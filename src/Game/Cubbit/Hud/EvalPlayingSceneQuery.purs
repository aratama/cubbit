...
import Game.Cubbit.Hud.Type (HudEffects, PlayingSceneQuery(SetCenterPanelVisible, OnKeyUp, OnKeyDown, Zoom, OnMouseClick, SetMousePosition, TogglePointerLock, SetPosition, SetMode, SetCursorPosition), Query)
