                              ...
                              return function (skybox) {
                                  return function __do() {
                                      ...
                                      var state$prime = (function () {
                                          ...
                                          $135.cameraRange = $$Math.max(3.0)(Data_Ord.min(Data_Ord.ordNumber)(20.0)(v.cameraRange + ((function () {
                                              if (v.gKey) {
                                                  return 1.0;
                                              };
                                              if (!v.gKey) {
                                              ...
                                              throw new Error("Failed pattern match at Game.Cubbit.Update line 235, column 80 - line 235, column 111: " + [ v.gKey.constructor.name ]);
                                          })() - (function () {
                                              if (v.tKey) {
                                                  return 1.0;
                                              };
                                              ...
                                              throw new Error("Failed pattern match at Game.Cubbit.Update line 235, column 116 - line 235, column 147: " + [ v.tKey.constructor.name ]);
                                                      ...
                                                      return Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Data_Identity.monadIdentity))(Data_Foreign_Class.readProp(Data_Foreign_Class.numberIsForeign)(Data_Foreign_Index.indexString)("cameraZoomSpeed")(value))(function (v12) {
                                                          return Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Data_Identity.monadIdentity))(Data_Foreign_Class.readProp(Data_Foreign_Class.numberIsForeign)(Data_Foreign_Index.indexString)("cameraMinZ")(value))(function (v13) {
                                                              return Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Data_Identity.monadIdentity))(Data_Foreign_Class.readProp(Data_Foreign_Class.numberIsForeign)(Data_Foreign_Index.indexString)("cameraMaxZ")(value))(function (v14) {
                                                                  return Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Data_Identity.monadIdentity))(Data_Foreign_Class.readProp(Data_Foreign_Class.numberIsForeign)(Data_Foreign_Index.indexString)("pointerHorizontalSensitivity")(value))(function (v15) {
                                                                      return Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Data_Identity.monadIdentity))(Data_Foreign_Class.readProp(Data_Foreign_Class.numberIsForeign)(Data_Foreign_Index.indexString)("pointerVerticalSensitivity")(value))(function (v16) {
                                                                          return Control_Applicative.pure(Control_Monad_Except_Trans.applicativeExceptT(Data_Identity.monadIdentity))({
                                                                              ...
                                                                              cameraMinZ: v13, 
                                                                              cameraMaxZ: v14, 
                                                                              pointerHorizontalSensitivity: v15, 
                                                                              pointerVerticalSensitivity: v16
                                                                          });
                                                                      });
                                                                  });
                                                              });
      ...
      return function (canvas2d) {
          return Data_Functor["void"](Control_Monad_Eff.functorEff)(Control_Monad_Aff.runAff(Control_Monad_Eff_Console.errorShow(Control_Monad_Eff_Exception.showError))(Control_Applicative.pure(Control_Monad_Eff.applicativeEff))(Control_Bind.bind(Control_Monad_Aff.bindAff)(Network_HTTP_Affjax.get(Network_HTTP_Affjax_Response.responsableForeign)("options.json"))(function (v) {
              return Control_Bind.bind(Control_Monad_Aff.bindAff)((function () {
                  var $99 = Control_Monad_Except.runExcept(readOptions(v.response));
                  if ($99 instanceof Data_Either.Left) {
                      return Control_Monad_Error_Class.throwError(Control_Monad_Aff.monadErrorAff)(Control_Monad_Eff_Exception.error(Data_Show.show(Data_List_Types.showNonEmptyList(Data_Foreign.showForeignError))($99.value0)));
                  };
                  if ($99 instanceof Data_Either.Right) {
                      return Control_Applicative.pure(Control_Monad_Aff.applicativeAff)($99.value0);
                  };
                  throw new Error("Failed pattern match at Game.Cubbit.Main line 102, column 16 - line 104, column 30: " + [ $99.constructor.name ]);
              })())(function (v1) {
                                  ...
                                  return Control_Bind.bind(Control_Monad_Aff.bindAff)(Graphics_Babylon_Texture_Aff.loadTexture("./alice/texture.png")(v3)(Graphics_Babylon_Texture.defaultCreateTextureOptions))(function () {
                                      return Control_Bind.bind(Control_Monad_Aff.bindAff)(Graphics_Babylon_SceneLoader_Aff.loadMesh("")("./alice/")("alice.babylon")(v3)(Control_Applicative.pure(Control_Monad_Eff.applicativeEff)))(function (v6) {
                                          return Control_Bind.bind(Control_Monad_Aff.bindAff)(Graphics_Babylon_Sound_Aff.loadSound("forest.mp3")("forest.mp3")(v3)((function () {
                                              var $110 = {};
                                              for (var $111 in Graphics_Babylon_Sound.defaultCreateSoundOptions) {
                                                  if (Graphics_Babylon_Sound.defaultCreateSoundOptions.hasOwnProperty($111)) {
                                                      $110[$111] = Graphics_Babylon_Sound.defaultCreateSoundOptions[$111];
                                                  };
                                              };
                                              $110.autoplay = true;
                                              $110.loop = true;
                                                  ...
                                                  Game_Cubbit_Event.onKeyDown(function (e) {
                                                      return function __do() {
                                                          Control_Applicative.when(Control_Monad_Eff.applicativeEff)(e.keyCode === 32)(Control_Monad_Eff_Ref.modifyRef(v15)(function (v16) {
                                                              var $149 = {};
                                                              for (var $150 in v16) {
                                                                  if (v16.hasOwnProperty($150)) {
                                                                      $149[$150] = v16[$150];
                                                                  };
                                                              };
                                                              $149.velocity = (function () {
                                                                  var $146 = {};
                                                                  for (var $147 in v16.velocity) {
                                                                      if (v16.velocity.hasOwnProperty($147)) {
                                                                          $146[$147] = v16.velocity[$147];
                                                                      };
                                                                  };
                                                                  $146.y = v16.velocity.y + v1.jumpVelocity;
                                                                  return $146;
                                                              })();
                                                              return $149;
                                                          }))();
