...
(function(exports) {
  ...
  var disposeLoadedMesh = function (v) {
      ...
      throw new Error("Failed pattern match at Game.Cubbit.Chunk line 52, column 21 - line 55, column 33: " + [ v.constructor.name ]);
  };
...
(function(exports) {
  ...
  var vecZero = vec(0.0)(0.0)(0.0);
  exports["vec"] = vec;
  exports["vecZero"] = vecZero;
})(PS["Game.Cubbit.Vec"] = PS["Game.Cubbit.Vec"] || {});
(function(exports) {
  /*
          ...
          return function __do() {
              ...
              if (v1 instanceof Data_Maybe.Just) {
                  ...
                  if ($27 instanceof Data_Maybe.Just) {
                      ...
                      throw new Error("Failed pattern match at Game.Cubbit.Terrain line 78, column 40 - line 78, column 97: " + [ $28.constructor.name ]);
                  };
                  return Data_Maybe.Nothing.value;
              };
              return Data_Maybe.Nothing.value;
      ...
      return function (inc) {
          ...
          return Control_Bind.bind(Control_Monad_Aff.bindAff)(Network_HTTP_Affjax.get(Network_HTTP_Affjax_Response.responsableForeign)("options.json"))(function (v) {
              return Control_Bind.bind(Control_Monad_Aff.bindAff)((function () {
                  var $41 = Control_Monad_Except.runExcept(Game_Cubbit_Option.readOptions(v.response));
                  if ($41 instanceof Data_Either.Left) {
                      return Control_Monad_Error_Class.throwError(Control_Monad_Aff.monadErrorAff)(Control_Monad_Eff_Exception.error(Data_Show.show(Data_List_Types.showNonEmptyList(Data_Foreign.showForeignError))($41.value0)));
                  };
                  if ($41 instanceof Data_Either.Right) {
                      return Control_Applicative.pure(Control_Monad_Aff.applicativeAff)($41.value0);
                  };
                  throw new Error("Failed pattern match at Game.Cubbit.Resources line 85, column 24 - line 87, column 30: " + [ $41.constructor.name ]);
              })())(function (v1) {
                                  ...
                                  return Control_Bind.bind(Control_Monad_Aff.bindAff)(loadTexture$prime("./image/texture.png")(v3)(Graphics_Babylon_Texture.defaultCreateTextureOptions))(function (v4) {
                                      return Control_Bind.bind(Control_Monad_Aff.bindAff)(loadTexture$prime("./image/alpha.png")(v3)(Graphics_Babylon_Texture.defaultCreateTextureOptions))(function (v5) {
                                          return Control_Bind.bind(Control_Monad_Aff.bindAff)(loadTexture$prime("./alice/texture.png")(v3)(Graphics_Babylon_Texture.defaultCreateTextureOptions))(function () {
                                              return Control_Bind.bind(Control_Monad_Aff.bindAff)(loadMesh$prime("")("./alice/")("alice.json")(v3)(Control_Applicative.pure(Control_Monad_Eff.applicativeEff)))(function (v6) {
                                                                      ...
                                                                      Data_Foldable.for_(Control_Monad_Eff.applicativeEff)(Data_Foldable.foldableArray)(v6)(function (mesh) {
                                                                          return Data_Functor["void"](Control_Monad_Eff.functorEff)(function __do() {
                                                                              ...
                                                                              Graphics_Babylon_AbstractMesh.setMaterial((function () {
                                                                                  var $77 = Data_String.contains("-outline")(name);
                                                                                  if ($77) {
                                                                                  ...
                                                                                  throw new Error("Failed pattern match at Game.Cubbit.Resources line 190, column 26 - line 190, column 129: " + [ $77.constructor.name ]);
                                                                              })())(mesh)();
      ...
      return function (playerMeshes) {
          return Data_Foldable.for_(Control_Monad_Eff.applicativeEff)(Data_Foldable.foldableArray)(playerMeshes)(function (mesh) {
              return Data_Functor["void"](Control_Monad_Eff.functorEff)(function __do() {
                  ...
                  throw new Error("Failed pattern match at Game.Cubbit.Control line 33, column 9 - line 38, column 91: " + [ v.constructor.name ]);
              });
          });
      };
  };
                              ...
                              if ($22 instanceof Data_Maybe.Just) {
                                  ...
                                  if (mode instanceof Game_Cubbit_Types.Put) {
                                      ...
                                      if (!$26) {
                                          ...
                                          throw new Error("Failed pattern match at Game.Cubbit.Control line 71, column 30 - line 84, column 57: " + [ $33.constructor.name ]);
                                      };
                                      throw new Error("Failed pattern match at Game.Cubbit.Control line 64, column 26 - line 84, column 57: " + [ $26.constructor.name ]);
                                  };
                                  if (mode instanceof Game_Cubbit_Types.Remove) {
                                      ...
                                      if (!$47) {
                                          ...
                                          throw new Error("Failed pattern match at Game.Cubbit.Control line 93, column 30 - line 106, column 57: " + [ $54.constructor.name ]);
                                      };
                                      throw new Error("Failed pattern match at Game.Cubbit.Control line 86, column 27 - line 106, column 57: " + [ $47.constructor.name ]);
                                  };
                                  if (mode instanceof Game_Cubbit_Types.Move) {
                                      return Data_Maybe.Nothing.value;
                                  };
                                  throw new Error("Failed pattern match at Game.Cubbit.Control line 63, column 13 - line 108, column 30: " + [ mode.constructor.name ]);
                              };
                              throw new Error("Failed pattern match at Game.Cubbit.Control line 48, column 5 - line 108, column 30: " + [ $22.constructor.name ]);
                          };
                      };
                  };
              };
...
(function(exports) {
              ...
              return function (scene) {
                  return function (v) {
                      return function (v1) {
                          ...
                          return function __do() {
                              var v2 = Graphics_Babylon_Mesh.createMesh("terrain")(scene)();
                              Control_Bind.bindFlipped(Control_Monad_Eff.bindEff)(Graphics_Babylon_VertexData.applyToMesh(v2)(false))(Graphics_Babylon_VertexData.createVertexData(verts))();
                              Graphics_Babylon_AbstractMesh.setRenderingGroupId(Game_Cubbit_Constants.terrainRenderingGroup)(Graphics_Babylon_Mesh.meshToAbstractMesh(v2))();
                              Graphics_Babylon_AbstractMesh.setReceiveShadows(v1.shadow)(Graphics_Babylon_Mesh.meshToAbstractMesh(v2))();
                              Graphics_Babylon_AbstractMesh.setUseVertexColors(v1.vertexColor)(Graphics_Babylon_Mesh.meshToAbstractMesh(v2))();
                              Graphics_Babylon_AbstractMesh.setMaterial(mat)(Graphics_Babylon_Mesh.meshToAbstractMesh(v2))();
                              Graphics_Babylon_AbstractMesh.setIsPickable(false)(Graphics_Babylon_Mesh.meshToAbstractMesh(v2))();
                              return v2;
                          };
                      };
                  };
  ...
  var generateChunk = function (ref) {
                      ...
                      return function (v1) {
                          return function __do() {
                              ...
                              if (v2.res instanceof Game_Cubbit_Types.Complete) {
                                      ...
                                      return Control_Monad_Eff.forE(i.y - 1)(i.y + 2 | 0)(function (y) {
                                          return Control_Monad_Eff.forE(i.z - 1)(i.z + 2 | 0)(function (z) {
                                              return Data_Functor["void"](Control_Monad_Eff.functorEff)((function () {
                                                  ...
                                                  return function __do() {
                                                      var v3 = Game_Cubbit_Terrain.lookupChunk(loadingChunkIndex)(v2.terrain)();
                                                      ...
                                                      if (v3 instanceof Data_Maybe.Nothing) {
                                                          Game_Cubbit_Terrain.insertChunk({
                                                              ...
                                                              blocks: Game_Cubbit_Generation.createBlockMap(v2.terrain.noise)(loadingChunkIndex), 
                                                              ...
                                                              bodies: Data_Maybe.Nothing.value
                                                          })(v2.terrain)();
                                                          return true;
                                                      };
                                                      throw new Error("Failed pattern match at Game.Cubbit.MeshBuilder line 71, column 25 - line 87, column 42: " + [ v3.constructor.name ]);
                                                  };
                                              })());
                                          });
                                      });
                                  })();
                                  var v3 = Game_Cubbit_Terrain.lookupChunk(index)(v2.terrain)();
                                  var v4 = (function () {
                                      if (v3 instanceof Data_Maybe.Nothing) {
                                          return Game_Cubbit_Generation.createBlockMap(v2.terrain.noise)(index);
                                      };
                                      if (v3 instanceof Data_Maybe.Just) {
                                          return v3.value0.blocks;
                                      };
                                      throw new Error("Failed pattern match at Game.Cubbit.MeshBuilder line 91, column 28 - line 93, column 47: " + [ v3.constructor.name ]);
                                  })();
                                  var $49 = createTerrainGeometry(v2.terrain)({
                                      index: index, 
                                      blocks: v4
                                  });
                                  var v5 = Game_Cubbit_Terrain.lookupChunk(index)(v2.terrain)();
                                  (function () {
                                      ...
                                      throw new Error("Failed pattern match at Game.Cubbit.MeshBuilder line 102, column 21 - line 104, column 65: " + [ v5.constructor.name ]);
                                  })()();
                                  var ci = Game_Cubbit_ChunkIndex.runChunkIndex(index);
                                  var gen = function (vertices) {
                                      return function (mat) {
                                          return function (gruop) {
                                              var $53 = 0 < Data_Array.length(vertices.indices);
                                              if ($53) {
                                                  return function __do() {
                                                      var v6 = generateMesh(index)(vertices)(mat)(scene)(v)(v1)();
                                              ...
                                              throw new Error("Failed pattern match at Game.Cubbit.MeshBuilder line 109, column 50 - line 115, column 53: " + [ $53.constructor.name ]);
                                          };
                                      };
                                  };
                                  var v6 = gen($49.standardMaterialBlocks)(materials.blockMaterial)(Game_Cubbit_Constants.terrainRenderingGroup)();
                                  var v7 = gen($49.waterMaterialBlocks)(materials.waterMaterial)(Game_Cubbit_Constants.terrainRenderingGroup)();
                                  var v8 = gen($49.transparentMaterialVertexData)(materials.bushMaterial)(Game_Cubbit_Constants.terrainRenderingGroup)();
                                  Game_Cubbit_Terrain.insertChunk({
                                      x: ci.x, 
                                      y: ci.y, 
                                      z: ci.z, 
                                  ...
                                  return 0 < (Data_Array.length($49.standardMaterialBlocks.indices) + Data_Array.length($49.waterMaterialBlocks.indices) | 0);
                              };
                              throw new Error("Failed pattern match at Game.Cubbit.MeshBuilder line 60, column 5 - line 135, column 109: " + [ v2.res.constructor.name ]);
                          };
                      };
                  };
              };
                      ...
                      return function (v1) {
                          return Data_Functor["void"](Control_Monad_Eff.functorEff)(function __do() {
                              ...
                              (function () {
                                  ...
                                  throw new Error("Failed pattern match at Game.Cubbit.MeshBuilder line 196, column 5 - line 198, column 49: " + [ v4.constructor.name ]);
                              })()();
                              var v5 = generateMesh(chunkWithMesh.index)(v3.standardMaterialBlocks)(materials.blockMaterial)(scene)(v)(v1)();
                              var v6 = generateMesh(chunkWithMesh.index)(v3.waterMaterialBlocks)(materials.waterMaterial)(scene)(v)(v1)();
                              var v7 = generateMesh(chunkWithMesh.index)(v3.transparentMaterialVertexData)(materials.bushMaterial)(scene)(v)(v1)();
                      ...
                      return Data_Functor["void"](Control_Monad_Eff.functorEff)((function () {
                          ...
                          return function __do() {
                              updateChunkMesh(ref)(v.res.value0.materials)(v.res.value0.scene)((function () {
                                  var $82 = {};
                                  for (var $83 in v1.value0) {
                                      if (v1.value0.hasOwnProperty($83)) {
                                          $82[$83] = v1.value0[$83];
                                      };
                                  };
                                  $82.blocks = Game_Cubbit_BoxelMap.insert(localIndex)(block)(v1.value0.blocks);
                                  return $82;
                                  ...
                                  return function (dy) {
                                      return function (dz) {
                                          return function __do() {
                                              ...
                                              throw new Error("Failed pattern match at Game.Cubbit.MeshBuilder line 173, column 21 - line 175, column 133: " + [ v2.constructor.name ]);
                                          };
                                      };
                                  };
                              };
                      ...
                      return Data_Functor.voidRight(Halogen_Query_HalogenM.functorHalogenM)(query.value1)((function () {
                          ...
                          if (query.value0 instanceof Game_Cubbit_Hud_Type.ShowConfig) {
                              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(modifyAppState(ref)(function (v2) {
                                  var $62 = {};
                                  for (var $63 in v2) {
                                      if (v2.hasOwnProperty($63)) {
                                          $62[$63] = v2[$63];
                                      };
                                  };
                                  $62.configVisible = true;
                                  return $62;
                              }))(function () {
                          ...
                          if (query.value0 instanceof Game_Cubbit_Hud_Type.CloseConfig) {
                              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(modifyAppState(ref)(function (v2) {
                                  var $66 = {};
                                  for (var $67 in v2) {
                                      if (v2.hasOwnProperty($67)) {
                                          $66[$67] = v2[$67];
                                      };
                                  };
                                  $66.configVisible = false;
                                  return $66;
                              }))(function () {
                                  return Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(Graphics_Babylon_Sound.play(v.res.value0.sounds.switchSound));
                              });
                          ...
                          if (query.value0 instanceof Game_Cubbit_Hud_Type.SetBGMVolume) {
                              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(modifyAppState(ref)(function (v2) {
                                  ...
                                  $73.config = (function () {
                                      var $70 = {};
                                      for (var $71 in v2.config) {
                                          if (v2.config.hasOwnProperty($71)) {
                                              $70[$71] = v2.config[$71];
                                          };
                                      };
                                      $70.bgmVolume = query.value0.value0;
                                      return $70;
                                  })();
                                  return $73;
                              }))(function () {
                          ...
                          if (query.value0 instanceof Game_Cubbit_Hud_Type.SetSEVolume) {
                              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(modifyAppState(ref)(function (v2) {
                                  var $83 = {};
                                  for (var $84 in v2) {
                                      if (v2.hasOwnProperty($84)) {
                                          $83[$84] = v2[$84];
                                      };
                                  };
                                  $83.config = (function () {
                                      var $80 = {};
                                      for (var $81 in v2.config) {
                                          if (v2.config.hasOwnProperty($81)) {
                                              $80[$81] = v2.config[$81];
                                          };
                                      };
                                      $80.seVolume = query.value0.value0;
                                      return $80;
                                  })();
                                  return $83;
                              }))(function () {
                          ...
                          if (query.value0 instanceof Game_Cubbit_Hud_Type.ToggleShadow) {
                              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(modifyAppState(ref)(function (v2) {
                                  ...
                                  $93.config = (function () {
                                      var $90 = {};
                                      for (var $91 in v2.config) {
                                          if (v2.config.hasOwnProperty($91)) {
                                              $90[$91] = v2.config[$91];
                                          };
                                      };
                                      $90.shadow = !v2.config.shadow;
                                      return $90;
                                  })();
                                  return $93;
                              }))(function () {
                          ...
                          if (query.value0 instanceof Game_Cubbit_Hud_Type.ToggleVertexColor) {
                              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(modifyAppState(ref)(function (v2) {
                                  var $102 = {};
                                  for (var $103 in v2) {
                                      if (v2.hasOwnProperty($103)) {
                                          $102[$103] = v2[$103];
                                      };
                                  };
                                  $102.config = (function () {
                                      var $99 = {};
                                      for (var $100 in v2.config) {
                                          if (v2.config.hasOwnProperty($100)) {
                                              $99[$100] = v2.config[$100];
                                          };
                                      };
                                      $99.vertexColor = !v2.config.vertexColor;
                                      return $99;
                                  })();
                                  return $102;
                              }))(function () {
                          ...
                          if (query.value0 instanceof Game_Cubbit_Hud_Type.SetShadowArea) {
                              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(modifyAppState(ref)(function (v2) {
                                  ...
                                  $111.config = (function () {
                                      var $108 = {};
                                      for (var $109 in v2.config) {
                                          if (v2.config.hasOwnProperty($109)) {
                                              $108[$109] = v2.config[$109];
                                          };
                                      };
                                      $108.shadowArea = query.value0.value0;
                                      return $108;
                                  })();
                                  return $111;
                              }))(function () {
                          ...
                          if (query.value0 instanceof Game_Cubbit_Hud_Type.SetChunkArea) {
                              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(modifyAppState(ref)(function (v2) {
                                  var $121 = {};
                                  for (var $122 in v2) {
                                      if (v2.hasOwnProperty($122)) {
                                          $121[$122] = v2[$122];
                                      };
                                  };
                                  $121.config = (function () {
                                      var $118 = {};
                                      for (var $119 in v2.config) {
                                          if (v2.config.hasOwnProperty($119)) {
                                              $118[$119] = v2.config[$119];
                                          };
                                      };
                                      $118.chunkArea = query.value0.value0;
                                      return $118;
                                  })();
                                  return $121;
                              }))(function () {
                          ...
                          if (query.value0 instanceof Game_Cubbit_Hud_Type.Start) {
                              ...
                              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(Graphics_Babylon_Sound.play(v.res.value0.sounds.warpSound)))(function () {
                                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(modifyAppState(ref)(function (v2) {
                                      var $128 = {};
                                      for (var $129 in v2) {
                                          if (v2.hasOwnProperty($129)) {
                                              $128[$129] = v2[$129];
                                          };
                                      };
                                      $128.nextScene = new Data_Maybe.Just(nextScene);
                                      return $128;
                                  }))(function () {
                                                  ...
                                                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Game_Cubbit_Aff.wait(Halogen_Query_HalogenM.monadAffHalogenM(Control_Monad_Aff_Class.monadAffAff))(1000))(function () {
                                                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(function __do() {
                                                          ...
                                                          return modifyAppState(ref)(function (v2) {
                                                              ...
                                                              $140.nextScene = Data_Maybe.Nothing.value;
                                                              return $140;
                                                          });
                                                      });
                                                  });
                          ...
                          if (query.value0 instanceof Game_Cubbit_Hud_Type.ToggleMute) {
                              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(modifyAppState(ref)(function (v2) {
                                  ...
                                  $147.config = (function () {
                                      var $144 = {};
                                      for (var $145 in v2.config) {
                                          if (v2.config.hasOwnProperty($145)) {
                                              $144[$145] = v2.config[$145];
                                          };
                                      };
                                      $144.mute = !v2.config.mute;
                                      return $144;
                                  })();
                                  return $147;
                              }))(function () {
                                  ...
                                  if (v2.sceneState instanceof Game_Cubbit_Types.PlayingSceneState) {
                                      if (query.value0.value0 instanceof Game_Cubbit_Hud_Type.SetCursorPosition) {
                                          return Control_Applicative.when(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Eq.notEq(Game_Cubbit_BlockIndex.eq_BlockIndex)(query.value0.value0.value0)(v2.sceneState.value0.cursorPosition))(modifyAppState(ref)(function (v3) {
                                              var $161 = {};
                                              for (var $162 in v3) {
                                                  if (v3.hasOwnProperty($162)) {
                                                      $161[$162] = v3[$162];
                                                  };
                                              };
                                              $161.sceneState = new Game_Cubbit_Types.PlayingSceneState((function () {
                                                  var $158 = {};
                                                  for (var $159 in v2.sceneState.value0) {
                                                      if (v2.sceneState.value0.hasOwnProperty($159)) {
                                                          $158[$159] = v2.sceneState.value0[$159];
                                                      };
                                                  };
                                                  $158.cursorPosition = query.value0.value0.value0;
                                                  return $158;
                                              })());
                                              return $161;
                                          }));
                                          ...
                                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(Control_Applicative.when(Control_Monad_Eff.applicativeEff)(Data_Eq.notEq(Game_Cubbit_Types.eqMode)(v2.sceneState.value0.mode)(query.value0.value0.value0))(Graphics_Babylon_Sound.play(v.res.value0.sounds.switchSound))))(function () {
                                              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(modifyAppState(ref)(function (v3) {
                                                  ...
                                                  $169.sceneState = new Game_Cubbit_Types.PlayingSceneState((function () {
                                                      ...
                                                      $166.mode = query.value0.value0.value0;
                                                      return $166;
                                                  })());
                                                  return $169;
                                              }))(function () {
                                      ...
                                      if (query.value0.value0 instanceof Game_Cubbit_Hud_Type.SetPosition) {
                                          return Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(Control_Monad_Eff_Ref.modifyRef(ref)(function (v3) {
                                              ...
                                              $177.sceneState = new Game_Cubbit_Types.PlayingSceneState((function () {
                                                  ...
                                                  $174.position = query.value0.value0.value0;
                                                  return $174;
                                              })());
                                              return $177;
                                          }));
                                              ...
                                              return function __do() {
                                                  Control_Monad_Eff_Ref.modifyRef(ref)(function (v3) {
                                                      ...
                                                      $185.sceneState = new Game_Cubbit_Types.PlayingSceneState((function () {
                                                          ...
                                                          $182.firstPersonView = firstPersonView;
                                                          return $182;
                                                      })());
                                                      return $185;
                                                  })();
                                                      ...
                                                      return Game_Cubbit_PointerLock.requestPointerLock(function (e) {
                                                          return function __do() {
                                                              Control_Monad_Eff_Ref.modifyRef(ref)(function (v3) {
                                                                  var $196 = {};
                                                                  for (var $197 in v3) {
                                                                      if (v3.hasOwnProperty($197)) {
                                                                          $196[$197] = v3[$197];
                                                                      };
                                                                  };
                                                                  $196.sceneState = (function () {
                                                                      ...
                                                                      if (v3.sceneState instanceof Game_Cubbit_Types.PlayingSceneState) {
                                                                          return new Game_Cubbit_Types.PlayingSceneState((function () {
                                                                              var $192 = {};
                                                                              for (var $193 in v3.sceneState.value0) {
                                                                                  if (v3.sceneState.value0.hasOwnProperty($193)) {
                                                                                      $192[$193] = v3.sceneState.value0[$193];
                                                                                  };
                                                                              };
                                                                              $192.playerRotation = v3.sceneState.value0.playerRotation + e.movementX * v1.pointerHorizontalSensitivity;
                                                                              $192.playerPitch = Data_Ord.max(Data_Ord.ordNumber)(-$$Math.pi * 0.45)(Data_Ord.min(Data_Ord.ordNumber)($$Math.pi * 0.45)(v3.sceneState.value0.playerPitch) - e.movementY * v1.pointerVerticalSensitivity);
                                                                              return $192;
                                                                          })());
                                                                      };
                                                                      throw new Error("Failed pattern match at Game.Cubbit.Hud.Eval line 290, column 70 - line 295, column 62: " + [ v3.sceneState.constructor.name ]);
                                                                  })();
                                                                  return $196;
                                                              })();
                                                              return Data_Unit.unit;
                                                          ...
                                                          var $206 = {};
                                                          for (var $207 in v3) {
                                                              if (v3.hasOwnProperty($207)) {
                                                                  $206[$207] = v3[$207];
                                                              };
                                                          };
                                                          $206.sceneState = (function () {
                                                              if (v3.sceneState instanceof Game_Cubbit_Types.TitleSceneState) {
                                                                  return new Game_Cubbit_Types.TitleSceneState(v3.sceneState.value0);
                                                              };
                                                              if (v3.sceneState instanceof Game_Cubbit_Types.PlayingSceneState) {
                                                                  return new Game_Cubbit_Types.PlayingSceneState((function () {
                                                                      var $202 = {};
                                                                      for (var $203 in v3.sceneState.value0) {
                                                                          if (v3.sceneState.value0.hasOwnProperty($203)) {
                                                                              $202[$203] = v3.sceneState.value0[$203];
                                                                          };
                                                                      };
                                                                      $202.firstPersonView = false;
                                                                      return $202;
                                                                  })());
                                                              };
                                                              throw new Error("Failed pattern match at Game.Cubbit.Hud.Eval line 299, column 66 - line 303, column 58: " + [ v3.sceneState.constructor.name ]);
                                                          })();
                                                          return $206;
                                                      }))();
                                                  };
                                                  ...
                                                  throw new Error("Failed pattern match at Game.Cubbit.Hud.Eval line 287, column 45 - line 305, column 69: " + [ firstPersonView.constructor.name ]);
                                              };
                                          })());
                                      };
                                      if (query.value0.value0 instanceof Game_Cubbit_Hud_Type.SetMousePosition) {
                                          return Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(Control_Monad_Eff_Ref.modifyRef(ref)(function (v3) {
                                              ...
                                              $215.sceneState = new Game_Cubbit_Types.PlayingSceneState((function () {
                                                  var $212 = {};
                                                  for (var $213 in v2.sceneState.value0) {
                                                      if (v2.sceneState.value0.hasOwnProperty($213)) {
                                                          $212[$213] = v2.sceneState.value0[$213];
                                                      };
                                                  };
                                                  $212.cameraYaw = (function () {
                                                      if (isRightButton) {
                                                      ...
                                                      throw new Error("Failed pattern match at Game.Cubbit.Hud.Eval line 319, column 81 - line 319, column 215: " + [ isRightButton.constructor.name ]);
                                                  })();
                                                  $212.cameraPitch = (function () {
                                                      if (isRightButton) {
                                                      ...
                                                      throw new Error("Failed pattern match at Game.Cubbit.Hud.Eval line 320, column 83 - line 320, column 255: " + [ isRightButton.constructor.name ]);
                                                  })();
                                                  return $212;
                                              })());
                                              return $215;
                                              ...
                                              return Control_Applicative.when(Control_Monad_Eff.applicativeEff)(DOM_Event_MouseEvent.buttons(query.value0.value0.value0) === 1)((function () {
                                                  var put = function (block) {
                                                      return function __do() {
                                                          ...
                                                          if (v4 instanceof Data_Maybe.Just) {
                                                              return Game_Cubbit_MeshBuilder.editBlock(ref)(v4.value0)(block)();
                                                          };
                                                          throw new Error("Failed pattern match at Game.Cubbit.Hud.Eval line 343, column 57 - line 345, column 110: " + [ v4.constructor.name ]);
                                                      };
                                                  };
                                                  ...
                                                  throw new Error("Failed pattern match at Game.Cubbit.Hud.Eval line 347, column 49 - line 354, column 70: " + [ v2.sceneState.value0.mode.constructor.name ]);
                                              })())();
                                          });
                                      };
                                      if (query.value0.value0 instanceof Game_Cubbit_Hud_Type.Zoom) {
                                          return Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(function __do() {
                                              Control_Monad_Eff_Ref.modifyRef(ref)(function (v3) {
                                                  var $234 = {};
                                                  for (var $235 in v3) {
                                                      if (v3.hasOwnProperty($235)) {
                                                          $234[$235] = v3[$235];
                                                      };
                                                  };
                                                  $234.sceneState = new Game_Cubbit_Types.PlayingSceneState((function () {
                                                      var $231 = {};
                                                      for (var $232 in v2.sceneState.value0) {
                                                          if (v2.sceneState.value0.hasOwnProperty($232)) {
                                                              $231[$232] = v2.sceneState.value0[$232];
                                                          };
                                                      };
                                                      $231.cameraRange = Data_Ord.max(Data_Ord.ordNumber)(v1.cameraMinimumRange)(Data_Ord.min(Data_Ord.ordNumber)(v1.cameraMaximumRange)(v2.sceneState.value0.cameraRange + Data_Int.toNumber(deltaY(query.value0.value0.value0)) * v1.cameraZoomSpeed));
                                                      return $231;
                                                  })());
                                                  return $234;
                                              })();
                                      ...
                                      if (query.value0.value0 instanceof Game_Cubbit_Hud_Type.OnKeyDown) {
                                          return Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(function __do() {
                                              Control_Monad_Eff_Ref.modifyRef(ref)(function (v3) {
                                                  var $239 = {};
                                                  for (var $240 in v3) {
                                                      if (v3.hasOwnProperty($240)) {
                                                          $239[$240] = v3[$240];
                                                      };
                                                  };
                                                  $239.keys = Data_Set.insert(Data_Ord.ordString)(DOM_Event_KeyboardEvent.key(query.value0.value0.value0))(v3.keys);
                                                  return $239;
                                              })();
                                              (function () {
                                                  var $242 = DOM_Event_KeyboardEvent.key(query.value0.value0.value0);
                                                  if ($242 === "1") {
                                                      return function __do() {
                                                          var v3 = Control_Monad_Eff_Ref.readRef(ref)();
                                                          if (v3.debugLayer) {
                                                          ...
                                                          throw new Error("Failed pattern match at Game.Cubbit.Hud.Eval line 373, column 49 - line 375, column 97: " + [ v3.debugLayer.constructor.name ]);
                                                      };
                                                  };
                                                  return Control_Applicative.pure(Control_Monad_Eff.applicativeEff)(Data_Unit.unit);
                                              })()();
                                      ...
                                      if (query.value0.value0 instanceof Game_Cubbit_Hud_Type.OnKeyUp) {
                                          return Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(function __do() {
                                              Control_Monad_Eff_Ref.modifyRef(ref)(function (v3) {
                                                  ...
                                                  $247.keys = Data_Set["delete"](Data_Ord.ordString)(DOM_Event_KeyboardEvent.key(query.value0.value0.value0))(v3.keys);
                                                  return $247;
                                              })();
                                              DOM_Event_Event.preventDefault(DOM_Event_Types.keyboardEventToEvent(query.value0.value0.value0))();
                                              return DOM_Event_Event.stopPropagation(DOM_Event_Types.keyboardEventToEvent(query.value0.value0.value0))();
                                      ...
                                      if (query.value0.value0 instanceof Game_Cubbit_Hud_Type.SetCenterPanelVisible) {
                                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(modifyAppState(ref)(function (v3) {
                                              var $255 = {};
                                              for (var $256 in v3) {
                                                  if (v3.hasOwnProperty($256)) {
                                                      $255[$256] = v3[$256];
                                                  };
                                              };
                                              $255.sceneState = new Game_Cubbit_Types.PlayingSceneState((function () {
                                                  var $252 = {};
                                                  for (var $253 in v2.sceneState.value0) {
                                                      if (v2.sceneState.value0.hasOwnProperty($253)) {
                                                          $252[$253] = v2.sceneState.value0[$253];
                                                      };
                                                  };
                                                  $252.centerPanelVisible = query.value0.value0.value0;
                                                  return $252;
                                              })());
                                              return $255;
                                          }))(function () {
                                      ...
                                      if (query.value0.value0 instanceof Game_Cubbit_Hud_Type.Home) {
                                          ...
                                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(Graphics_Babylon_Sound.play(v.res.value0.sounds.warpSound)))(function () {
                                              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(modifyAppState(ref)(function (v3) {
                                                  ...
                                                  $260.nextScene = new Data_Maybe.Just(nextScene);
                                                  return $260;
                                              }))(function () {
                                                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Game_Cubbit_Aff.wait(Halogen_Query_HalogenM.monadAffHalogenM(Control_Monad_Aff_Class.monadAffAff))(1000))(function () {
                                                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(function __do() {
                                                          ...
                                                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(modifyAppState(ref)(function (v3) {
                                                              var $266 = {};
                                                              for (var $267 in v3) {
                                                                  if (v3.hasOwnProperty($267)) {
                                                                      $266[$267] = v3[$267];
                                                                  };
                                                              };
                                                              $266.sceneState = nextScene;
                                                              return $266;
                                                          }))(function () {
                                                              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Game_Cubbit_Aff.wait(Halogen_Query_HalogenM.monadAffHalogenM(Control_Monad_Aff_Class.monadAffAff))(1000))(function () {
                                                                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(function __do() {
                                                                      ...
                                                                      return modifyAppState(ref)(function (v3) {
                                                                          var $272 = {};
                                                                          for (var $273 in v3) {
                                                                              if (v3.hasOwnProperty($273)) {
                                                                                  $272[$273] = v3[$273];
                                                                              };
                                                                          };
                                                                          $272.nextScene = Data_Maybe.Nothing.value;
                                                                          return $272;
                                                                      });
                                                                  });
                                                              });
                                      ...
                                      throw new Error("Failed pattern match at Game.Cubbit.Hud.Eval line 246, column 33 - line 411, column 115: " + [ query.value0.value0.constructor.name ]);
                                  };
                                  throw new Error("Failed pattern match at Game.Cubbit.Hud.Eval line 238, column 25 - line 411, column 115: " + [ v2.sceneState.constructor.name ]);
                              });
                          };
                          throw new Error("Failed pattern match at Game.Cubbit.Hud.Eval line 64, column 41 - line 411, column 115: " + [ query.value0.constructor.name ]);
                      })());
                  });
              };
              throw new Error("Failed pattern match at Game.Cubbit.Hud.Eval line 44, column 5 - line 411, column 115: " + [ v.res.constructor.name ]);
          });
      };
  };
  exports["eval"] = $$eval;
...
(function(exports) {
  ...
  var slotClass = function (active) {
      return Halogen_HTML_Properties.class_("slot" + (function () {
          ...
          throw new Error("Failed pattern match at Game.Cubbit.Hud.Render line 27, column 49 - line 27, column 81: " + [ active.constructor.name ]);
      })());
  };
  ...
  var render = function (v) {
      var toggle = function (value) {
          return function (act) {
              return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("config-toggle " + (function () {
                  ...
                  throw new Error("Failed pattern match at Game.Cubbit.Hud.Render line 187, column 56 - line 187, column 85: " + [ value.constructor.name ]);
                  ...
                  throw new Error("Failed pattern match at Game.Cubbit.Hud.Render line 189, column 21 - line 189, column 50: " + [ value.constructor.name ]);
              })()) ]);
          };
      };
          ...
          return function (action) {
              return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("config-slider") ])(Data_Functor.mapFlipped(Data_Functor.functorArray)(Data_Array.range(0)(Game_Cubbit_Constants.sliderMaxValue))(function (i) {
                  return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("config-slider-box " + (function () {
                      ...
                      throw new Error("Failed pattern match at Game.Cubbit.Hud.Render line 181, column 64 - line 181, column 102: " + [ $7.constructor.name ]);
                  })()), Halogen_HTML_Events.onClick(function (e) {
      ...
      var hotbuttons = function (playingSceneState) {
          var tool = function (v1) {
              ...
              throw new Error("Failed pattern match at Game.Cubbit.Hud.Render line 213, column 17 - line 216, column 42: " + [ v1.constructor.name ]);
          };
          var slot = function (v1) {
              ...
              throw new Error("Failed pattern match at Game.Cubbit.Hud.Render line 39, column 1 - line 217, column 56: " + [ v1.constructor.name ]);
          };
      ...
      if (v.res instanceof Game_Cubbit_Types.Loading) {
          return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.id_("content"), Halogen_HTML_Properties.key("root-content"), Halogen_HTML_Properties.class_("content-layer") ])([ Halogen_HTML_Elements.img([ Halogen_HTML_Properties.class_("content-layer"), Halogen_HTML_Properties.src("image/loading.png") ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("progress") ])(Data_Functor.mapFlipped(Data_Functor.functorArray)(Data_Array.range(0)(16))(function (i) {
              return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("cell" + (function () {
                  ...
                  throw new Error("Failed pattern match at Game.Cubbit.Hud.Render line 47, column 51 - line 47, column 88: " + [ $13.constructor.name ]);
              })()) ])([  ]);
          })) ]);
      };
      if (v.res instanceof Game_Cubbit_Types.Complete) {
          return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.id_("content"), Halogen_HTML_Properties.key("root-content"), Halogen_HTML_Properties.class_("content-layer"), Halogen_HTML_Events.onContextMenu(function (e) {
              ...
              if (v.sceneState instanceof Game_Cubbit_Types.PlayingSceneState) {
                  ...
                  return [ Halogen_HTML_Elements.img([ Halogen_HTML_Properties.key("image/screenshade.png"), Halogen_HTML_Properties.id_("screen-shade"), Halogen_HTML_Properties.class_("content-layer"), Halogen_HTML_Properties.src("image/screenshade.png") ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.id_("cursor-position") ])([ Halogen_HTML.text("cursor: (" + (Data_Show.show(Data_Show.showInt)(index.x) + (", " + (Data_Show.show(Data_Show.showInt)(index.y) + (", " + (Data_Show.show(Data_Show.showInt)(index.z) + ")")))))) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.id_("life") ])(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Array.replicate(v.sceneState.value0.life)(Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("active") ])([ icon("heart") ])))(Data_Array.replicate(v.sceneState.value0.maxLife - v.sceneState.value0.life)(icon("heart")))), Halogen_HTML_Elements.p([ Halogen_HTML_Properties.id_("message-box-top") ])([  ]), Halogen_HTML_Elements.p([ Halogen_HTML_Properties.id_("message-box") ])([ Halogen_HTML.text("Cubbit\xd7Cubbit Playable Demo") ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.id_("right-panel"), suppressMouseMove, suppressMouseDown ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("button"), Halogen_HTML_Events.onClick(function (e) {
                      ...
                      throw new Error("Failed pattern match at Game.Cubbit.Hud.Render line 106, column 21 - line 113, column 37: " + [ v.sceneState.value0.centerPanelVisible.constructor.name ]);
              ...
              throw new Error("Failed pattern match at Game.Cubbit.Hud.Render line 63, column 50 - line 126, column 18: " + [ v.sceneState.constructor.name ]);
              ...
              throw new Error("Failed pattern match at Game.Cubbit.Hud.Render line 129, column 67 - line 129, column 113: " + [ v.configVisible.constructor.name ]);
          })()), Halogen_HTML_Events.onClick(function (e) {
              ...
              throw new Error("Failed pattern match at Game.Cubbit.Hud.Render line 159, column 55 - line 159, column 104: " + [ $20.constructor.name ]);
          })()), Halogen_HTML_Properties.key("shadow") ])([  ]) ]);
      };
      throw new Error("Failed pattern match at Game.Cubbit.Hud.Render line 39, column 50 - line 162, column 10: " + [ v.res.constructor.name ]);
  };
              ...
              return function (playingSceneState) {
                  return Control_Monad_Eff.runPure((function () {
                      var rot = -(function () {
                          ...
                          throw new Error("Failed pattern match at Game.Cubbit.Update line 58, column 23 - line 58, column 138: " + [ playingSceneState.firstPersonView.constructor.name ]);
                      })();
                      var keyStep = function (key) {
                          var $35 = Data_Set.member(Data_Ord.ordString)(key)(v1.keys);
                          if ($35) {
                              return 1.0;
                          };
                          if (!$35) {
                          ...
                          throw new Error("Failed pattern match at Game.Cubbit.Update line 60, column 23 - line 62, column 5: " + [ $35.constructor.name ]);
                      };
                      var keyVector = {
                      ...
                      return function __do() {
                          ...
                          var jumpVelocity = (function () {
                              var $39 = isLanding && (Data_Set.member(Data_Ord.ordString)(" ")(v1.keys) && playingSceneState.landing === 0);
                              if ($39) {
                              ...
                              throw new Error("Failed pattern match at Game.Cubbit.Update line 81, column 24 - line 83, column 5: " + [ $39.constructor.name ]);
                          })();
                          var moveFactor = (function () {
                              ...
                              throw new Error("Failed pattern match at Game.Cubbit.Update line 85, column 22 - line 88, column 5: " + [ isLanding.constructor.name ]);
                          })();
                          var gravityAccelerator = (function () {
                              ...
                              throw new Error("Failed pattern match at Game.Cubbit.Update line 88, column 30 - line 88, column 84: " + [ isLanding.constructor.name ]);
                          })();
                          var moveVectorLength = $$Math.sqrt(rotatedKeyVector.x * rotatedKeyVector.x + rotatedKeyVector.z * rotatedKeyVector.z);
                          var normalizedMoveX = (function () {
                              if (isLanding) {
                                  return (rotatedKeyVector.x / moveVectorLength) * v.moveSpeed;
                              };
                              if (!isLanding) {
                                  return playingSceneState.velocity.x;
                              };
                              throw new Error("Failed pattern match at Game.Cubbit.Update line 91, column 27 - line 91, column 124: " + [ isLanding.constructor.name ]);
                          })();
                          var normalizedMoveZ = (function () {
                              if (isLanding) {
                                  return (rotatedKeyVector.z / moveVectorLength) * v.moveSpeed;
                              };
                              if (!isLanding) {
                                  return playingSceneState.velocity.z;
                              };
                              throw new Error("Failed pattern match at Game.Cubbit.Update line 92, column 27 - line 92, column 124: " + [ isLanding.constructor.name ]);
                          })();
                          var velocityX = (function () {
                              if (isLanding) {
                                  if (stopped) {
                                      return playingSceneState.velocity.x * 0.5;
                                  };
                                  if (!stopped) {
                                      return normalizedMoveX;
                                  };
                                  throw new Error("Failed pattern match at Game.Cubbit.Update line 95, column 40 - line 95, column 111: " + [ stopped.constructor.name ]);
                              };
                              if (!isLanding) {
                                  return playingSceneState.velocity.x;
                              };
                              throw new Error("Failed pattern match at Game.Cubbit.Update line 95, column 21 - line 95, column 146: " + [ isLanding.constructor.name ]);
                          })();
                          var velocityY = (function () {
                              var $46 = isLanding && !Data_Set.member(Data_Ord.ordString)(" ")(v1.keys);
                              if ($46) {
                                  return 0.0;
                              };
                              if (!$46) {
                                  return playingSceneState.velocity.y + jumpVelocity + gravityAccelerator;
                              };
                              throw new Error("Failed pattern match at Game.Cubbit.Update line 96, column 21 - line 96, column 143: " + [ $46.constructor.name ]);
                          })();
                          var velocityZ = (function () {
                              if (isLanding) {
                                  if (stopped) {
                                      return playingSceneState.velocity.z * 0.5;
                                  };
                                  if (!stopped) {
                                      return normalizedMoveZ;
                                  };
                                  throw new Error("Failed pattern match at Game.Cubbit.Update line 97, column 40 - line 97, column 111: " + [ stopped.constructor.name ]);
                              };
                              if (!isLanding) {
                                  return playingSceneState.velocity.z;
                              };
                              throw new Error("Failed pattern match at Game.Cubbit.Update line 97, column 21 - line 97, column 146: " + [ isLanding.constructor.name ]);
                          })();
                          var velocity = (function () {
                              var $49 = 0 < playingSceneState.landing;
                              if ($49) {
                                  return Game_Cubbit_Vec.vecZero;
                              };
                              if (!$49) {
                                  return Game_Cubbit_Vec.vec(velocityX)(velocityY)(velocityZ);
                              };
                              throw new Error("Failed pattern match at Game.Cubbit.Update line 98, column 20 - line 98, column 104: " + [ $49.constructor.name ]);
                          })();
                          var playerRotation$prime = (function () {
                              if (isLanding) {
                                  var $51 = 0 < playingSceneState.landing;
                                  if ($51) {
                                      return playingSceneState.playerRotation;
                                  };
                                  if (!$51) {
                                      var $52 = stopped || playingSceneState.firstPersonView;
                                      if ($52) {
                                          return playingSceneState.playerRotation;
                                      };
                                      if (!$52) {
                                      ...
                                      throw new Error("Failed pattern match at Game.Cubbit.Update line 104, column 22 - line 106, column 60: " + [ $52.constructor.name ]);
                                  };
                                  throw new Error("Failed pattern match at Game.Cubbit.Update line 102, column 19 - line 106, column 60: " + [ $51.constructor.name ]);
                              };
                              if (!isLanding) {
                                  return playingSceneState.playerRotation;
                              };
                              throw new Error("Failed pattern match at Game.Cubbit.Update line 101, column 27 - line 107, column 52: " + [ isLanding.constructor.name ]);
                          })();
                          var playerPosition = {
                          ...
                          var animation$prime = (function () {
                              var $53 = 0 < playingSceneState.landing;
                              if ($53) {
                                  return "land";
                              };
                              if (!$53) {
                                  if (isLanding) {
                                      var $55 = Data_Foldable.any(Data_Foldable.foldableArray)(Data_HeytingAlgebra.heytingAlgebraBoolean)(function (k) {
                                      ...
                                      throw new Error("Failed pattern match at Game.Cubbit.Update line 120, column 23 - line 120, column 101: " + [ $55.constructor.name ]);
                                  };
                                  if (!isLanding) {
                                      return "jump";
                                  };
                                  throw new Error("Failed pattern match at Game.Cubbit.Update line 119, column 18 - line 123, column 5: " + [ isLanding.constructor.name ]);
                              };
                              throw new Error("Failed pattern match at Game.Cubbit.Update line 117, column 22 - line 123, column 5: " + [ $53.constructor.name ]);
                          })();
                          ...
                          var position$prime = (function () {
                              if (v3 instanceof Data_Maybe.Just && Game_Cubbit_Terrain.isSolidBlock(v3.value0)) {
                                  var $58 = {};
                                  for (var $59 in playerPosition) {
                                      if (playerPosition.hasOwnProperty($59)) {
                                          $58[$59] = playerPosition[$59];
                                      };
                                  };
                                  $58.y = Data_Int.toNumber(globalIndex.y) + 1.001;
                                  return $58;
                              };
                          ...
                          var landingCount = (function () {
                              var $65 = isLanding$prime && playingSceneState.velocity.y < v.landingVelocityLimit;
                              if ($65) {
                              ...
                              throw new Error("Failed pattern match at Game.Cubbit.Update line 140, column 24 - line 140, column 160: " + [ $65.constructor.name ]);
                          })();
                          var cameraSpeed = (function () {
                              ...
                              throw new Error("Failed pattern match at Game.Cubbit.Update line 143, column 23 - line 143, column 99: " + [ playingSceneState.firstPersonView.constructor.name ]);
                          })();
                          var thirdPersonCameraTargetX = position$prime.x + velocityX * 20.0;
                          var thirdPersonCameraTargetY = position$prime.y + v.eyeHeight;
                          var thirdPersonCameraTargetZ = position$prime.z + velocityZ * 20.0;
                          var playerRotationTheta = -playingSceneState.playerRotation - $$Math.pi * 0.5;
                          var firstPersonCameraTargetX = position$prime.x + $$Math.cos(playerRotationTheta) * $$Math.cos(playingSceneState.playerPitch);
                          var firstPersonCameraTargetY = position$prime.y + v.eyeHeight + $$Math.sin(playingSceneState.playerPitch);
                          var firstPersonCameraTargetZ = position$prime.z + $$Math.sin(playerRotationTheta) * $$Math.cos(playingSceneState.playerPitch);
                          ...
                          var cameraTargetZ$prime = (function () {
                              ...
                              throw new Error("Failed pattern match at Game.Cubbit.Update line 159, column 26 - line 159, column 122: " + [ playingSceneState.firstPersonView.constructor.name ]);
                          })();
                          ...
                          var thirdPersonCameraPositionX = position$prime.x + $$Math.cos(theta) * $$Math.cos(playingSceneState.cameraPitch) * playingSceneState.cameraRange + velocityX * 20.0;
                          var thirdPersonCameraPositionY = position$prime.y + v.eyeHeight + $$Math.sin(playingSceneState.cameraPitch) * playingSceneState.cameraRange;
                          var thirdPersonCameraPositionZ = position$prime.z + $$Math.sin(theta) * $$Math.cos(playingSceneState.cameraPitch) * playingSceneState.cameraRange + velocityZ * 20.0;
                          var firstPersonCameraPositionY = position$prime.y + v.eyeHeight;
                          ...
                          var sceneState = (function () {
                              var $79 = {};
                              for (var $80 in playingSceneState) {
                                  if (playingSceneState.hasOwnProperty($80)) {
                                      $79[$80] = playingSceneState[$80];
                                  };
                              };
                              $79.cameraYaw = playingSceneState.cameraYaw + ((function () {
                                  var $73 = Data_Set.member(Data_Ord.ordString)("q")(v1.keys);
                                  if ($73) {
                                      return 1.0;
                                  };
                                  if (!$73) {
                                  ...
                                  throw new Error("Failed pattern match at Game.Cubbit.Update line 192, column 61 - line 192, column 103: " + [ $73.constructor.name ]);
                              })() - (function () {
                                  var $74 = Data_Set.member(Data_Ord.ordString)("e")(v1.keys);
                                  if ($74) {
                                      return 1.0;
                                  };
                                  if (!$74) {
                                  ...
                                  throw new Error("Failed pattern match at Game.Cubbit.Update line 192, column 108 - line 192, column 150: " + [ $74.constructor.name ]);
                              })()) * v.cameraRotationSpeed;
                              $79.cameraPitch = Data_Ord.max(Data_Ord.ordNumber)(0.1)(Data_Ord.min(Data_Ord.ordNumber)($$Math.pi * 0.48)(playingSceneState.cameraPitch + ((function () {
                                  var $75 = Data_Set.member(Data_Ord.ordString)("r")(v1.keys);
                                  if ($75) {
                                      return 1.0;
                                  };
                                  if (!$75) {
                                  ...
                                  throw new Error("Failed pattern match at Game.Cubbit.Update line 193, column 91 - line 193, column 133: " + [ $75.constructor.name ]);
                              })() - (function () {
                                  var $76 = Data_Set.member(Data_Ord.ordString)("f")(v1.keys);
                                  if ($76) {
                                      return 1.0;
                                  };
                                  if (!$76) {
                                  ...
                                  throw new Error("Failed pattern match at Game.Cubbit.Update line 193, column 138 - line 193, column 180: " + [ $76.constructor.name ]);
                              })()) * v.cameraRotationSpeed));
                              $79.cameraRange = Data_Ord.max(Data_Ord.ordNumber)(v.cameraMinimumRange)(Data_Ord.min(Data_Ord.ordNumber)(v.cameraMaximumRange)(playingSceneState.cameraRange + ((function () {
                                  var $77 = Data_Set.member(Data_Ord.ordString)("g")(v1.keys);
                                  if ($77) {
                                      return 1.0;
                                  };
                                  if (!$77) {
                                  ...
                                  throw new Error("Failed pattern match at Game.Cubbit.Update line 194, column 129 - line 194, column 171: " + [ $77.constructor.name ]);
                              })() - (function () {
                                  var $78 = Data_Set.member(Data_Ord.ordString)("t")(v1.keys);
                                  if ($78) {
                                      return 1.0;
                                  };
                                  if (!$78) {
                                  ...
                                  throw new Error("Failed pattern match at Game.Cubbit.Update line 194, column 176 - line 194, column 218: " + [ $78.constructor.name ]);
                              })()) * v.cameraZoomSpeed));
                              $79.position = position$prime;
                              $79.velocity = velocity;
                              $79.playerRotation = playerRotation$prime;
                              $79.animation = animation$prime;
                              $79.landing = Data_Ord.max(Data_Ord.ordInt)(0)(landingCount - 1);
                              return $79;
                          })();
                          var state$prime = (function () {
                              var $82 = {};
                              for (var $83 in v1) {
                                  if (v1.hasOwnProperty($83)) {
                                      $82[$83] = v1[$83];
                                  };
                              };
                              $82.sceneState = new Game_Cubbit_Types.PlayingSceneState(sceneState);
                              $82.cameraTarget = cameraTarget$prime;
                              $82.cameraPosition = {
                                  x: cameraPositionInterpolatedX, 
                                  y: cameraPositionInterpolatedY, 
                                  z: cameraPositionInterpolatedZ
                              };
                              $82.totalFrames = v1.totalFrames + 1 | 0;
                              $82.skyboxRotation = v1.skyboxRotation + v.skyboxRotationSpeed * deltaTime;
                              return $82;
                          })();
                                      ...
                                      return function (skybox) {
                                          return function (driver) {
                                              return function __do() {
                                                  ...
                                                  var v2 = Graphics_Babylon_Engine.getDeltaTime(engine)();
                                                  var playerMeshes = (function () {
                                                      ...
                                                      throw new Error("Failed pattern match at Game.Cubbit.Update line 233, column 28 - line 235, column 49: " + [ v1.res.constructor.name ]);
                                                  })();
                                                  var v3 = (function () {
                                                      if (v1.sceneState instanceof Game_Cubbit_Types.TitleSceneState) {
                                                          var state$prime = (function () {
                                                              ...
                                                              $106.sceneState = new Game_Cubbit_Types.TitleSceneState((function () {
                                                                  var $103 = {};
                                                                  for (var $104 in v1.sceneState.value0) {
                                                                      if (v1.sceneState.value0.hasOwnProperty($104)) {
                                                                          $103[$104] = v1.sceneState.value0[$104];
                                                                      };
                                                                  };
                                                                  $103.position = v1.sceneState.value0.position + v2 * 8.0e-4;
                                                                  return $103;
                                                              })());
                                                              return $106;
                                                          })();
                                                      ...
                                                      if (v1.sceneState instanceof Game_Cubbit_Types.PlayingSceneState) {
                                                          return function __do() {
                                                              var v3 = calcurateNextState(v)(v2)(v1)(v1.sceneState.value0);
                                                              Control_Applicative.when(Control_Monad_Eff.applicativeEff)(v3.value1.animation !== v1.sceneState.value0.animation)(Game_Cubbit_Control.playAnimation(v3.value1.animation)(playerMeshes))();
                                                              ...
                                                              Data_Foldable.for_(Control_Monad_Eff.applicativeEff)(Data_Foldable.foldableArray)(playerMeshes)(function (mesh) {
                                                                  return Data_Functor["void"](Control_Monad_Eff.functorEff)(function __do() {
                                                                      ...
                                                                      return Graphics_Babylon_AbstractMesh.setVisibility((function () {
                                                                          ...
                                                                          throw new Error("Failed pattern match at Game.Cubbit.Update line 261, column 36 - line 261, column 90: " + [ v1.sceneState.value0.firstPersonView.constructor.name ]);
                                                                      })())(mesh)();
                                                                  });
                                                              })();
                                                              (function () {
                                                                  ...
                                                                  return function __do() {
                                                                      var v6 = Game_Cubbit_Control.pickBlock(scene)(cursor)(v3.value1.mode)(v1.terrain)(v1.mousePosition.x)(v1.mousePosition.y)();
                                                                      if (v6 instanceof Data_Maybe.Nothing) {
                                                                          return Data_Unit.unit;
                                                                      };
                                                                      if (v6 instanceof Data_Maybe.Just) {
                                                                          return Data_Functor["void"](Control_Monad_Eff.functorEff)((function () {
                                                                              var rbi = Game_Cubbit_BlockIndex.runBlockIndex(v6.value0);
                                                                              return function __do() {
                                                                                  var v7 = Graphics_Babylon_Vector3.createVector3(Data_Int.toNumber(rbi.x) + 0.5)(Data_Int.toNumber(rbi.y) + 0.5)(Data_Int.toNumber(rbi.z) + 0.5)();
                                                                                  Graphics_Babylon_Mesh.setPosition(v7)(cursor)();
                                                                                  return Game_Cubbit_Hud_Driver.queryToHud(driver)(Game_Cubbit_Hud_Type.Query.create(new Game_Cubbit_Hud_Type.PlayingSceneQuery(new Game_Cubbit_Hud_Type.SetCursorPosition(v6.value0))))();
                                                                              };
                                                                          })())();
                                                                      };
                                                                      throw new Error("Failed pattern match at Game.Cubbit.Update line 271, column 29 - line 277, column 105: " + [ v6.constructor.name ]);
                                                                  };
                                                              })()();
                                                              Graphics_Babylon_AbstractMesh.setIsVisible((function () {
                                                                  ...
                                                                  throw new Error("Failed pattern match at Game.Cubbit.Update line 281, column 35 - line 284, column 38: " + [ v3.value1.mode.constructor.name ]);
                                                              })())(Graphics_Babylon_Mesh.meshToAbstractMesh(cursor))();
                                                              (function () {
                                                                  var $121 = v1.sceneState.value0.animation !== "run" && v3.value1.animation === "run";
                                                                  if ($121) {
                                                                      return Graphics_Babylon_Sound.play(sounds.stepSound);
                                                                  };
                                                                  if (!$121) {
                                                                      var $122 = v1.sceneState.value0.animation === "run" && v3.value1.animation !== "run";
                                                                      if ($122) {
                                                                      ...
                                                                      throw new Error("Failed pattern match at Game.Cubbit.Update line 290, column 30 - line 292, column 43: " + [ $122.constructor.name ]);
                                                                  };
                                                                  throw new Error("Failed pattern match at Game.Cubbit.Update line 288, column 21 - line 292, column 43: " + [ $121.constructor.name ]);
                                                              })()();
                                                              return v3.value0;
                                                          };
                                                      };
                                                      throw new Error("Failed pattern match at Game.Cubbit.Update line 237, column 51 - line 294, column 36: " + [ v1.sceneState.constructor.name ]);
                                                  })()();
                                                  Control_Monad_Eff_Ref.writeRef(ref)(v3)();
                                                  var cameraPositionChunkIndex = Game_Cubbit_Terrain.globalPositionToChunkIndex(v3.cameraPosition.x)(v3.cameraPosition.y)(v3.cameraPosition.z);
                                                  var v4 = Graphics_Babylon_Vector3.createVector3(v3.cameraPosition.x)(v3.cameraPosition.y)(v3.cameraPosition.z)();
                                                  var v5 = Graphics_Babylon_Vector3.createVector3(v3.cameraTarget.x)(v3.cameraTarget.y)(v3.cameraTarget.z)();
                                                  var v6 = Game_Cubbit_Terrain.lookupBlockByVec(v3.cameraPosition)(v3.terrain)();
                                                  var v7 = (function () {
                                                      if (v6 instanceof Data_Maybe.Just && Game_Cubbit_Terrain.isSolidBlock(v6.value0)) {
                                                          return function __do() {
                                                              var v7 = Graphics_Babylon_Vector3.subtract(v5)(v4)();
                                                              var v8 = Graphics_Babylon_Vector3.length(v7)();
                                                              var v9 = Graphics_Babylon_Ray.createRayWithLength(v4)(v7)(v8)();
                                                              var predicate = function (mesh) {
                                                                  var name = Graphics_Babylon_Node.getName(Graphics_Babylon_AbstractMesh.abstractMeshToNode(mesh));
                                                                  return Control_Applicative.pure(Control_Monad_Eff.applicativeEff)(name === "terrain");
                                                              };
                                                              var v10 = Graphics_Babylon_Scene.pickWithRay(v9)(predicate)(true)(scene)();
                                                              var pickedPoint = Graphics_Babylon_PickingInfo.getPickedPoint(v10);
                                                              var $135 = Graphics_Babylon_PickingInfo.getPickedPoint(v10);
                                                              ...
                                                              throw new Error("Failed pattern match at Game.Cubbit.Update line 320, column 22 - line 322, column 44: " + [ $135.constructor.name ]);
                                                          };
                                                      };
                                                      return Control_Applicative.pure(Control_Monad_Eff.applicativeEff)(v4);
                                                  })()();
                                                  Graphics_Babylon_Camera.setPosition(v7)(Graphics_Babylon_TargetCamera.targetCameraToCamera(camera))();
                                                  Graphics_Babylon_TargetCamera.setTarget(v5)(camera)();
                                                  var v8 = Graphics_Babylon_Vector3.createVector3(0.0)(v3.skyboxRotation)(0.0)();
                                                  Graphics_Babylon_AbstractMesh.setRotation(v8)(Graphics_Babylon_Mesh.meshToAbstractMesh(skybox))();
                                                  (function __do() {
                                                      var v9 = Control_Monad_Eff_Ref.newRef(0)();
                                                      var ci = Game_Cubbit_ChunkIndex.runChunkIndex(cameraPositionChunkIndex);
                                                      var loadAndGenerateChunk = function (index) {
                                                          return Game_Cubbit_MeshBuilder.generateChunk(ref)(materials)(scene)(index)(v)(v1.config);
                                                      };
                                                      var loadDistance = 3 + v3.config.chunkArea | 0;
                                                      var v10 = $foreign.foreachBlocks(loadDistance)(ci.x)(ci.y)(ci.z)(v1.updateIndex)(function (x) {
                                                          return function (y) {
                                                              return function (z) {
                                                                  var index = Game_Cubbit_ChunkIndex.chunkIndex(x)(y)(z);
                                                                  return function __do() {
                                                                      var v10 = Game_Cubbit_Terrain.lookupChunk(index)(v1.terrain)();
                                                                      if (v10 instanceof Data_Maybe.Just) {
                                                                          if (v10.value0.standardMaterialMesh instanceof Game_Cubbit_Chunk.MeshNotLoaded) {
                                                                      ...
                                                                      throw new Error("Failed pattern match at Game.Cubbit.Update line 357, column 17 - line 369, column 13: " + [ v10.constructor.name ]);
                                                                  };
                                                              };
                                                          };
                                                      })();
                                                      return Control_Monad_Eff_Ref.modifyRef(ref)(function (v11) {
                                                          var $147 = {};
                                                          for (var $148 in v11) {
                                                              if (v11.hasOwnProperty($148)) {
                                                                  $147[$148] = v11[$148];
                                                              };
                                                          };
                                                          $147.updateIndex = Data_Nullable.toNullable(new Data_Maybe.Just(v10));
                                                          return $147;
                                                      })();
                                                  })();
                                                  (function () {
                                                  ...
                                                  if (v3.config.shadow) {
                                                      var shadowDisplayRange = 1 + v3.config.shadowArea | 0;
                                                  ...
                                                  throw new Error("Failed pattern match at Game.Cubbit.Update line 390, column 9 - line 401, column 43: " + [ v3.config.shadow.constructor.name ]);
                                              };
                                          };
                                      };
                                  };
...
(function(exports) {
  ...
  var main = function __do() {
              ...
              return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Game_Cubbit_Config.readConfig))(function (v2) {
                  return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Game_Cubbit_Terrain.createTerrain(0)))(function (v3) {
                      ...
                      return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Control_Monad_Eff_Ref.newRef(initialState)))(function (v4) {
                          return Control_Bind.bind(Control_Monad_Aff.bindAff)(Game_Cubbit_Hud_Driver.initializeHud(initialState)(v4)(v1))(function (v5) {
                              return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Control_Monad_Eff_Ref.newRef(0)))(function (v6) {
                                  var inc = Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Control_Monad_Eff_Ref.modifyRef(v6)(function (v7) {
                                      return v7 + 1 | 0;
                                  })))(function () {
                                      return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Control_Monad_Eff_Ref.readRef(v6)))(function (v7) {
                                          return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Control_Monad_Eff_Console.log(Data_Show.show(Data_Show.showInt)(v7) + (" / " + Data_Show.show(Data_Show.showInt)(Game_Cubbit_Resources.resourceCount)))))(function () {
                                              return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Control_Monad_Eff_Ref.readRef(v4)))(function (v8) {
                                                  return Game_Cubbit_Hud_Eval.repaint(v5)((function () {
                                                      var $25 = {};
                                                      for (var $26 in v8) {
                                                          if (v8.hasOwnProperty($26)) {
                                                              $25[$26] = v8[$26];
                                                          };
                                                      };
                                                      $25.res = new Game_Cubbit_Types.Loading(v7);
                                                      return $25;
                                                  })());
                                              });
                                          });
                                  ...
                                  return Control_Bind.bind(Control_Monad_Aff.bindAff)(Game_Cubbit_Resources.loadResources(v.value0)(inc))(function (v7) {
                                      return Control_Bind.bind(Control_Monad_Aff.bindAff)(Game_Cubbit_Hud_Eval.repaint(v5)((function () {
                                          var $29 = {};
                                          for (var $30 in initialState) {
                                              if (initialState.hasOwnProperty($30)) {
                                                  $29[$30] = initialState[$30];
                                              };
                                          };
                                          $29.res = new Game_Cubbit_Types.Complete(v7);
                                          return $29;
                                      })()))(function () {
                                          return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Applicative.pure(Control_Monad_Aff.applicativeAff)(v7.options))(function (v8) {
                                              return Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(function __do() {
                                                  Control_Monad_Eff.forE(-v8.initialWorldSize)(v8.initialWorldSize)(function (x) {
                                                      return Control_Monad_Eff.forE(-v8.initialWorldSize)(v8.initialWorldSize)(function (z) {
                                                          return Data_Functor["void"](Control_Monad_Eff.functorEff)((function () {
                                                              var index = Game_Cubbit_ChunkIndex.chunkIndex(x)(0)(z);
                                                              return Game_Cubbit_MeshBuilder.generateChunk(v4)(v7.materials)(v7.scene)(index)(v8)(v2);
                                                          })());
                                                      });
                                                  })();
                                                  Game_Cubbit_Event.focus("content")();
                                                  Game_Cubbit_Sounds.setMute(v2.mute)(v7.sounds)();
                                                  Game_Cubbit_Sounds.setBGMVolume(Data_Int.toNumber(v2.bgmVolume) / Data_Int.toNumber(Game_Cubbit_Constants.sliderMaxValue))(v7.sounds)();
                                                  Game_Cubbit_Sounds.setSEVolume(Data_Int.toNumber(v2.seVolume) / Data_Int.toNumber(Game_Cubbit_Constants.sliderMaxValue))(v7.sounds)();
                                                  Graphics_Babylon_Sound.play(v7.sounds.cleaning)();
                                                  var v9 = Graphics_Cannon_World.createWorld();
                                                  var v10 = Graphics_Cannon_Vec3.createVec3(0.5)(0.5)(0.5)();
                                                  var v11 = Graphics_Cannon.createBox(v10)();
                                                  var v12 = Graphics_Cannon_Body.createBody(Graphics_Cannon_Body.defaultBodyProps)();
                                                  Graphics_Cannon_World.addBody(v12)(v9)();
                                                  return Graphics_Babylon_Engine.runRenderLoop(function __do() {
                                                      Game_Cubbit_Update.update(v4)(v7.engine)(v7.scene)(v7.materials)(v7.sounds)(v7.shadowMap)(v7.cursor)(v7.targetCamera)(v8)(v7.skybox)(v5)();
                                                      Graphics_Babylon_Scene.render(v7.scene)();
                                                      return Graphics_Cannon_World.step(1.0 / 60.0)(0.0)(10)(v9)();
                                                  })(v7.engine)();
                                              });
                                          });
                                      });
      ...
      throw new Error("Failed pattern match at Game.Cubbit.Main line 38, column 62 - line 131, column 49: " + [ v.constructor.name ]);
  };
  exports["main"] = main;
