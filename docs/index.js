          ...
          return function __do() {
              ...
              return Data_Foldable.for_(Control_Monad_Eff.applicativeEff)(Data_Foldable.foldableArray)(v.playerMeshes)(function (mesh) {
                  return Data_Functor["void"](Control_Monad_Eff.functorEff)(function __do() {
                      ...
                      return Graphics_Babylon_Skeleton.beginAnimation(name)(true)(1.0)(Control_Applicative.pure(Control_Monad_Eff.applicativeEff))(v1)();
                  });
              })();
          };
      };
              ...
              return function (screenX) {
                  return function (screenY) {
                      ...
                      return function __do() {
                          ...
                          var $50 = Graphics_Babylon_PickingInfo.getPickedPoint(v1);
                          if ($50 instanceof Data_Maybe.Nothing) {
                              return Data_Maybe.Nothing.value;
                          };
                          if ($50 instanceof Data_Maybe.Just) {
                              var v2 = Graphics_Babylon_Vector3.runVector3($50.value0)();
                              ...
                              if (v.mode instanceof Game_Cubbit_Types.Put) {
                                  ...
                                  if (!$54) {
                                      ...
                                      throw new Error("Failed pattern match at Game.Cubbit.Update line 80, column 30 - line 93, column 57: " + [ $61.constructor.name ]);
                                  };
                                  throw new Error("Failed pattern match at Game.Cubbit.Update line 73, column 24 - line 93, column 57: " + [ $54.constructor.name ]);
                              };
                              if (v.mode instanceof Game_Cubbit_Types.Remove) {
                                  ...
                                  if (!$74) {
                                      ...
                                      throw new Error("Failed pattern match at Game.Cubbit.Update line 102, column 30 - line 115, column 57: " + [ $81.constructor.name ]);
                                  };
                                  throw new Error("Failed pattern match at Game.Cubbit.Update line 95, column 27 - line 115, column 57: " + [ $74.constructor.name ]);
                              };
                              if (v.mode instanceof Game_Cubbit_Types.Move) {
                                  return Data_Maybe.Nothing.value;
                              };
                              throw new Error("Failed pattern match at Game.Cubbit.Update line 72, column 13 - line 117, column 37: " + [ v.mode.constructor.name ]);
                          };
                          throw new Error("Failed pattern match at Game.Cubbit.Update line 57, column 5 - line 117, column 37: " + [ $50.constructor.name ]);
                      };
                  };
              };
          };
                              ...
                              return function (skybox) {
                                  return function __do() {
                                      Control_Monad_Eff_Ref.modifyRef(ref)(function (v) {
                                          ...
                                          $96.totalFrames = v.totalFrames + 1 | 0;
                                          return $96;
                                      })();
                                      var v = Control_Monad_Eff_Ref.readRef(ref)();
                                      ...
                                      (function () {
                                          ...
                                          return function __do() {
                                              ...
                                              if (v2 instanceof Data_Maybe.Just) {
                                                  var rbi = Game_Cubbit_BlockIndex.runBlockIndex(v2.value0);
                                                  var v3 = Graphics_Babylon_Vector3.createVector3(Data_Int.toNumber(rbi.x) + 0.5)(Data_Int.toNumber(rbi.y) + 0.5)(Data_Int.toNumber(rbi.z) + 0.5)();
                                                  Graphics_Babylon_Mesh.setPosition(v3)(cursor)();
                                              ...
                                              throw new Error("Failed pattern match at Game.Cubbit.Update line 140, column 21 - line 147, column 118: " + [ v2.constructor.name ]);
                                          };
                                      })()();
                                      (function () {
                                          var cci = Game_Cubbit_ChunkIndex.runChunkIndex(cameraPositionChunkIndex);
                                          return function __do() {
                                              var v2 = Game_Cubbit_ChunkMap.filterNeighbors(options.shadowDisplayRange)(cci.x)(cci.y)(cci.z)(v.terrain.map)();
                                      ...
                                      (function __do() {
                                          ...
                                          var v3 = $foreign.foreachBlocks(options.loadDistance)(ci.x)(ci.y)(ci.z)(v.updateIndex)(function (x) {
                                              return function (y) {
                                                  return function (z) {
                                                      ...
                                                      return function __do() {
                                                          var v3 = Game_Cubbit_Terrain.lookupChunk(index)(v.terrain)();
                                                          if (v3 instanceof Data_Maybe.Just) {
                                                              if (v3.value0.standardMaterialMesh instanceof Game_Cubbit_Chunk.MeshNotLoaded) {
                                                          ...
                                                          throw new Error("Failed pattern match at Game.Cubbit.Update line 183, column 17 - line 195, column 13: " + [ v3.constructor.name ]);
                                                      };
                                                  };
                                              };
                                          })();
                                          return Control_Monad_Eff_Ref.modifyRef(ref)(function (v4) {
                                              var $116 = {};
                                              for (var $117 in v4) {
                                                  if (v4.hasOwnProperty($117)) {
                                                      $116[$117] = v4[$117];
                                                  };
                                              };
                                              $116.updateIndex = Data_Nullable.toNullable(new Data_Maybe.Just(v3));
                                              return $116;
                                          })();
                                      })();
                                      (function () {
                                          ...
                                          return function __do() {
                                              ...
                                              var v3 = Game_Cubbit_ChunkMap.size(v2.terrain.map)();
                                              return Control_Applicative.when(Control_Monad_Eff.applicativeEff)(options.maximumLoadedChunks < v3)(function __do() {
                                                  var v4 = Game_Cubbit_ChunkMap.getSortedChunks(ci.x)(ci.y)(ci.z)(v2.terrain.map)();
                                                  var sliced = Data_Array.drop(options.maximumLoadedChunks)(v4);
                                                  return Data_Foldable.for_(Control_Monad_Eff.applicativeEff)(Data_Foldable.foldableArray)(Data_Array.take(options.chunkUnloadSpeed)(sliced))(function (chunkWithMesh) {
                                                      return function __do() {
                                                          ...
                                                          return Game_Cubbit_ChunkMap["delete"](chunkWithMesh.index)(v2.terrain.map)();
                                                      };
                                                  })();
                                              })();
                                          };
                                      ...
                                      var rot = -(function () {
                                          if (v2.firstPersonView) {
                                              return v2.playerRotation + $$Math.pi;
                                          };
                                          if (!v2.firstPersonView) {
                                              return v2.cameraYaw;
                                          };
                                          throw new Error("Failed pattern match at Game.Cubbit.Update line 221, column 24 - line 221, column 101: " + [ v2.firstPersonView.constructor.name ]);
                                      })();
                                      var keyVector = {
                                          x: (function () {
                                              if (v2.dKey) {
                                              ...
                                              if (!v2.dKey) {
                                                  return 0.0 - (function () {
                                                      ...
                                                      throw new Error("Failed pattern match at Game.Cubbit.Update line 224, column 49 - line 224, column 83: " + [ v2.aKey.constructor.name ]);
                                                  })();
                                              };
                                              throw new Error("Failed pattern match at Game.Cubbit.Update line 224, column 24 - line 224, column 83: " + [ v2.dKey.constructor.name ]);
                                          })(), 
                                          z: (function () {
                                              if (v2.wKey) {
                                                  return 1.0;
                                              ...
                                              if (!v2.wKey) {
                                                  return 0.0 - (function () {
                                                      ...
                                                      throw new Error("Failed pattern match at Game.Cubbit.Update line 225, column 49 - line 226, column 17: " + [ v2.sKey.constructor.name ]);
                                                  })();
                                              };
                                              throw new Error("Failed pattern match at Game.Cubbit.Update line 225, column 24 - line 226, column 17: " + [ v2.wKey.constructor.name ]);
                                          })()
                                      };
                                      ...
                                      var velocity = (function () {
                                          if (stopped) {
                                              var $130 = {};
                                              for (var $131 in v.velocity) {
                                                  if (v.velocity.hasOwnProperty($131)) {
                                                      $130[$131] = v.velocity[$131];
                                                  };
                                              };
                                              $130.x = v.velocity.x * 0.5;
                                              $130.z = v.velocity.z * 0.5;
                                              return $130;
                                          };
                                          if (!stopped) {
                                              var len = $$Math.sqrt(rotatedKeyVector.x * rotatedKeyVector.x + rotatedKeyVector.z * rotatedKeyVector.z);
                                              var $133 = {};
                                              for (var $134 in v.velocity) {
                                                  if (v.velocity.hasOwnProperty($134)) {
                                                      $133[$134] = v.velocity[$134];
                                                  };
                                              };
                                              $133.x = (rotatedKeyVector.x / len) * options.moveSpeed;
                                              $133.z = (rotatedKeyVector.z / len) * options.moveSpeed;
                                              return $133;
                                          };
                                          throw new Error("Failed pattern match at Game.Cubbit.Update line 235, column 28 - line 243, column 26: " + [ stopped.constructor.name ]);
                                      })();
                                      var playerRotation$prime = (function () {
                                          var $136 = stopped || v2.firstPersonView;
                                          if ($136) {
                                              return v2.playerRotation;
                                          };
                                          if (!$136) {
                                              return $$Math.atan2(velocity.x)(velocity.z) - $$Math.pi;
                                          };
                                          throw new Error("Failed pattern match at Game.Cubbit.Update line 246, column 35 - line 246, column 130: " + [ $136.constructor.name ]);
                                      })();
                                      var playerPosition = {
                                      ...
                                      var animation$prime = (function () {
                                          var $137 = v2.wKey || (v2.sKey || (v2.aKey || v2.dKey));
                                          if ($137) {
                                              return "Action";
                                          };
                                          if (!$137) {
                                          ...
                                          throw new Error("Failed pattern match at Game.Cubbit.Update line 254, column 30 - line 256, column 13: " + [ $137.constructor.name ]);
                                      })();
                                      ...
                                      var v3 = Game_Cubbit_Terrain.lookupBlockByVec(playerPosition)(v2.terrain)();
                                      var position$prime = (function () {
                                          if (v3 instanceof Data_Maybe.Just && Game_Cubbit_Terrain.isSolidBlock(v3.value0)) {
                                              var $140 = {};
                                              for (var $141 in playerPosition) {
                                                  if (playerPosition.hasOwnProperty($141)) {
                                                      $140[$141] = playerPosition[$141];
                                                  };
                                              };
                                              $140.y = Data_Int.toNumber(globalIndex.y) + 1.001;
                                              return $140;
                                          };
                                      ...
                                      var velocity$prime = (function () {
                                          if (v3 instanceof Data_Maybe.Just && Game_Cubbit_Terrain.isSolidBlock(v3.value0)) {
                                              var $145 = {};
                                              for (var $146 in velocity) {
                                                  if (velocity.hasOwnProperty($146)) {
                                                      $145[$146] = velocity[$146];
                                                  };
                                              };
                                              $145.y = 0.0;
                                              return $145;
                                          ...
                                          var $149 = {};
                                          for (var $150 in velocity) {
                                              if (velocity.hasOwnProperty($150)) {
                                                  $149[$150] = velocity[$150];
                                              };
                                          };
                                          $149.y = velocity.y - 1.0e-2;
                                          return $149;
                                      })();
                                      var cameraSpeed = (function () {
                                          ...
                                          throw new Error("Failed pattern match at Game.Cubbit.Update line 271, column 31 - line 271, column 92: " + [ v2.firstPersonView.constructor.name ]);
                                      })();
                                      var thirdPersonCameraTargetY = position$prime.y + 1.4;
                                      var playerRotationTheta = -v2.playerRotation - $$Math.pi * 0.5;
                                      var firstPersonCameraTargetX = position$prime.x + $$Math.cos(playerRotationTheta) * $$Math.cos(v2.playerPitch);
                                      var firstPersonCameraTargetY = position$prime.y + 1.4 + $$Math.sin(v2.playerPitch);
                                      var firstPersonCameraTargetZ = position$prime.z + $$Math.sin(playerRotationTheta) * $$Math.cos(v2.playerPitch);
                                      var cameraTargetX$prime = (function () {
                                          ...
                                          throw new Error("Failed pattern match at Game.Cubbit.Update line 284, column 34 - line 284, column 115: " + [ v2.firstPersonView.constructor.name ]);
                                      })();
                                      var cameraTargetY$prime = (function () {
                                          ...
                                          throw new Error("Failed pattern match at Game.Cubbit.Update line 285, column 34 - line 285, column 115: " + [ v2.firstPersonView.constructor.name ]);
                                      })();
                                      var cameraTargetZ$prime = (function () {
                                          ...
                                          throw new Error("Failed pattern match at Game.Cubbit.Update line 286, column 34 - line 286, column 115: " + [ v2.firstPersonView.constructor.name ]);
                                      })();
                                      var cameraTargetInterpolatedX$prime = v2.viewReferencePoint.x + (cameraTargetX$prime - v2.viewReferencePoint.x) * cameraSpeed;
                                      var cameraTargetInterpolatedY$prime = v2.viewReferencePoint.y + (cameraTargetY$prime - v2.viewReferencePoint.y) * cameraSpeed;
                                      var cameraTargetInterpolatedZ$prime = v2.viewReferencePoint.z + (cameraTargetZ$prime - v2.viewReferencePoint.z) * cameraSpeed;
                                      var viewReferencePoint$prime = {
                                          x: cameraTargetInterpolatedX$prime, 
                                          y: cameraTargetInterpolatedY$prime, 
                                          z: cameraTargetInterpolatedZ$prime
                                      };
                                      var theta = -v2.cameraYaw - $$Math.pi * 0.5;
                                      var thirdPersonCameraPositionX = position$prime.x + $$Math.cos(theta) * $$Math.cos(v2.cameraPitch) * v2.cameraRange;
                                      var thirdPersonCameraPositionY = position$prime.y + $$Math.sin(v2.cameraPitch) * v2.cameraRange;
                                      var thirdPersonCameraPositionZ = position$prime.z + $$Math.sin(theta) * $$Math.cos(v2.cameraPitch) * v2.cameraRange;
                                      ...
                                      var cameraPositionX = (function () {
                                          ...
                                          throw new Error("Failed pattern match at Game.Cubbit.Update line 304, column 35 - line 304, column 120: " + [ v2.firstPersonView.constructor.name ]);
                                      })();
                                      var cameraPositionY = (function () {
                                          ...
                                          throw new Error("Failed pattern match at Game.Cubbit.Update line 305, column 35 - line 305, column 120: " + [ v2.firstPersonView.constructor.name ]);
                                      })();
                                      var cameraPositionZ = (function () {
                                          ...
                                          throw new Error("Failed pattern match at Game.Cubbit.Update line 306, column 35 - line 306, column 120: " + [ v2.firstPersonView.constructor.name ]);
                                      })();
                                      ...
                                      var st$prime = (function () {
                                          var $165 = {};
                                          for (var $166 in v2) {
                                              if (v2.hasOwnProperty($166)) {
                                                  $165[$166] = v2[$166];
                                              };
                                          };
                                          $165.position = position$prime;
                                          $165.velocity = velocity$prime;
                                          $165.cameraPosition = {
                                              x: cameraPositionInterpolatedX, 
                                              y: cameraPositionInterpolatedY, 
                                              z: cameraPositionInterpolatedZ
                                          };
                                          $165.cameraYaw = v2.cameraYaw + ((function () {
                                              if (v2.qKey) {
                                                  return 1.0;
                                              };
                                              if (!v2.qKey) {
                                              ...
                                              throw new Error("Failed pattern match at Game.Cubbit.Update line 319, column 54 - line 319, column 82: " + [ v2.qKey.constructor.name ]);
                                          })() - (function () {
                                              if (v2.eKey) {
                                                  return 1.0;
                                              };
                                              ...
                                              throw new Error("Failed pattern match at Game.Cubbit.Update line 319, column 87 - line 319, column 115: " + [ v2.eKey.constructor.name ]);
                                          })()) * options.cameraRotationSpeed;
                                          $165.cameraPitch = $$Math.max(0.1)(Data_Ord.min(Data_Ord.ordNumber)($$Math.pi * 0.48)(v2.cameraPitch + ((function () {
                                              if (v2.rKey) {
                                                  return 1.0;
                                              };
                                              if (!v2.rKey) {
                                              ...
                                              throw new Error("Failed pattern match at Game.Cubbit.Update line 320, column 84 - line 320, column 112: " + [ v2.rKey.constructor.name ]);
                                          })() - (function () {
                                              if (v2.fKey) {
                                                  return 1.0;
                                              };
                                              ...
                                              throw new Error("Failed pattern match at Game.Cubbit.Update line 320, column 117 - line 320, column 145: " + [ v2.fKey.constructor.name ]);
                                          })()) * options.cameraRotationSpeed));
                                          $165.cameraRange = $$Math.max(3.0)(Data_Ord.min(Data_Ord.ordNumber)(20.0)(v2.cameraRange + ((function () {
                                              if (v2.gKey) {
                                                  return 1.0;
                                              };
                                              if (!v2.gKey) {
                                              ...
                                              throw new Error("Failed pattern match at Game.Cubbit.Update line 321, column 77 - line 321, column 105: " + [ v2.gKey.constructor.name ]);
                                          })() - (function () {
                                              if (v2.tKey) {
                                                  return 1.0;
                                              };
                                              ...
                                              throw new Error("Failed pattern match at Game.Cubbit.Update line 321, column 110 - line 321, column 138: " + [ v2.tKey.constructor.name ]);
                                          })()) * options.cameraZoomSpeed));
                                          $165.animation = animation$prime;
                                          $165.viewReferencePoint = viewReferencePoint$prime;
                                          $165.playerRotation = playerRotation$prime;
                                          return $165;
                                      })();
                                      Control_Monad_Eff_Ref.writeRef(ref)(st$prime)();
                                      Control_Applicative.when(Control_Monad_Eff.applicativeEff)(animation$prime !== v2.animation)(playAnimation(animation$prime)(ref))();
                                      var v4 = Graphics_Babylon_Vector3.createVector3(0.0)(playerRotation$prime)(0.0)();
                                      var v5 = Graphics_Babylon_Vector3.createVector3(st$prime.position.x)(st$prime.position.y)(st$prime.position.z)();
                                      Data_Foldable.for_(Control_Monad_Eff.applicativeEff)(Data_Foldable.foldableArray)(v2.playerMeshes)(function (mesh) {
                                          return Data_Functor["void"](Control_Monad_Eff.functorEff)(function __do() {
                                              ...
                                              return Graphics_Babylon_AbstractMesh.setVisibility((function () {
                                                  ...
                                                  throw new Error("Failed pattern match at Game.Cubbit.Update line 338, column 32 - line 338, column 71: " + [ v2.firstPersonView.constructor.name ]);
                                              })())(mesh)();
                                          });
                                      })();
                                      var v6 = Graphics_Babylon_Vector3.createVector3(cameraPositionInterpolatedX)(cameraPositionInterpolatedY)(cameraPositionInterpolatedZ)();
                                      var v7 = Graphics_Babylon_Vector3.createVector3(cameraTargetInterpolatedX$prime)(cameraTargetInterpolatedY$prime)(cameraTargetInterpolatedZ$prime)();
                                      var v8 = Graphics_Babylon_Vector3.subtract(v7)(v6)();
                                      var v9 = Graphics_Babylon_Vector3.length(v8)();
                                      var v10 = Graphics_Babylon_Ray.createRayWithLength(v6)(v8)(v9)();
                                      var predicate = function (mesh) {
                                          var name = Graphics_Babylon_Node.getName(Graphics_Babylon_AbstractMesh.abstractMeshToNode(mesh));
                                          return Control_Applicative.pure(Control_Monad_Eff.applicativeEff)(name === "terrain");
                                      };
                                      var v11 = Graphics_Babylon_Scene.pickWithRay(v10)(predicate)(true)(scene)();
                                      var pickedPoint = Graphics_Babylon_PickingInfo.getPickedPoint(v11);
                                      var cameraPosition$prime$prime = (function () {
                                          var $177 = Graphics_Babylon_PickingInfo.getPickedPoint(v11);
                                          if ($177 instanceof Data_Maybe.Nothing) {
                                              return v6;
                                          };
                                          if ($177 instanceof Data_Maybe.Just) {
                                              return $177.value0;
                                          };
                                          throw new Error("Failed pattern match at Game.Cubbit.Update line 356, column 36 - line 358, column 40: " + [ $177.constructor.name ]);
                                      })();
                                      Graphics_Babylon_Camera.setPosition(cameraPosition$prime$prime)(Graphics_Babylon_TargetCamera.targetCameraToCamera(camera))();
                                      Graphics_Babylon_TargetCamera.setTarget(v7)(camera)();
                                      var v12 = Graphics_Babylon_Vector3.createVector3(0.0)(Data_Int.toNumber(v2.totalFrames) * 1.0e-4)(0.0)();
                                      Graphics_Babylon_AbstractMesh.setRotation(v12)(Graphics_Babylon_Mesh.meshToAbstractMesh(skybox))();
                                      return Data_Unit.unit;
                                  };
                              };
                          };
