              ...
              if (query.value0 instanceof Game_Cubbit_Hud_Type.ToggleShadow) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Game_Cubbit_Hud_Start.modifyAppState(ref)(function (v) {
                      ...
                      return Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(function __do() {
                          ...
                          throw new Error("Failed pattern match at Game.Cubbit.Hud.Eval line 136, column 17 - line 140, column 70: " + [ $149.constructor.name ]);
                      });
                  });
              };
              if (query.value0 instanceof Game_Cubbit_Hud_Type.ToggleVertexColor) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Game_Cubbit_Hud_Start.modifyAppState(ref)(function (v) {
                      ...
                      return Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(function __do() {
                          ...
                          throw new Error("Failed pattern match at Game.Cubbit.Hud.Eval line 158, column 17 - line 162, column 76: " + [ $165.constructor.name ]);
                      });
                  });
              };
              ...
              if (query.value0 instanceof Game_Cubbit_Hud_Type.PlayingSceneQuery) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(Control_Monad_Eff_Ref.readRef(ref)))(function (v) {
                      if (v.sceneState instanceof Game_Cubbit_Types.PlayingSceneState) {
                          ...
                          if (query.value0.value0 instanceof Game_Cubbit_Hud_Type.TogglePointerLock) {
                              return Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))((function () {
                                  ...
                                  return function __do() {
                                      ...
                                      throw new Error("Failed pattern match at Game.Cubbit.Hud.Eval line 303, column 33 - line 321, column 57: " + [ firstPersonView.constructor.name ]);
                                  };
                              })());
                          };
                                      ...
                                      if (v1.sceneState instanceof Game_Cubbit_Types.PlayingSceneState) {
                                          return new Game_Cubbit_Types.PlayingSceneState((function () {
                                              ...
                                              $302.cameraYaw = (function () {
                                                  ...
                                                  throw new Error("Failed pattern match at Game.Cubbit.Hud.Eval line 335, column 61 - line 335, column 195: " + [ isRightButton.constructor.name ]);
                                              })();
                                              $302.cameraPitch = (function () {
                                                  ...
                                                  throw new Error("Failed pattern match at Game.Cubbit.Hud.Eval line 336, column 63 - line 336, column 235: " + [ isRightButton.constructor.name ]);
                                              })();
                                              return $302;
                                          })());
                                      };
                          ...
                          if (query.value0.value0 instanceof Game_Cubbit_Hud_Type.OnMouseClick) {
                              return Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(function __do() {
                                  ...
                                  return Control_Applicative.when(Control_Monad_Eff.applicativeEff)(DOM_Event_MouseEvent.buttons(query.value0.value0.value0) === 1)((function () {
                                      ...
                                      throw new Error("Failed pattern match at Game.Cubbit.Hud.Eval line 364, column 33 - line 371, column 54: " + [ v.sceneState.value0.mode.constructor.name ]);
                                  })())();
                              });
                          };
                                  ...
                                  (function () {
                                      ...
                                      if ($336 === "1") {
                                          return function __do() {
                                              ...
                                              throw new Error("Failed pattern match at Game.Cubbit.Hud.Eval line 390, column 37 - line 392, column 89: " + [ v1.debugLayer.constructor.name ]);
                                          };
                                      };
                                      if ($336 === "2") {
                          ...
                          throw new Error("Failed pattern match at Game.Cubbit.Hud.Eval line 262, column 21 - line 408, column 38: " + [ query.value0.value0.constructor.name ]);
                      };
                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit);
                  });
              };
              throw new Error("Failed pattern match at Game.Cubbit.Hud.Eval line 52, column 29 - line 411, column 45: " + [ query.value0.constructor.name ]);
          })());
      };
  };
  exports["eval"] = $$eval;
