                                              ...
                                              return function __do() {
                                                  ...
                                                  (function () {
                                                      var v9 = (function () {
                                                          ...
                                                          throw new Error("Failed pattern match at Game.Cubbit.Update line 404, column 21 - line 404, column 126: " + [ v1.config.mute.constructor.name ]);
                                                      })();
                                                      return function __do() {
                                                          ...
                                                          var sev = (function () {
                                                              ...
                                                              throw new Error("Failed pattern match at Game.Cubbit.Update line 407, column 23 - line 407, column 110: " + [ v1.config.mute.constructor.name ]);
                                                          })();
                                                  ...
                                                  (function () {
                                                      ...
                                                      throw new Error("Failed pattern match at Game.Cubbit.Update line 429, column 9 - line 440, column 43: " + [ v1.config.shadow.constructor.name ]);
                                                  })()();
                                                  return v8;
                                              };
                                          };
              ...
              return function (playingSceneState) {
                  return Control_Monad_Eff.runPure((function () {
                      ...
                      var keyStep = function (key) {
                          ...
                          throw new Error("Failed pattern match at Game.Cubbit.Update line 60, column 23 - line 62, column 5: " + [ $94.constructor.name ]);
                      };
                      var keyVector = {
                      ...
                      return function __do() {
                          ...
                          var jumpVelocity = (function () {
                              var $98 = isLanding && (Data_Set.member(Data_Ord.ordString)(" ")(v1.keys) && playingSceneState.landing === 0);
                              if ($98) {
                              ...
                              throw new Error("Failed pattern match at Game.Cubbit.Update line 81, column 24 - line 83, column 5: " + [ $98.constructor.name ]);
                          })();
                          ...
                          var velocity = (function () {
                              ...
                              throw new Error("Failed pattern match at Game.Cubbit.Update line 92, column 20 - line 102, column 14: " + [ $101.constructor.name ]);
                          })();
                          var playerRotation$prime = (function () {
                              if (isLanding) {
                                  ...
                                  if (!$103) {
                                      ...
                                      throw new Error("Failed pattern match at Game.Cubbit.Update line 108, column 22 - line 110, column 60: " + [ $104.constructor.name ]);
                                  };
                                  throw new Error("Failed pattern match at Game.Cubbit.Update line 106, column 19 - line 110, column 60: " + [ $103.constructor.name ]);
                              };
                              if (!isLanding) {
                                  return playingSceneState.playerRotation;
                              };
                          ...
                          var animation$prime = (function () {
                              ...
                              if (!$105) {
                                  if (isLanding) {
                                      ...
                                      throw new Error("Failed pattern match at Game.Cubbit.Update line 124, column 23 - line 124, column 101: " + [ $107.constructor.name ]);
                                  };
                                  if (!isLanding) {
                                      return "jump";
                                  };
                              ...
                              throw new Error("Failed pattern match at Game.Cubbit.Update line 121, column 22 - line 127, column 5: " + [ $105.constructor.name ]);
                          })();
                          ...
                          var landingCount = (function () {
                              ...
                              throw new Error("Failed pattern match at Game.Cubbit.Update line 138, column 24 - line 140, column 43: " + [ $112.constructor.name ]);
                          })();
                          ...
                          var sceneState = (function () {
                              var $126 = {};
                              for (var $127 in playingSceneState) {
                                  if (playingSceneState.hasOwnProperty($127)) {
                                      $126[$127] = playingSceneState[$127];
                                  };
                              };
                              $126.cameraYaw = playingSceneState.cameraYaw + ((function () {
                                  ...
                                  throw new Error("Failed pattern match at Game.Cubbit.Update line 194, column 61 - line 194, column 103: " + [ $120.constructor.name ]);
                              })() - (function () {
                                  ...
                                  throw new Error("Failed pattern match at Game.Cubbit.Update line 194, column 108 - line 194, column 150: " + [ $121.constructor.name ]);
                              })()) * v.cameraRotationSpeed;
                              $126.cameraPitch = Data_Ord.max(Data_Ord.ordNumber)(0.1)(Data_Ord.min(Data_Ord.ordNumber)($$Math.pi * 0.48)(playingSceneState.cameraPitch + ((function () {
                                  ...
                                  throw new Error("Failed pattern match at Game.Cubbit.Update line 195, column 91 - line 195, column 133: " + [ $122.constructor.name ]);
                              })() - (function () {
                                  ...
                                  throw new Error("Failed pattern match at Game.Cubbit.Update line 195, column 138 - line 195, column 180: " + [ $123.constructor.name ]);
                              })()) * v.cameraRotationSpeed));
                              $126.cameraRange = Data_Ord.max(Data_Ord.ordNumber)(v.cameraMinimumRange)(Data_Ord.min(Data_Ord.ordNumber)(v.cameraMaximumRange)(playingSceneState.cameraRange + ((function () {
                                  ...
                                  throw new Error("Failed pattern match at Game.Cubbit.Update line 196, column 129 - line 196, column 171: " + [ $124.constructor.name ]);
                              })() - (function () {
                                  ...
                                  throw new Error("Failed pattern match at Game.Cubbit.Update line 196, column 176 - line 196, column 218: " + [ $125.constructor.name ]);
                              })()) * v.cameraZoomSpeed));
                              $126.velocity = velocity;
                              $126.playerRotation = playerRotation$prime;
                              $126.animation = animation$prime;
                              $126.landing = Data_Ord.max(Data_Ord.ordInt)(0)(landingCount - 1);
                              return $126;
                          })();
                          var state$prime = (function () {
                              var $129 = {};
                              for (var $130 in v1) {
                                  if (v1.hasOwnProperty($130)) {
                                      $129[$130] = v1[$130];
                                  };
                              };
                              $129.sceneState = new Game_Cubbit_Types.PlayingSceneState(sceneState);
                              $129.cameraTarget = cameraTarget$prime;
                              $129.cameraPosition = {
                                  x: cameraPositionInterpolatedX, 
                                  y: cameraPositionInterpolatedY, 
                                  z: cameraPositionInterpolatedZ
                              };
                              $129.totalFrames = v1.totalFrames + 1 | 0;
                              $129.skyboxRotation = v1.skyboxRotation + v.skyboxRotationSpeed * deltaTime;
                              return $129;
                          })();
                          ...
                          return function (v) {
                              ...
                              if (v.sceneState instanceof Game_Cubbit_Types.TitleSceneState) {
                                  var state$prime = (function () {
                                      ...
                                      $147.sceneState = new Game_Cubbit_Types.TitleSceneState((function () {
                                          var $144 = {};
                                          for (var $145 in v.sceneState.value0) {
                                              if (v.sceneState.value0.hasOwnProperty($145)) {
                                                  $144[$145] = v.sceneState.value0[$145];
                                              };
                                          };
                                          $144.position = v.sceneState.value0.position + deltaTime * 8.0e-4;
                                          return $144;
                                      })());
                                      return $147;
                                  })();
                              ...
                              if (v.sceneState instanceof Game_Cubbit_Types.PlayingSceneState) {
                                  return function __do() {
                                      ...
                                      (function () {
                                          var $162 = v.sceneState.value0.animation !== "run" && v1.value1.animation === "run";
                                          if ($162) {
                                              return Graphics_Babylon_Sound.play(sounds.stepSound);
                                          };
                                          if (!$162) {
                                              var $163 = v.sceneState.value0.animation === "run" && v1.value1.animation !== "run";
                                              if ($163) {
                                              ...
                                              throw new Error("Failed pattern match at Game.Cubbit.Update line 290, column 30 - line 292, column 43: " + [ $163.constructor.name ]);
                                          };
                                          throw new Error("Failed pattern match at Game.Cubbit.Update line 288, column 21 - line 292, column 43: " + [ $162.constructor.name ]);
                                      })()();
                                      return v1.value0;
                                  };
                              };
