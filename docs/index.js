...
(function(exports) {exports.focus = function(id){
      return function(){
...
(function(exports) {
  ...
  var Zoom = (function () {
      function Zoom(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      Zoom.create = function (value0) {
          return function (value1) {
              return new Zoom(value0, value1);
          };
      };
      return Zoom;
  })();
  ...
  var OnKeyUp = (function () {
      function OnKeyUp(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      OnKeyUp.create = function (value0) {
          return function (value1) {
              return new OnKeyUp(value0, value1);
          };
      };
      return OnKeyUp;
  })();
  ...
  var mouseHandler = Unsafe_Coerce.unsafeCoerce;
  var onWheel = function ($232) {
      return Halogen_HTML_Events.handler("wheel")(mouseHandler($232));
  };
  var render = function (state) {
      ...
      return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.id_("content"), Halogen_HTML_Properties.class_("content-layer"), Halogen_HTML_Events.onContextMenu(function (e) {
          ...
          return new Data_Maybe.Just(new OnKeyDown(e, Data_Unit.unit));
      }), Halogen_HTML_Events.onKeyUp(function (e) {
          return new Data_Maybe.Just(new OnKeyUp(e, Data_Unit.unit));
          ...
          return new Data_Maybe.Just(new Zoom(e, Data_Unit.unit));
  ...
  var $$eval = function (v) {
      ...
      if (v instanceof SetCursorPosition) {
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Applicative.when(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Eq.notEq(Game_Cubbit_BlockIndex.eq_BlockIndex)(v.value0)(v1.cursorPosition))(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                  var $53 = {};
                  for (var $54 in v2) {
                      if (v2.hasOwnProperty($54)) {
                          $53[$54] = v2[$54];
                      };
                  };
                  $53.cursorPosition = v.value0;
                  return $53;
              })))(function () {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
              });
          ...
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(function __do() {
                  Control_Monad_Eff_Ref.modifyRef(v1.ref)(function (v2) {
                      ...
                      $74.firstPersonView = !v2.firstPersonView;
                      return $74;
                  })();
                      ...
                      return Game_Cubbit_PointerLock.requestPointerLock(function (e) {
                          return function __do() {
                              Control_Monad_Eff_Ref.modifyRef(v1.ref)(function (v3) {
                                  var $80 = {};
                                  for (var $81 in v3) {
                                      if (v3.hasOwnProperty($81)) {
                                          $80[$81] = v3[$81];
                                      };
                                  };
                                  $80.playerRotation = v3.playerRotation + e.movementX * v1.options.pointerHorizontalSensitivity;
                                  $80.playerPitch = Data_Ord.max(Data_Ord.ordNumber)(-$$Math.pi * 0.45)(Data_Ord.min(Data_Ord.ordNumber)($$Math.pi * 0.45)(v3.playerPitch) - e.movementY * v1.options.pointerVerticalSensitivity);
                                  return $80;
                              })();
                              return Data_Unit.unit;
                          };
                          ...
                          var $84 = {};
                          for (var $85 in v3) {
                              if (v3.hasOwnProperty($85)) {
                                  $84[$85] = v3[$85];
                              };
                          };
                          $84.firstPersonView = false;
                          return $84;
                      }))();
                  };
                  if (!v2.firstPersonView) {
                  ...
                  throw new Error("Failed pattern match at Game.Cubbit.Hud line 144, column 13 - line 154, column 37: " + [ v2.firstPersonView.constructor.name ]);
              }))(function () {
      ...
      if (v instanceof SetMousePosition) {
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))((function () {
                  if (v1.scene instanceof Data_Maybe.Nothing) {
                      return Control_Applicative.pure(Control_Monad_Eff.applicativeEff)(Data_Unit.unit);
                  };
                  if (v1.scene instanceof Data_Maybe.Just) {
                      return Data_Functor["void"](Control_Monad_Eff.functorEff)(Control_Monad_Eff_Ref.modifyRef(v1.ref)(function (v2) {
                          var isRightButton = DOM_Event_MouseEvent.buttons(v.value0) === 2;
                          var dy = offsetY(v.value0) - v2.mousePosition.y;
                          var dx = offsetX(v.value0) - v2.mousePosition.x;
                          var $93 = {};
                          for (var $94 in v2) {
                              if (v2.hasOwnProperty($94)) {
                                  $93[$94] = v2[$94];
                              };
                          };
                          $93.mousePosition = {
                          ...
                          $93.cameraYaw = (function () {
                              if (isRightButton) {
                                  return v2.cameraYaw + Data_Int.toNumber(dx) * v1.options.cameraHorizontalSensitivity;
                              };
                              if (!isRightButton) {
                                  return v2.cameraYaw;
                              };
                              throw new Error("Failed pattern match at Game.Cubbit.Hud line 173, column 53 - line 173, column 165: " + [ isRightButton.constructor.name ]);
                          })();
                          $93.cameraPitch = (function () {
                              if (isRightButton) {
                                  return Data_Ord.max(Data_Ord.ordNumber)(-$$Math.pi * 0.45)(Data_Ord.min(Data_Ord.ordNumber)($$Math.pi * 0.45)(v2.cameraPitch + Data_Int.toNumber(dy) * v1.options.cameraVertialSensitivity));
                              };
                              if (!isRightButton) {
                                  return v2.cameraPitch;
                              };
                              throw new Error("Failed pattern match at Game.Cubbit.Hud line 174, column 55 - line 174, column 205: " + [ isRightButton.constructor.name ]);
                          })();
                          return $93;
                      }));
                  };
                  throw new Error("Failed pattern match at Game.Cubbit.Hud line 160, column 13 - line 175, column 38: " + [ v1.scene.constructor.name ]);
              })()))(function () {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
              });
          });
      ...
      if (v instanceof SetScene) {
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
              var $99 = {};
              for (var $100 in v1) {
                  if (v1.hasOwnProperty($100)) {
                      $99[$100] = v1[$100];
                  };
              };
              $99.scene = new Data_Maybe.Just(v.value0);
              return $99;
          }))(function () {
              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
          });
          ...
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(function __do() {
                  ...
                  if (v1.scene instanceof Data_Maybe.Just) {
                      ...
                      throw new Error("Failed pattern match at Game.Cubbit.Hud line 192, column 21 - line 194, column 74: " + [ v2.debugLayer.constructor.name ]);
                  };
                  throw new Error("Failed pattern match at Game.Cubbit.Hud line 188, column 13 - line 194, column 74: " + [ v1.scene.constructor.name ]);
              }))(function () {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0);
              });
          });
                  ...
                  if (v1.scene instanceof Data_Maybe.Just) {
                      var put = function (block) {
                          return function __do() {
                              ...
                              throw new Error("Failed pattern match at Game.Cubbit.Hud line 218, column 29 - line 220, column 110: " + [ v3.constructor.name ]);
                          };
                      };
                      ...
                      throw new Error("Failed pattern match at Game.Cubbit.Hud line 222, column 21 - line 225, column 42: " + [ v2.mode.constructor.name ]);
                  };
                  throw new Error("Failed pattern match at Game.Cubbit.Hud line 212, column 13 - line 225, column 42: " + [ v1.scene.constructor.name ]);
              }))(function () {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
              });
          });
      ...
      if (v instanceof Zoom) {
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))((function () {
                  ...
                  if (v1.scene instanceof Data_Maybe.Just) {
                      return Control_Monad_Eff_Ref.modifyRef(v1.ref)(function (v2) {
                          var $131 = {};
                          for (var $132 in v2) {
                              if (v2.hasOwnProperty($132)) {
                                  $131[$132] = v2[$132];
                              };
                          };
                          $131.cameraRange = Data_Ord.max(Data_Ord.ordNumber)(v1.options.cameraMinimumRange)(Data_Ord.min(Data_Ord.ordNumber)(v1.options.cameraMaximumRange)(v2.cameraRange + Data_Int.toNumber(deltaY(v.value0)) * v1.options.cameraZoomSpeed));
                          return $131;
                      });
                  };
                  throw new Error("Failed pattern match at Game.Cubbit.Hud line 232, column 13 - line 237, column 22: " + [ v1.scene.constructor.name ]);
              })()))(function () {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
              });
          });
      ...
      if (v instanceof OnKeyDown) {
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(function __do() {
                  (function () {
                      var $138 = DOM_Event_KeyboardEvent.key(v.value0);
                      if ($138 === " ") {
                          return Data_Functor["void"](Control_Monad_Eff.functorEff)(Control_Monad_Eff_Ref.modifyRef(v1.ref)(function (v2) {
                              var $143 = {};
                              for (var $144 in v2) {
                                  if (v2.hasOwnProperty($144)) {
                                      $143[$144] = v2[$144];
                                  };
                              };
                              $143.velocity = (function () {
                                  var $140 = {};
                                  for (var $141 in v2.velocity) {
                                      if (v2.velocity.hasOwnProperty($141)) {
                                          $140[$141] = v2.velocity[$141];
                                      };
                                  };
                                  $140.y = v2.velocity.y + v1.options.jumpVelocity;
                                  return $140;
                              })();
                              return $143;
                          }));
                  ...
                  DOM_Event_Event.preventDefault(DOM_Event_Types.keyboardEventToEvent(v.value0))();
                  return DOM_Event_Event.stopPropagation(DOM_Event_Types.keyboardEventToEvent(v.value0))();
              }))(function () {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
              });
          });
      ...
      if (v instanceof OnKeyUp) {
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(function __do() {
                  (function () {
                      var $189 = DOM_Event_KeyboardEvent.key(v.value0);
                      if ($189 === "w") {
                          return Data_Functor["void"](Control_Monad_Eff.functorEff)(Control_Monad_Eff_Ref.modifyRef(v1.ref)(function (v2) {
                              var $191 = {};
                              for (var $192 in v2) {
                                  if (v2.hasOwnProperty($192)) {
                                      $191[$192] = v2[$192];
                                  };
                              };
                              $191.wKey = false;
      ...
      throw new Error("Failed pattern match at Game.Cubbit.Hud line 115, column 8 - line 286, column 18: " + [ v.constructor.name ]);
  };
  var ui = function (ref) {
      return function (options) {
                                      ...
                                      return Control_Bind.bind(Control_Monad_Aff.bindAff)(Graphics_Babylon_Texture_Aff.loadTexture("./alice/texture.png")(v1)(Graphics_Babylon_Texture.defaultCreateTextureOptions))(function () {
                                          return Control_Bind.bind(Control_Monad_Aff.bindAff)(Graphics_Babylon_SceneLoader_Aff.loadMesh("")("./alice/")("alice.babylon")(v1)(Control_Applicative.pure(Control_Monad_Eff.applicativeEff)))(function (v4) {
                                              return Control_Bind.bind(Control_Monad_Aff.bindAff)(Graphics_Babylon_Sound_Aff.loadSound("forest.mp3")("forest.mp3")(v1)((function () {
                                                  var $48 = {};
                                                  for (var $49 in Graphics_Babylon_Sound.defaultCreateSoundOptions) {
                                                      if (Graphics_Babylon_Sound.defaultCreateSoundOptions.hasOwnProperty($49)) {
                                                          $48[$49] = Graphics_Babylon_Sound.defaultCreateSoundOptions[$49];
                                                      };
                                                  };
                                                  $48.autoplay = true;
                                                  $48.loop = true;
      ...
      return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Control_Monad_Eff_Ref.newRef({
          ...
          return Control_Bind.bind(Control_Monad_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(function (v2) {
              return Control_Bind.bind(Control_Monad_Aff.bindAff)(Network_HTTP_Affjax.get(Network_HTTP_Affjax_Response.responsableForeign)("options.json"))(function (v3) {
                  return Control_Bind.bind(Control_Monad_Aff.bindAff)((function () {
                      var $84 = Control_Monad_Except.runExcept(Game_Cubbit_Option.readOptions(v3.response));
                      if ($84 instanceof Data_Either.Left) {
                          return Control_Monad_Error_Class.throwError(Control_Monad_Aff.monadErrorAff)(Control_Monad_Eff_Exception.error(Data_Show.show(Data_List_Types.showNonEmptyList(Data_Foreign.showForeignError))($84.value0)));
                      };
                      if ($84 instanceof Data_Either.Right) {
                          return Control_Applicative.pure(Control_Monad_Aff.applicativeAff)($84.value0);
                      };
                      throw new Error("Failed pattern match at Game.Cubbit.Main line 247, column 16 - line 249, column 30: " + [ $84.constructor.name ]);
                  })())(function (v4) {
