...
(function(exports) {
  ...
  var render = function (state) {
      ...
      }) ])([ Halogen_HTML.text("Fst Person View") ]), Halogen_HTML_Elements.button([ Halogen_HTML_Properties.id_("debuglayer") ])([ Halogen_HTML.text("DebugLayer") ]) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.id_("cursor-position") ])([ Halogen_HTML.text("cursor: (" + (Data_Show.show(Data_Show.showInt)(index.x) + (", " + (Data_Show.show(Data_Show.showInt)(index.y) + (", " + (Data_Show.show(Data_Show.showInt)(index.z) + ")")))))) ]) ]);
  };
          ...
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(function __do() {
                  Control_Monad_Eff_Ref.modifyRef(v1.ref)(function (v2) {
                      ...
                      $39.firstPersonView = !v2.firstPersonView;
                      return $39;
                  })();
                      ...
                      return Game_Cubbit_PointerLock.requestPointerLock(function (e) {
                          return function __do() {
                              Control_Monad_Eff_Ref.modifyRef(v1.ref)(function (v3) {
                                  var $45 = {};
                                  for (var $46 in v3) {
                                      if (v3.hasOwnProperty($46)) {
                                          $45[$46] = v3[$46];
                                      };
                                  };
                                  $45.playerRotation = v3.playerRotation + e.movementX * v1.options.pointerHorizontalSensitivity;
                                  $45.playerPitch = Data_Ord.max(Data_Ord.ordNumber)(-$$Math.pi * 0.45)(Data_Ord.min(Data_Ord.ordNumber)($$Math.pi * 0.45)(v3.playerPitch) - e.movementY * v1.options.pointerVerticalSensitivity);
                                  return $45;
                              })();
                              return Data_Unit.unit;
                          };
                          ...
                          var $49 = {};
                          for (var $50 in v3) {
                              if (v3.hasOwnProperty($50)) {
                                  $49[$50] = v3[$50];
                              };
                          };
                          $49.firstPersonView = false;
                          return $49;
                      }))();
                  };
                  if (!v2.firstPersonView) {
                  ...
                  throw new Error("Failed pattern match at Game.Cubbit.Hud line 104, column 13 - line 114, column 37: " + [ v2.firstPersonView.constructor.name ]);
              }))(function () {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0);
              });
          });
      };
      throw new Error("Failed pattern match at Game.Cubbit.Hud line 75, column 8 - line 115, column 18: " + [ v.constructor.name ]);
  };
  var ui = function (ref) {
      return function (options) {
                          ...
                          if ($48 instanceof Data_Maybe.Just) {
                              ...
                              if (v.mode instanceof Game_Cubbit_Types.Put) {
                                  ...
                                  if (!$52) {
                                      ...
                                      throw new Error("Failed pattern match at Game.Cubbit.Update line 85, column 30 - line 98, column 57: " + [ $59.constructor.name ]);
                                  };
                                  throw new Error("Failed pattern match at Game.Cubbit.Update line 78, column 24 - line 98, column 57: " + [ $52.constructor.name ]);
                              };
                              if (v.mode instanceof Game_Cubbit_Types.Remove) {
                                  ...
                                  if (!$72) {
                                      ...
                                      throw new Error("Failed pattern match at Game.Cubbit.Update line 107, column 30 - line 120, column 57: " + [ $79.constructor.name ]);
                                  };
                                  throw new Error("Failed pattern match at Game.Cubbit.Update line 100, column 27 - line 120, column 57: " + [ $72.constructor.name ]);
                              };
                              if (v.mode instanceof Game_Cubbit_Types.Move) {
                                  return Data_Maybe.Nothing.value;
                              };
                              throw new Error("Failed pattern match at Game.Cubbit.Update line 77, column 13 - line 122, column 37: " + [ v.mode.constructor.name ]);
                          };
                          throw new Error("Failed pattern match at Game.Cubbit.Update line 62, column 5 - line 122, column 37: " + [ $48.constructor.name ]);
                      };
                  };
              };
          };
                                  ...
                                  return function (driver) {
                                      return function __do() {
                                          ...
                                          var rot = -(function () {
                                              ...
                                              throw new Error("Failed pattern match at Game.Cubbit.Update line 144, column 24 - line 144, column 110: " + [ v.firstPersonView.constructor.name ]);
                                          })();
                                          var keyVector = {
                                              x: (function () {
                                                  if (v.dKey) {
                                                  ...
                                                  if (!v.dKey) {
                                                      return 0.0 - (function () {
                                                          ...
                                                          throw new Error("Failed pattern match at Game.Cubbit.Update line 147, column 52 - line 147, column 89: " + [ v.aKey.constructor.name ]);
                                                      })();
                                                  };
                                                  throw new Error("Failed pattern match at Game.Cubbit.Update line 147, column 24 - line 147, column 89: " + [ v.dKey.constructor.name ]);
                                              })(), 
                                              z: (function () {
                                                  if (v.wKey) {
                                                      return 1.0;
                                                  ...
                                                  if (!v.wKey) {
                                                      return 0.0 - (function () {
                                                          ...
                                                          throw new Error("Failed pattern match at Game.Cubbit.Update line 148, column 52 - line 149, column 17: " + [ v.sKey.constructor.name ]);
                                                      })();
                                                  };
                                                  throw new Error("Failed pattern match at Game.Cubbit.Update line 148, column 24 - line 149, column 17: " + [ v.wKey.constructor.name ]);
                                              })()
                                          };
                                          ...
                                          var velocity = (function () {
                                              ...
                                              throw new Error("Failed pattern match at Game.Cubbit.Update line 158, column 28 - line 166, column 26: " + [ stopped.constructor.name ]);
                                          })();
                                          var playerRotation$prime = (function () {
                                              ...
                                              throw new Error("Failed pattern match at Game.Cubbit.Update line 169, column 35 - line 169, column 136: " + [ $106.constructor.name ]);
                                          })();
                                          var playerPosition = {
                                          ...
                                          var animation$prime = (function () {
                                              ...
                                              throw new Error("Failed pattern match at Game.Cubbit.Update line 177, column 30 - line 179, column 13: " + [ $107.constructor.name ]);
                                          })();
                                          ...
                                          var cameraSpeed = (function () {
                                              ...
                                              throw new Error("Failed pattern match at Game.Cubbit.Update line 193, column 31 - line 193, column 95: " + [ v.firstPersonView.constructor.name ]);
                                          })();
                                          ...
                                          var cameraTargetX$prime = (function () {
                                              ...
                                              throw new Error("Failed pattern match at Game.Cubbit.Update line 206, column 34 - line 206, column 118: " + [ v.firstPersonView.constructor.name ]);
                                          })();
                                          var cameraTargetY$prime = (function () {
                                              ...
                                              throw new Error("Failed pattern match at Game.Cubbit.Update line 207, column 34 - line 207, column 118: " + [ v.firstPersonView.constructor.name ]);
                                          })();
                                          var cameraTargetZ$prime = (function () {
                                              ...
                                              throw new Error("Failed pattern match at Game.Cubbit.Update line 208, column 34 - line 208, column 118: " + [ v.firstPersonView.constructor.name ]);
                                          })();
                                          ...
                                          var cameraPositionX = (function () {
                                              ...
                                              throw new Error("Failed pattern match at Game.Cubbit.Update line 229, column 35 - line 229, column 123: " + [ v.firstPersonView.constructor.name ]);
                                          })();
                                          var cameraPositionY = (function () {
                                              ...
                                              throw new Error("Failed pattern match at Game.Cubbit.Update line 230, column 35 - line 230, column 123: " + [ v.firstPersonView.constructor.name ]);
                                          })();
                                          var cameraPositionZ = (function () {
                                              ...
                                              throw new Error("Failed pattern match at Game.Cubbit.Update line 231, column 35 - line 231, column 123: " + [ v.firstPersonView.constructor.name ]);
                                          })();
                                          ...
                                          var state$prime = (function () {
                                              ...
                                              $135.cameraYaw = v.cameraYaw + ((function () {
                                                  ...
                                                  throw new Error("Failed pattern match at Game.Cubbit.Update line 245, column 57 - line 245, column 88: " + [ v.qKey.constructor.name ]);
                                              })() - (function () {
                                                  if (v.eKey) {
                                                      return 1.0;
                                                  };
                                                  ...
                                                  throw new Error("Failed pattern match at Game.Cubbit.Update line 245, column 93 - line 245, column 124: " + [ v.eKey.constructor.name ]);
                                              ...
                                              $135.cameraPitch = $$Math.max(0.1)(Data_Ord.min(Data_Ord.ordNumber)($$Math.pi * 0.48)(v.cameraPitch + ((function () {
                                                  ...
                                                  throw new Error("Failed pattern match at Game.Cubbit.Update line 246, column 87 - line 246, column 118: " + [ v.rKey.constructor.name ]);
                                              })() - (function () {
                                                  if (v.fKey) {
                                                      return 1.0;
                                                  };
                                                  ...
                                                  throw new Error("Failed pattern match at Game.Cubbit.Update line 246, column 123 - line 246, column 154: " + [ v.fKey.constructor.name ]);
                                              })()) * options.cameraRotationSpeed));
                                              $135.cameraRange = $$Math.max(options.cameraMinimumRange)(Data_Ord.min(Data_Ord.ordNumber)(options.cameraMaximumRange)(v.cameraRange + ((function () {
                                                  ...
                                                  throw new Error("Failed pattern match at Game.Cubbit.Update line 247, column 125 - line 247, column 156: " + [ v.gKey.constructor.name ]);
                                              })() - (function () {
                                                  if (v.tKey) {
                                                      return 1.0;
                                                  };
                                                  ...
                                                  throw new Error("Failed pattern match at Game.Cubbit.Update line 247, column 161 - line 247, column 192: " + [ v.tKey.constructor.name ]);
                                          ...
                                          Data_Foldable.for_(Control_Monad_Eff.applicativeEff)(Data_Foldable.foldableArray)(v.playerMeshes)(function (mesh) {
                                              return Data_Functor["void"](Control_Monad_Eff.functorEff)(function __do() {
                                                  ...
                                                  return Graphics_Babylon_AbstractMesh.setVisibility((function () {
                                                      ...
                                                      throw new Error("Failed pattern match at Game.Cubbit.Update line 266, column 32 - line 266, column 74: " + [ v.firstPersonView.constructor.name ]);
                                                  })())(mesh)();
                                              });
                                          })();
                                          ...
                                          var cameraPosition$prime$prime = (function () {
                                              ...
                                              throw new Error("Failed pattern match at Game.Cubbit.Update line 284, column 36 - line 286, column 40: " + [ $147.constructor.name ]);
                                          })();
                                                  ...
                                                  return function (y) {
                                                      return function (z) {
                                                          ...
                                                          return function __do() {
                                                              ...
                                                              throw new Error("Failed pattern match at Game.Cubbit.Update line 317, column 21 - line 329, column 17: " + [ v12.constructor.name ]);
                                                          };
                                                      };
                                                  };
                                              })();
                                          ...
                                          (function () {
                                              ...
                                              return function __do() {
                                                  ...
                                                  throw new Error("Failed pattern match at Game.Cubbit.Update line 365, column 25 - line 371, column 73: " + [ v11.constructor.name ]);
                                              };
                                          })()();
                                          return Graphics_Babylon_AbstractMesh.setIsVisible((function () {
                                              ...
                                              throw new Error("Failed pattern match at Game.Cubbit.Update line 374, column 31 - line 377, column 34: " + [ v.mode.constructor.name ]);
                              ...
                              return function (options) {
                                  return function __do() {
                                      ...
                                      Game_Cubbit_Event.onButtonClick("debuglayer")(function __do() {
                                          ...
                                          throw new Error("Failed pattern match at Game.Cubbit.UI line 60, column 9 - line 62, column 57: " + [ v.debugLayer.constructor.name ]);
                                      })();
                                          ...
                                          return function __do() {
                                              ...
                                              var put = function (block) {
                                                  return function __do() {
                                                      ...
                                                      throw new Error("Failed pattern match at Game.Cubbit.UI line 70, column 17 - line 72, column 86: " + [ v1.constructor.name ]);
                                                  };
                                              };
                                              if (v.mode instanceof Game_Cubbit_Types.Put) {
                                              ...
                                              throw new Error("Failed pattern match at Game.Cubbit.UI line 74, column 9 - line 77, column 30: " + [ v.mode.constructor.name ]);
                                          };
                                      })();
                                      Game_Cubbit_Event.onRightMouseDrag(function (e) {
                                          return Control_Monad_Eff_Ref.modifyRef(ref)(function (v) {
                                              ...
                                              $23.cameraYaw = v.cameraYaw + Data_Int.toNumber(e.movementX) * options.cameraHorizontalSensitivity;
                                              $23.cameraPitch = $$Math.max(-$$Math.pi * 0.45)($$Math.min($$Math.pi * 0.45)(v.cameraPitch + Data_Int.toNumber(e.movementY) * options.cameraVertialSensitivity));
                                              return $23;
                                          });
                                      })();
                                      return Game_Cubbit_Event.onWheel(function (e) {
                                          return Control_Monad_Eff_Ref.modifyRef(ref)(function (v) {
                                              ...
                                              $27.cameraRange = $$Math.max(options.cameraMinimumRange)($$Math.min(options.cameraMaximumRange)(v.cameraRange + Data_Int.toNumber(e.deltaY) * options.cameraZoomSpeed));
                                              return $27;
                                          });
                                      })();
                                  };
          ...
          return Control_Bind.bind(Control_Monad_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(function (v2) {
              return Control_Bind.bind(Control_Monad_Aff.bindAff)(Network_HTTP_Affjax.get(Network_HTTP_Affjax_Response.responsableForeign)("options.json"))(function (v3) {
                  return Control_Bind.bind(Control_Monad_Aff.bindAff)((function () {
                      ...
                      throw new Error("Failed pattern match at Game.Cubbit.Main line 296, column 16 - line 298, column 30: " + [ $192.constructor.name ]);
                  })())(function (v4) {
