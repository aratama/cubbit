...
(function(exports) {
  ...
  var mouseHandler = Unsafe_Coerce.unsafeCoerce;
  var onWheel = function ($200) {
      return Halogen_HTML_Events.handler("wheel")(mouseHandler($200));
  };
                  ...
                  return function (ref) {
                      return function (v) {
                          ...
                          if (v instanceof SetMode) {
                              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(Control_Monad_Eff_Ref.modifyRef(ref)(function (v1) {
                                  var $49 = {};
                                  for (var $50 in v1) {
                                      if (v1.hasOwnProperty($50)) {
                                          $49[$50] = v1[$50];
                                      };
                                  };
                                  $49.mode = v.value0;
                          ...
                          if (v instanceof TogglePointerLock) {
                              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(function __do() {
                                  Control_Monad_Eff_Ref.modifyRef(ref)(function (v1) {
                                      ...
                                      $61.firstPersonView = !v1.firstPersonView;
                                      return $61;
                                  })();
                                  var v1 = Control_Monad_Eff_Ref.readRef(ref)();
                                  if (v1.firstPersonView) {
                                      return Game_Cubbit_PointerLock.requestPointerLock(function (e) {
                                          return function __do() {
                                              Control_Monad_Eff_Ref.modifyRef(ref)(function (v2) {
                                                  ...
                                                  $67.playerRotation = v2.playerRotation + e.movementX * options.pointerHorizontalSensitivity;
                                                  $67.playerPitch = Data_Ord.max(Data_Ord.ordNumber)(-$$Math.pi * 0.45)(Data_Ord.min(Data_Ord.ordNumber)($$Math.pi * 0.45)(v2.playerPitch) - e.movementY * options.pointerVerticalSensitivity);
                                                  return $67;
                                              })();
                                              return Data_Unit.unit;
                                          };
                                  ...
                                  throw new Error("Failed pattern match at Game.Cubbit.Hud line 131, column 13 - line 141, column 37: " + [ v1.firstPersonView.constructor.name ]);
                              }))(function () {
                          ...
                          if (v instanceof SetMousePosition) {
                              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(Control_Monad_Eff_Ref.modifyRef(ref)(function (v1) {
                                  ...
                                  var dy = offsetY(v.value0) - v1.mousePosition.y;
                                  var dx = offsetX(v.value0) - v1.mousePosition.x;
                                  var $78 = {};
                                  for (var $79 in v1) {
                                  ...
                                  $78.cameraYaw = (function () {
                                      if (isRightButton) {
                                          return v1.cameraYaw + Data_Int.toNumber(dx) * options.cameraHorizontalSensitivity;
                                      };
                                      if (!isRightButton) {
                                          return v1.cameraYaw;
                                      };
                                      throw new Error("Failed pattern match at Game.Cubbit.Hud line 155, column 45 - line 155, column 155: " + [ isRightButton.constructor.name ]);
                                  })();
                                  $78.cameraPitch = (function () {
                                      if (isRightButton) {
                                          return Data_Ord.max(Data_Ord.ordNumber)(-$$Math.pi * 0.45)(Data_Ord.min(Data_Ord.ordNumber)($$Math.pi * 0.45)(v1.cameraPitch + Data_Int.toNumber(dy) * options.cameraVertialSensitivity));
                                      };
                                      if (!isRightButton) {
                                          return v1.cameraPitch;
                                      };
                                      throw new Error("Failed pattern match at Game.Cubbit.Hud line 156, column 47 - line 156, column 195: " + [ isRightButton.constructor.name ]);
                                  })();
                                  return $78;
                              })))(function () {
                                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
                          ...
                          if (v instanceof ToggleDebugLayer) {
                              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(function __do() {
                                  Control_Monad_Eff_Ref.modifyRef(ref)(function (v1) {
                                      var $84 = {};
                                      for (var $85 in v1) {
                                          if (v1.hasOwnProperty($85)) {
                                              $84[$85] = v1[$85];
                                          };
                                      };
                                      $84.debugLayer = !v1.debugLayer;
                                      return $84;
                                  })();
                                  var v1 = Control_Monad_Eff_Ref.readRef(ref)();
                                  if (v1.debugLayer) {
                                  ...
                                  throw new Error("Failed pattern match at Game.Cubbit.Hud line 167, column 13 - line 169, column 61: " + [ v1.debugLayer.constructor.name ]);
                              }))(function () {
                                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0);
                              });
                          };
                          if (v instanceof OnMouseClick) {
                              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(function __do() {
                                  ...
                                  var put = function (block) {
                                      return function __do() {
                                          var v2 = Game_Cubbit_Control.pickBlock(scene)(cursor)(v1)(v1.mousePosition.x)(v1.mousePosition.y)();
                                          if (v2 instanceof Data_Maybe.Nothing) {
                                              return Data_Unit.unit;
                                          };
                                          if (v2 instanceof Data_Maybe.Just) {
                                              return Game_Cubbit_MeshBuilder.editBlock(ref)(materials)(scene)(v2.value0)(block)();
                                          };
                                          throw new Error("Failed pattern match at Game.Cubbit.Hud line 187, column 21 - line 189, column 90: " + [ v2.constructor.name ]);
                                      };
                                  };
                                  if (v1.mode instanceof Game_Cubbit_Types.Put) {
                                      return put(Game_Cubbit_BlockType.dirtBlock)();
                                  };
                                  if (v1.mode instanceof Game_Cubbit_Types.Remove) {
                                      return put(Game_Cubbit_BlockType.airBlock)();
                                  };
                                  if (v1.mode instanceof Game_Cubbit_Types.Move) {
                                      return Data_Unit.unit;
                                  };
                                  throw new Error("Failed pattern match at Game.Cubbit.Hud line 191, column 13 - line 194, column 34: " + [ v1.mode.constructor.name ]);
                              }))(function () {
                                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
                              });
                          };
                          if (v instanceof Zoom) {
                              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(Control_Monad_Eff_Ref.modifyRef(ref)(function (v1) {
                                  ...
                                  $102.cameraRange = Data_Ord.max(Data_Ord.ordNumber)(options.cameraMinimumRange)(Data_Ord.min(Data_Ord.ordNumber)(options.cameraMaximumRange)(v1.cameraRange + Data_Int.toNumber(deltaY(v.value0)) * options.cameraZoomSpeed));
                                  return $102;
                              })))(function () {
                                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
                              });
                          ...
                          if (v instanceof OnKeyDown) {
                              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(function __do() {
                                  (function () {
                                      var $107 = DOM_Event_KeyboardEvent.key(v.value0);
                                      if ($107 === " ") {
                                          return Data_Functor["void"](Control_Monad_Eff.functorEff)(Control_Monad_Eff_Ref.modifyRef(ref)(function (v1) {
                                              var $112 = {};
                                              for (var $113 in v1) {
                                                  if (v1.hasOwnProperty($113)) {
                                                      $112[$113] = v1[$113];
                                                  };
                                              };
                                              $112.velocity = (function () {
                                                  var $109 = {};
                                                  for (var $110 in v1.velocity) {
                                                      if (v1.velocity.hasOwnProperty($110)) {
                                                          $109[$110] = v1.velocity[$110];
                                                      };
                                                  };
                                                  $109.y = v1.velocity.y + options.jumpVelocity;
                                                  return $109;
                                              })();
                                              return $112;
                                          }));
                          ...
                          if (v instanceof OnKeyUp) {
                              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(function __do() {
                                  (function () {
                                      var $157 = DOM_Event_KeyboardEvent.key(v.value0);
                                      if ($157 === "w") {
                                          return Data_Functor["void"](Control_Monad_Eff.functorEff)(Control_Monad_Eff_Ref.modifyRef(ref)(function (v1) {
                                              var $159 = {};
                                              for (var $160 in v1) {
                                                  if (v1.hasOwnProperty($160)) {
                                                      $159[$160] = v1[$160];
                                                  };
                                              };
                                              $159.wKey = false;
                          ...
                          throw new Error("Failed pattern match at Game.Cubbit.Hud line 106, column 43 - line 245, column 18: " + [ v.constructor.name ]);
                      };
                  };
              };
          };
              ...
              return function (cursor) {
                  return function (materials) {
                      return Halogen_Component.component({
                          render: render, 
                          "eval": $$eval(scene)(cursor)(materials)(options)(ref), 
      ...
      return function (options) {
          return function (body) {
              return function (scene) {
                  return function (cursor) {
                      return function (materials) {
                          return Halogen_VirtualDOM_Driver.runUI(ui(ref)(options)(scene)(cursor)(materials))(body);
                      };
                  };
              };
          };
  ...
  var main = function __do() {
      ...
      if (v instanceof Data_Maybe.Just) {
          return Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Control_Monad_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(function (v1) {
              return Control_Bind.bind(Control_Monad_Aff.bindAff)(Network_HTTP_Affjax.get(Network_HTTP_Affjax_Response.responsableForeign)("options.json"))(function (v2) {
                  return Control_Bind.bind(Control_Monad_Aff.bindAff)((function () {
                      var $43 = Control_Monad_Except.runExcept(Game_Cubbit_Option.readOptions(v2.response));
                      ...
                      throw new Error("Failed pattern match at Game.Cubbit.Main line 64, column 20 - line 66, column 34: " + [ $43.constructor.name ]);
                  })())(function (v3) {
                      return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Graphics_Babylon_Engine.createEngine(v.value0)(true)))(function (v4) {
                          return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(function __do() {
                              var v5 = Graphics_Babylon_Scene.createScene(v4)();
                              Graphics_Babylon_Scene.setFogMode(Graphics_Babylon_Scene.fOGMODE_EXP)(v5)();
                              Graphics_Babylon_Scene.setFogDensity(v3.fogDensity)(v5)();
                              var v6 = Graphics_Babylon_Color3.createColor3(155.0 / 255.0)(181.0 / 255.0)(230.0 / 255.0)();
                              Graphics_Babylon_Scene.setFogColor(v6)(v5)();
                              Graphics_Babylon_Scene.setCollisionsEnabled(true)(v5)();
                              return v5;
                          }))(function (v5) {
                              return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Game_Cubbit_Terrain.emptyTerrain(0)))(function (v6) {
                                  return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Control_Monad_Eff_Ref.newRef({
                                      ...
                                      return Control_Bind.bind(Control_Monad_Aff.bindAff)(Graphics_Babylon_Texture_Aff.loadTexture("./texture.png")(v5)(Graphics_Babylon_Texture.defaultCreateTextureOptions))(function (v8) {
                                          return Control_Bind.bind(Control_Monad_Aff.bindAff)(Graphics_Babylon_Texture_Aff.loadTexture("./alpha.png")(v5)(Graphics_Babylon_Texture.defaultCreateTextureOptions))(function (v9) {
                                              return Control_Bind.bind(Control_Monad_Aff.bindAff)(Graphics_Babylon_Texture_Aff.loadTexture("./alice/texture.png")(v5)(Graphics_Babylon_Texture.defaultCreateTextureOptions))(function () {
                                                  return Control_Bind.bind(Control_Monad_Aff.bindAff)(Graphics_Babylon_SceneLoader_Aff.loadMesh("")("./alice/")("alice.babylon")(v5)(Control_Applicative.pure(Control_Monad_Eff.applicativeEff)))(function (v10) {
                                                      return Control_Bind.bind(Control_Monad_Aff.bindAff)(Graphics_Babylon_Sound_Aff.loadSound("forest.mp3")("forest.mp3")(v5)((function () {
                                                          var $56 = {};
                                                          for (var $57 in Graphics_Babylon_Sound.defaultCreateSoundOptions) {
                                                              if (Graphics_Babylon_Sound.defaultCreateSoundOptions.hasOwnProperty($57)) {
                                                                  $56[$57] = Graphics_Babylon_Sound.defaultCreateSoundOptions[$57];
                                                              };
                                                          };
                                                          $56.autoplay = true;
                                                          $56.loop = true;
                                                          ...
                                                          return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(function __do() {
                                                              var v12 = Graphics_Babylon_Mesh.createBox("cursor")(1.0)(v5)();
                                                              Graphics_Babylon_AbstractMesh.setRenderingGroupId(1)(Graphics_Babylon_Mesh.meshToAbstractMesh(v12))();
                                                              Graphics_Babylon_AbstractMesh.setIsPickable(false)(Graphics_Babylon_Mesh.meshToAbstractMesh(v12))();
                                                              Graphics_Babylon_AbstractMesh.setIsVisible(false)(Graphics_Babylon_Mesh.meshToAbstractMesh(v12))();
                                                              var v13 = Graphics_Babylon_StandardMaterial.createStandardMaterial("cursormat")(v5)();
                                                              Graphics_Babylon_Material.setWireframe(true)(Graphics_Babylon_StandardMaterial.standardMaterialToMaterial(v13))();
                                                              Graphics_Babylon_Material.setZOffset(-1.0e-2)(Graphics_Babylon_StandardMaterial.standardMaterialToMaterial(v13))();
                                                              Graphics_Babylon_AbstractMesh.setMaterial(Graphics_Babylon_StandardMaterial.standardMaterialToMaterial(v13))(Graphics_Babylon_Mesh.meshToAbstractMesh(v12))();
                                                              return v12;
                                                          }))(function (v12) {
                                                              return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(function __do() {
                                                                  var v13 = Graphics_Babylon_CubeTexture.createCubeTexture("skybox/skybox")(v5)();
                                                                  Graphics_Babylon_Texture.setCoordinatesMode(Graphics_Babylon_Texture.sKYBOX_MODE)(Graphics_Babylon_CubeTexture.cubeTextureToTexture(v13))();
                                                                  var v14 = Graphics_Babylon_StandardMaterial.createStandardMaterial("skyBox/skybox")(v5)();
                                                                  Graphics_Babylon_Material.setFogEnabled(false)(Graphics_Babylon_StandardMaterial.standardMaterialToMaterial(v14))();
                                                                  Graphics_Babylon_StandardMaterial.setBackFaceCulling(false)(v14)();
                                                                  Graphics_Babylon_StandardMaterial.setDisableLighting(true)(v14)();
                                                                  var v15 = Graphics_Babylon_Color3.createColor3(0.0)(0.0)(0.0)();
                                                                  Graphics_Babylon_StandardMaterial.setDiffuseColor(v15)(v14)();
                                                                  var v16 = Graphics_Babylon_Color3.createColor3(0.0)(0.0)(0.0)();
                                                                  Graphics_Babylon_StandardMaterial.setSpecularColor(v16)(v14)();
                                                                  Graphics_Babylon_StandardMaterial.setReflectionTexture(Graphics_Babylon_CubeTexture.cubeTextureToTexture(v13))(v14)();
                                                                  var v17 = Graphics_Babylon_Mesh.createBox("skybox")(1000.0)(v5)();
                                                                  Graphics_Babylon_AbstractMesh.setRenderingGroupId(Game_Cubbit_Constants.skyBoxRenderingGruop)(Graphics_Babylon_Mesh.meshToAbstractMesh(v17))();
                                                                  Graphics_Babylon_AbstractMesh.setMaterial(Graphics_Babylon_StandardMaterial.standardMaterialToMaterial(v14))(Graphics_Babylon_Mesh.meshToAbstractMesh(v17))();
                                                                  Graphics_Babylon_Mesh.setInfiniteDistance(true)(v17)();
                                                                  return v17;
                                                              }))(function (v13) {
                                                                  return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Game_Cubbit_Materials.initializeMaterials(v5)(v13)(v8)(v9)(v3)))(function (v14) {
                                                                      return Control_Bind.bind(Control_Monad_Aff.bindAff)(Game_Cubbit_Hud.initializeHud(v7)(v3)(v1)(v5)(v12)(v14))(function (v15) {
                                                                          return Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(function __do() {
                                                                              Control_Monad_Eff_Ref.modifyRef(v7)(function (v16) {
                                                                                  var $72 = {};
                                                                                  for (var $73 in v16) {
                                                                                      if (v16.hasOwnProperty($73)) {
                                                                                          $72[$73] = v16[$73];
                                                                                      };
                                                                                  };
                                                                                  $72.playerMeshes = v10;
                                                                              ...
                                                                              var v16 = (function __do() {
                                                                                  var v16 = Graphics_Babylon_Vector3.createVector3(10.0)(20.0)(-10.0)();
                                                                                  var v17 = Graphics_Babylon_TargetCamera.createTargetCamera("target-camera")(v16)(v5)();
                                                                                  var v18 = Graphics_Babylon_Vector3.createVector3(0.0)(8.0)(0.0)();
                                                                                  Graphics_Babylon_TargetCamera.setTarget(v18)(v17)();
                                                                                  Graphics_Babylon_Camera.setMaxZ(v3.cameraMaxZ)(Graphics_Babylon_TargetCamera.targetCameraToCamera(v17))();
                                                                                  Graphics_Babylon_Camera.setMinZ(v3.cameraMinZ)(Graphics_Babylon_TargetCamera.targetCameraToCamera(v17))();
                                                                                  Graphics_Babylon_Camera.setFOV(v3.cameraFOV)(Graphics_Babylon_TargetCamera.targetCameraToCamera(v17))();
                                                                                  return v17;
                                                                              })();
                                                                              Graphics_Babylon_Scene.setActiveCameras([ Graphics_Babylon_TargetCamera.targetCameraToCamera(v16) ])(v5)();
                                                                              Graphics_Babylon_Scene.setActiveCamera(Graphics_Babylon_TargetCamera.targetCameraToCamera(v16))(v5)();
                                                                              (function __do() {
                                                                                  var v17 = Graphics_Babylon_Vector3.createVector3(0.0)(1.0)(0.0)();
                                                                                  var v18 = Graphics_Babylon_HemisphericLight.createHemisphericLight("Hemi0")(v17)(v5)();
                                                                                  var v19 = Graphics_Babylon_Color3.createColor3(0.6)(0.6)(0.6)();
                                                                                  return Graphics_Babylon_Light.setDiffuse(v19)(Graphics_Babylon_HemisphericLight.hemisphericLightToLight(v18))();
                                                                              })();
                                                                              var v17 = (function __do() {
                                                                                  var v17 = Graphics_Babylon_Vector3.createVector3(0.3)(-1.0)(0.5)();
                                                                                  var v18 = Graphics_Babylon_DirectionalLight.createDirectionalLight("light1")(v17)(v5)();
                                                                                  var v19 = Graphics_Babylon_Color3.createColor3(0.8)(0.8)(0.8)();
                                                                                  Graphics_Babylon_Light.setDiffuse(v19)(Graphics_Babylon_DirectionalLight.directionalLightToLight(v18))();
                                                                                  var v20 = Graphics_Babylon_ShadowGenerator.createShadowGenerator(v3.shadowMapSize)(v18)();
                                                                                  Graphics_Babylon_ShadowGenerator.setBias(5.0e-6)(v20)();
                                                                                  Graphics_Babylon_ShadowGenerator.setUsePoissonSampling(true)(v20)();
                                                                                  return Graphics_Babylon_ShadowGenerator.getShadowMap(v20)();
                                                                              })();
                                                                              Data_Foldable.for_(Control_Monad_Eff.applicativeEff)(Data_Foldable.foldableArray)(v10)(function (mesh) {
                                                                                  return Data_Functor["void"](Control_Monad_Eff.functorEff)(function __do() {
                                                                                      var v18 = Graphics_Babylon_Vector3.createVector3(0.5)(13.0)(0.5)();
                                                                                      Graphics_Babylon_AbstractMesh.setPosition(v18)(mesh)();
                                                                                      Graphics_Babylon_AbstractMesh.setRenderingGroupId(1)(mesh)();
                                                                                      Graphics_Babylon_AbstractMesh.setReceiveShadows(true)(mesh)();
                                                                                      var v19 = Graphics_Babylon_AbstractMesh.getSkeleton(mesh)();
                                                                                      return Graphics_Babylon_AbstractMesh.setMaterial(v14.cellShadingMaterial)(mesh)();
                                                                                  });
                                                                              })();
                                                                              Control_Monad_Eff.forE(-v3.initialWorldSize)(v3.initialWorldSize)(function (x) {
                                                                                  return Control_Monad_Eff.forE(-v3.initialWorldSize)(v3.initialWorldSize)(function (z) {
                                                                                      return Data_Functor["void"](Control_Monad_Eff.functorEff)((function () {
                                                                                          var index = Game_Cubbit_ChunkIndex.chunkIndex(x)(0)(z);
                                                                                          return Game_Cubbit_MeshBuilder.createChunkMesh(v7)(v14)(v5)(index);
                                                                                      })());
                                                                                  });
                                                                              })();
                                                                              Graphics_Babylon_Engine.runRenderLoop(function __do() {
                                                                                  Game_Cubbit_Update.update(v7)(v5)(v14)(v17)(v12)(v16)(v3)(v13)(v15)();
                                                                                  return Graphics_Babylon_Scene.render(v5)();
                                                                              })(v4)();
      ...
      throw new Error("Failed pattern match at Game.Cubbit.Main line 55, column 8 - line 227, column 24: " + [ v.constructor.name ]);
  };
  exports["main"] = main;
})(PS["Game.Cubbit.Main"] = PS["Game.Cubbit.Main"] || {});
(function(exports) {
