...
(function(exports) {
  ...
  var genericOptions = new Data_Generic_Rep.Generic(function (x) {
      ...
      return {
          ...
          skyboxRotationSpeed: x.value1.value1.value1.value1.value1.value1.value1.value1.value1.value1.value1.value1.value1.value1.value1.value1.value1.value1.value1.value1.value1.value1.value1.value1.value1.value1
      };
  });
  ...
  }))(Data_Foreign_Class.intIsForeign))(Data_Foreign_Generic_Classes.genericDecodeFieldsField(new Data_Symbol.IsSymbol(function () {
      return "skyboxRotationSpeed";
  }))(Data_Foreign_Class.numberIsForeign)))))))))))))))))))))))))))))(Data_Foreign_Generic_Classes.genericCountArgsRec))((function () {
      var $109 = {};
      for (var $110 in Data_Foreign_Generic.defaultOptions) {
          if (Data_Foreign_Generic.defaultOptions.hasOwnProperty($110)) {
              $109[$110] = Data_Foreign_Generic.defaultOptions[$110];
          };
      };
      $109.unwrapSingleConstructors = true;
      return $109;
  })());
          ...
          var load = function (url) {
              return function (loop) {
                  return Control_Bind.bind(Control_Monad_Aff.bindAff)(Graphics_Babylon_Aff_Sound.loadSound(url)(url)(scene)((function () {
                      var $12 = {};
                      for (var $13 in Graphics_Babylon_Sound.defaultCreateSoundOptions) {
                          if (Graphics_Babylon_Sound.defaultCreateSoundOptions.hasOwnProperty($13)) {
                              $12[$13] = Graphics_Babylon_Sound.defaultCreateSoundOptions[$13];
                          };
                      };
                      $12.autoplay = false;
                      $12.loop = loop;
          ...
          return Control_Bind.bind(Control_Monad_Aff.bindAff)(load("sound/Your_natural.mp3")(true))(function (v) {
              return Control_Bind.bind(Control_Monad_Aff.bindAff)(load("sound/rye.mp3")(true))(function (v1) {
                  return Control_Bind.bind(Control_Monad_Aff.bindAff)(load("sound/cleaningstream.mp3")(true))(function (v2) {
                      return Control_Bind.bind(Control_Monad_Aff.bindAff)(load("sound/ichigo.mp3")(true))(function (v3) {
                          return Control_Bind.bind(Control_Monad_Aff.bindAff)(load("sound/forest.mp3")(true))(function (v4) {
                              return Control_Bind.bind(Control_Monad_Aff.bindAff)(load("sound/step13a.mp3")(true))(function (v5) {
                                  return Control_Bind.bind(Control_Monad_Aff.bindAff)(load("sound/tm2_switch001.mp3")(false))(function (v6) {
                                      return Control_Bind.bind(Control_Monad_Aff.bindAff)(load("sound/bosu06.mp3")(false))(function (v7) {
                                          return Control_Bind.bind(Control_Monad_Aff.bindAff)(load("sound/bosu28_c.mp3")(false))(function (v8) {
                                              return Control_Bind.bind(Control_Monad_Aff.bindAff)(load("sound/warp01.mp3")(false))(function (v9) {
                                                  var bgms = [ v1, v, v2, v3 ];
                                                  var ses = [ v4, v6, v7, v8, v5, v9 ];
...
(function(exports) {
  // Generated by psc version 0.10.3
  "use strict";
  var $foreign = PS["Game.Cubbit.Resources"];
  var Control_Alternative = PS["Control.Alternative"];
  var Control_Bind = PS["Control.Bind"];
  var Control_Monad_Aff = PS["Control.Monad.Aff"];
  var Control_Monad_Eff = PS["Control.Monad.Eff"];
  ...
  var loadResources = function (canvasGL) {
      return function (inc) {
          ...
          return Control_Bind.bind(Control_Monad_Aff.bindAff)(loadImage$prime("./image/loading.png"))(function () {
                  ...
                  return Control_Bind.bind(Control_Monad_Aff.bindAff)(loadImage$prime("./image/screenshade.png"))(function () {
                      return Control_Bind.bind(Control_Monad_Aff.bindAff)(Network_HTTP_Affjax.get(Network_HTTP_Affjax_Response.responsableForeign)("options.json"))(function (v) {
                          return Control_Bind.bind(Control_Monad_Aff.bindAff)((function () {
                              var $44 = Control_Monad_Except.runExcept(Game_Cubbit_Option.readOptions(v.response));
                              if ($44 instanceof Data_Either.Left) {
                                  return Control_Monad_Error_Class.throwError(Control_Monad_Aff.monadErrorAff)(Control_Monad_Eff_Exception.error(Data_Show.show(Data_List_Types.showNonEmptyList(Data_Foreign.showForeignError))($44.value0)));
                              };
                              if ($44 instanceof Data_Either.Right) {
                                  return Control_Applicative.pure(Control_Monad_Aff.applicativeAff)($44.value0);
                              };
                              throw new Error("Failed pattern match at Game.Cubbit.Resources line 99, column 24 - line 101, column 30: " + [ $44.constructor.name ]);
                          })())(function (v1) {
                              return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Web_Firebase.initializeApp(v1.profile)))(function (v2) {
                                  return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Graphics_Babylon_Engine.createEngine(canvasGL)(true)))(function (v3) {
                                      return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(function __do() {
                                          ...
                                          return Control_Bind.bind(Control_Monad_Aff.bindAff)(loadTexture$prime("./image/texture.png")(v4)(Graphics_Babylon_Texture.defaultCreateTextureOptions))(function (v5) {
                                              return Control_Bind.bind(Control_Monad_Aff.bindAff)(loadTexture$prime("./image/alpha.png")(v4)(Graphics_Babylon_Texture.defaultCreateTextureOptions))(function (v6) {
                                                  return Control_Bind.bind(Control_Monad_Aff.bindAff)(loadTexture$prime("./alice/texture.png")(v4)(Graphics_Babylon_Texture.defaultCreateTextureOptions))(function () {
                                                      return Control_Bind.bind(Control_Monad_Aff.bindAff)(loadMesh$prime("")("./alice/")("alice.babylon")(v4)(Control_Applicative.pure(Control_Monad_Eff.applicativeEff)))(function (v7) {
                                                                  ...
                                                                  return Control_Bind.bind(Control_Monad_Aff.bindAff)(loadText("./alice/outline.fragment.fx"))(function () {
                                                                      return Control_Bind.bind(Control_Monad_Aff.bindAff)(loadText("./alice/outline.vertex.fx"))(function () {
                                                                          return Control_Bind.bind(Control_Monad_Aff.bindAff)(loadText("./alice/alice.babylon.manifest"))(function () {
                                                                              return Control_Bind.bind(Control_Monad_Aff.bindAff)(Game_Cubbit_Sounds.loadSounds(v4)(inc))(function (v8) {
                                                                                  return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(function __do() {
                                                                                      var v9 = Graphics_Babylon_Mesh.createBox("cursor")(1.0)(v4)();
                                                                                      Graphics_Babylon_AbstractMesh.setRenderingGroupId(1)(Graphics_Babylon_Mesh.meshToAbstractMesh(v9))();
                                                                                      Graphics_Babylon_AbstractMesh.setIsPickable(false)(Graphics_Babylon_Mesh.meshToAbstractMesh(v9))();
                                                                                      Graphics_Babylon_AbstractMesh.setIsVisible(false)(Graphics_Babylon_Mesh.meshToAbstractMesh(v9))();
                                                                                      var v10 = Graphics_Babylon_StandardMaterial.createStandardMaterial("cursormat")(v4)();
                                                                                      Graphics_Babylon_Material.setWireframe(true)(Graphics_Babylon_StandardMaterial.standardMaterialToMaterial(v10))();
                                                                                      Graphics_Babylon_Material.setZOffset(-1.0e-2)(Graphics_Babylon_StandardMaterial.standardMaterialToMaterial(v10))();
                                                                                      Graphics_Babylon_AbstractMesh.setMaterial(Graphics_Babylon_StandardMaterial.standardMaterialToMaterial(v10))(Graphics_Babylon_Mesh.meshToAbstractMesh(v9))();
                                                                                      return v9;
                                                                                  }))(function (v9) {
                                                                                      return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(function __do() {
                                                                                          var v10 = Graphics_Babylon_CubeTexture.createCubeTexture("skybox/skybox")(v4)();
                                                                                          Graphics_Babylon_Texture.setCoordinatesMode(Graphics_Babylon_Texture.sKYBOX_MODE)(Graphics_Babylon_CubeTexture.cubeTextureToTexture(v10))();
                                                                                          var v11 = Graphics_Babylon_StandardMaterial.createStandardMaterial("skyBox/skybox")(v4)();
                                                                                          Graphics_Babylon_Material.setFogEnabled(false)(Graphics_Babylon_StandardMaterial.standardMaterialToMaterial(v11))();
                                                                                          Graphics_Babylon_StandardMaterial.setBackFaceCulling(false)(v11)();
                                                                                          Graphics_Babylon_StandardMaterial.setDisableLighting(true)(v11)();
                                                                                          var v12 = Graphics_Babylon_Color3.createColor3(0.0)(0.0)(0.0)();
                                                                                          Graphics_Babylon_StandardMaterial.setDiffuseColor(v12)(v11)();
                                                                                          var v13 = Graphics_Babylon_Color3.createColor3(0.0)(0.0)(0.0)();
                                                                                          Graphics_Babylon_StandardMaterial.setSpecularColor(v13)(v11)();
                                                                                          Graphics_Babylon_StandardMaterial.setReflectionTexture(Graphics_Babylon_CubeTexture.cubeTextureToTexture(v10))(v11)();
                                                                                          var v14 = Graphics_Babylon_Mesh.createBox("skybox")(1000.0)(v4)();
                                                                                          Graphics_Babylon_AbstractMesh.setRenderingGroupId(Game_Cubbit_Constants.skyBoxRenderingGruop)(Graphics_Babylon_Mesh.meshToAbstractMesh(v14))();
                                                                                          Graphics_Babylon_AbstractMesh.setMaterial(Graphics_Babylon_StandardMaterial.standardMaterialToMaterial(v11))(Graphics_Babylon_Mesh.meshToAbstractMesh(v14))();
                                                                                          Graphics_Babylon_Mesh.setInfiniteDistance(true)(v14)();
                                                                                          return v14;
                                                                                      }))(function (v10) {
                                                                                          return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Game_Cubbit_Materials.initializeMaterials(v4)(v10)(v5)(v6)(v1)))(function (v11) {
                                                                                              return Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(function __do() {
                                                                                                  var v12 = (function __do() {
                                                                                                      var v12 = Graphics_Babylon_Vector3.createVector3(10.0)(20.0)(-10.0)();
                                                                                                      var v13 = Graphics_Babylon_TargetCamera.createTargetCamera("target-camera")(v12)(v4)();
                                                                                                      var v14 = Graphics_Babylon_Vector3.createVector3(0.0)(8.0)(0.0)();
                                                                                                      Graphics_Babylon_TargetCamera.setTarget(v14)(v13)();
                                                                                                      Graphics_Babylon_Camera.setMaxZ(v1.cameraMaxZ)(Graphics_Babylon_TargetCamera.targetCameraToCamera(v13))();
                                                                                                      Graphics_Babylon_Camera.setMinZ(v1.cameraMinZ)(Graphics_Babylon_TargetCamera.targetCameraToCamera(v13))();
                                                                                                      Graphics_Babylon_Camera.setFOV(v1.cameraFOV)(Graphics_Babylon_TargetCamera.targetCameraToCamera(v13))();
                                                                                                      return v13;
                                                                                                  })();
                                                                                                  Graphics_Babylon_Scene.setActiveCameras([ Graphics_Babylon_TargetCamera.targetCameraToCamera(v12) ])(v4)();
                                                                                                  Graphics_Babylon_Scene.setActiveCamera(Graphics_Babylon_TargetCamera.targetCameraToCamera(v12))(v4)();
                                                                                                  (function __do() {
                                                                                                      var v13 = Graphics_Babylon_Vector3.createVector3(0.0)(1.0)(0.0)();
                                                                                                      var v14 = Graphics_Babylon_HemisphericLight.createHemisphericLight("Hemi0")(v13)(v4)();
                                                                                                      var v15 = Graphics_Babylon_Color3.createColor3(0.6)(0.6)(0.6)();
                                                                                                      return Graphics_Babylon_Light.setDiffuse(v15)(Graphics_Babylon_HemisphericLight.hemisphericLightToLight(v14))();
                                                                                                  })();
                                                                                                  var v13 = (function __do() {
                                                                                                      var v13 = Graphics_Babylon_Vector3.createVector3(0.3)(-1.0)(0.5)();
                                                                                                      var v14 = Graphics_Babylon_DirectionalLight.createDirectionalLight("light1")(v13)(v4)();
                                                                                                      var v15 = Graphics_Babylon_Color3.createColor3(0.8)(0.8)(0.8)();
                                                                                                      Graphics_Babylon_Light.setDiffuse(v15)(Graphics_Babylon_DirectionalLight.directionalLightToLight(v14))();
                                                                                                      var v16 = Graphics_Babylon_ShadowGenerator.createShadowGenerator(v1.shadowMapSize)(v14)();
                                                                                                      Graphics_Babylon_ShadowGenerator.setBias(5.0e-6)(v16)();
                                                                                                      Graphics_Babylon_ShadowGenerator.setUsePoissonSampling(true)(v16)();
                                                                                                      return Graphics_Babylon_ShadowGenerator.getShadowMap(v16)();
                                                                                                  })();
                                                                                                  Data_Foldable.for_(Control_Monad_Eff.applicativeEff)(Data_Foldable.foldableArray)(v7)(function (mesh) {
                                                                                                      return Data_Functor["void"](Control_Monad_Eff.functorEff)(function __do() {
                                                                                                          var v14 = Graphics_Babylon_Vector3.createVector3(0.5)(13.0)(0.5)();
                                                                                                          Graphics_Babylon_AbstractMesh.setPosition(v14)(mesh)();
                                                                                                          Graphics_Babylon_AbstractMesh.setRenderingGroupId(1)(mesh)();
                                                                                                          Graphics_Babylon_AbstractMesh.setReceiveShadows(true)(mesh)();
                                                                                                          var v15 = Graphics_Babylon_AbstractMesh.getSkeleton(mesh)();
                                                                                                          var name = Graphics_Babylon_Node.getName(Unsafe_Coerce.unsafeCoerce(mesh));
                                                                                                          Graphics_Babylon_AbstractMesh.setMaterial((function () {
                                                                                                              var $81 = Data_String.contains("-outline")(name);
                                                                                                              if ($81) {
                                                                                                                  return v11.outlineMaterial;
                                                                                                              };
                                                                                                              if (!$81) {
                                                                                                                  return v11.cellShadingMaterial;
                                                                                                              };
                                                                                                              throw new Error("Failed pattern match at Game.Cubbit.Resources line 209, column 26 - line 209, column 129: " + [ $81.constructor.name ]);
                                                                                                          })())(mesh)();
...
(function(exports) {
          ...
          return function (index) {
              return function __do() {
                  (function () {
                      ...
                      throw new Error("Failed pattern match at Game.Cubbit.Collesion line 124, column 5 - line 127, column 55: " + [ $30.constructor.name ]);
                  })()();
                  var $32 = {};
                  for (var $33 in v) {
  ...
  var createPlayerCollesion = function __do() {
      ...
      var v3 = Graphics_Cannon_Body.createBody((function () {
          ...
          for (var $39 in Graphics_Cannon_Body.defaultBodyProps) {
              if (Graphics_Cannon_Body.defaultBodyProps.hasOwnProperty($39)) {
      ...
      return function (world) {
          return function (index) {
              ...
              return function __do() {
                  ...
                  var indices = Control_Bind.bind(Data_List_Types.bindList)(Data_List.range(ri.x - 1)(ri.x + 1 | 0))(function (v1) {
                      return Control_Bind.bind(Data_List_Types.bindList)(Data_List.range(ri.y - 1)(ri.y + 1 | 0))(function (v2) {
                          return Control_Bind.bind(Data_List_Types.bindList)(Data_List.range(ri.z - 1)(ri.z + 1 | 0))(function (v3) {
                              ...
                              throw new Error("Failed pattern match at Game.Cubbit.Collesion line 160, column 13 - line 162, column 34: " + [ $61.constructor.name ]);
                          });
                      });
                  });
                  ...
                  throw new Error("Failed pattern match at Game.Cubbit.Collesion line 167, column 5 - line 173, column 13: " + [ v1.constructor.name ]);
              };
          };
      };
  };
              ...
              return function (v) {
                  ...
                  if (v.sceneState instanceof Game_Cubbit_Types.PlayingSceneState) {
                      return function __do() {
                          ...
                          $86.sceneState = new Game_Cubbit_Types.PlayingSceneState((function () {
                              var $83 = {};
                              for (var $84 in v.sceneState.value0) {
                                  if (v.sceneState.value0.hasOwnProperty($84)) {
                                      $83[$84] = v.sceneState.value0[$84];
                                  };
                              };
                              $83.position = v4;
                              $83.velocity = v5;
                  ...
                  throw new Error("Failed pattern match at Game.Cubbit.Collesion line 68, column 57 - line 94, column 10: " + [ v.sceneState.constructor.name ]);
              };
          };
      };
  };
  var updateChunkCollesion = function (v) {
      return function (world) {
          return function (index) {
              var $93 = Data_Map.lookup(Game_Cubbit_ChunkIndex.ordChunkIndex)(index)(v.bodies);
              if ($93 instanceof Data_Maybe.Nothing) {
                  return Control_Applicative.pure(Control_Monad_Eff.applicativeEff)(v);
              };
              if ($93 instanceof Data_Maybe.Just) {
                  return function __do() {
                      Data_Foldable.for_(Control_Monad_Eff.applicativeEff)(Data_Foldable.foldableArray)($93.value0)(function (body) {
                          return Graphics_Cannon_World.removeBody(body)(world);
                      })();
                      ...
                      if (v1 instanceof Data_Maybe.Just) {
                          ...
                          $100.bodies = Data_Map.insert(Game_Cubbit_ChunkIndex.ordChunkIndex)(index)(v2)(Data_Map["delete"](Game_Cubbit_ChunkIndex.ordChunkIndex)(index)(v.bodies));
                          return $100;
                      };
                      throw new Error("Failed pattern match at Game.Cubbit.Collesion line 112, column 13 - line 120, column 22: " + [ v1.constructor.name ]);
                  };
              };
              throw new Error("Failed pattern match at Game.Cubbit.Collesion line 103, column 5 - line 120, column 22: " + [ $93.constructor.name ]);
          };
      };
  };
...
(function(exports) {
  ...
  var ModeSelect = (function () {
      ...
      ModeSelect.value = new ModeSelect();
      return ModeSelect;
  })();
  var Home = (function () {
      function Home() {
  ...
  var ToggleWaterMaterial = (function () {
      function ToggleWaterMaterial() {

      };
      ToggleWaterMaterial.value = new ToggleWaterMaterial();
  ...
  var SetLanguage = (function () {
      function SetLanguage(value0) {
          this.value0 = value0;
      };
      SetLanguage.create = function (value0) {
          return new SetLanguage(value0);
      };
      return SetLanguage;
  })();
  var Query = (function () {
              ...
              return function (index) {
                  return function (v1) {
                      return function (v2) {
                          ...
                          if (v.res instanceof Game_Cubbit_Types.Complete) {
                              return function __do() {
                                  ...
                                  var v4 = (function () {
                                      ...
                                      throw new Error("Failed pattern match at Game.Cubbit.MeshBuilder line 101, column 28 - line 103, column 47: " + [ v3.constructor.name ]);
                                  })();
                                  ...
                                  (function () {
                                      ...
                                      throw new Error("Failed pattern match at Game.Cubbit.MeshBuilder line 112, column 21 - line 114, column 65: " + [ v5.constructor.name ]);
                                  })()();
                                  ...
                                  var gen = function (vertices) {
                                      return function (mat) {
                                          return function (gruop) {
                                              ...
                                              throw new Error("Failed pattern match at Game.Cubbit.MeshBuilder line 119, column 50 - line 125, column 53: " + [ $57.constructor.name ]);
                                          };
                                      };
                                  };
                                  var v6 = gen($53.standardMaterialBlocks)(materials.blockMaterial)(Game_Cubbit_Constants.terrainRenderingGroup)();
                                  var v7 = gen($53.waterMaterialBlocks)(materials.waterMaterial)(Game_Cubbit_Constants.terrainRenderingGroup)();
                                  var v8 = gen($53.transparentMaterialVertexData)(materials.bushMaterial)(Game_Cubbit_Constants.terrainRenderingGroup)();
                          ...
                          throw new Error("Failed pattern match at Game.Cubbit.MeshBuilder line 92, column 5 - line 144, column 109: " + [ v.res.constructor.name ]);
                      };
                  };
              };
          };
                      ...
                      return function (v1) {
                          return Data_Functor["void"](Control_Monad_Eff.functorEff)(function __do() {
                              ...
                              (function () {
                                  ...
                                  throw new Error("Failed pattern match at Game.Cubbit.MeshBuilder line 244, column 5 - line 246, column 49: " + [ v4.constructor.name ]);
                              })()();
                      ...
                      return Data_Functor["void"](Control_Monad_Eff.functorEff)((function () {
                          ...
                          return function __do() {
                              updateChunkMesh(ref)(v.res.value0.materials)(v.res.value0.scene)((function () {
                                  var $86 = {};
                                  for (var $87 in v1.value0) {
                                      if (v1.value0.hasOwnProperty($87)) {
                                          $86[$87] = v1.value0[$87];
                                      };
                                  };
                                  $86.blocks = blocks;
                                  ...
                                  if (v.sceneState instanceof Game_Cubbit_Types.PlayingSceneState) {
                                      ...
                                      if (v.sceneState.value0.gameMode instanceof Game_Cubbit_Types.MultiplayerMode) {
                                          return Game_Cubbit_Firebase.saveChunkToFirebase({
                                              index: v1.value0.index, 
                                              blocks: blocks
                                          })(v.res.value0.firebase);
                                      };
                                      throw new Error("Failed pattern match at Game.Cubbit.MeshBuilder line 182, column 21 - line 184, column 127: " + [ v.sceneState.value0.gameMode.constructor.name ]);
                                  };
                                  return Control_Applicative.pure(Control_Monad_Eff.applicativeEff)(Data_Unit.unit);
                              })()();
                                  ...
                                  return function (dy) {
                                      return function (dz) {
                                          return function __do() {
                                              ...
                                              throw new Error("Failed pattern match at Game.Cubbit.MeshBuilder line 191, column 21 - line 193, column 133: " + [ v2.constructor.name ]);
                                          };
                                      };
                                  };
                              };
                  ...
                  return Control_Bind.bind(Control_Monad_Eff.bindEff)(Game_Cubbit_Terrain.lookupChunk(v.index)(v1.terrain))(Data_Foldable.traverse_(Control_Monad_Eff.applicativeEff)(Data_Foldable.foldableMaybe)(function (chunkData) {
                      return function __do() {
                          ...
                          updateChunkMesh(ref)(res.materials)(res.scene)((function () {
                              var $101 = {};
                              for (var $102 in chunkData) {
                                  if (chunkData.hasOwnProperty($102)) {
                                      $101[$102] = chunkData[$102];
                                  };
                              };
                              $101.blocks = v.blocks;
                              $101.edited = true;
                                  ...
                                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)((function () {
                                      ...
                                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(modifyAppState(ref)(function (v4) {
                                          ...
                                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(function __do() {
                                                  ...
                                                  return Control_Monad_Eff.forE(-v1.options.initialWorldSize)(v1.options.initialWorldSize)(function (z) {
                                                      return Data_Functor["void"](Control_Monad_Eff.functorEff)((function () {
                                                          ...
                                                          return function __do() {
                                                              ...
                                                              return Game_Cubbit_MeshBuilder.generateChunk(v4)(v1.materials)(v1.scene)(index)(v1.options)(v4.config)();
                                                          };
                                                      })());
                                                  });
                                              })();
                                              ...
                                              throw new Error("Failed pattern match at Game.Cubbit.Hud.Start line 127, column 9 - line 129, column 41: " + [ gameMode.constructor.name ]);
                                          }))(function () {
                                              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Game_Cubbit_Aff.wait(Halogen_Query_HalogenM.monadAffHalogenM(Control_Monad_Aff_Class.monadAffAff))(1000))(function () {
                                                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(function __do() {
...
(function(exports) {
  ...
  var initializeTerrain = function (ref) {
      return function __do() {
          ...
          if (v.res instanceof Game_Cubbit_Types.Complete) {
              Game_Cubbit_Hud_Start.clearTerrain(v.terrain)(v.world)();
              var v1 = Game_Cubbit_Terrain.createTerrain(0)();
              ...
              Control_Monad_Eff.forE(-v.res.value0.options.initialWorldSize)(v.res.value0.options.initialWorldSize)(function (x) {
                  return Control_Monad_Eff.forE(-v.res.value0.options.initialWorldSize)(v.res.value0.options.initialWorldSize)(function (z) {
                      return Data_Functor["void"](Control_Monad_Eff.functorEff)((function () {
                          var index = Game_Cubbit_ChunkIndex.chunkIndex(x)(0)(z);
                          return function __do() {
                              var v2 = Control_Monad_Eff_Ref.readRef(ref)();
                              return Game_Cubbit_MeshBuilder.generateChunk(v2)(v.res.value0.materials)(v.res.value0.scene)(index)(v.res.value0.options)(v2.config)();
                          };
                      })());
                  });
              })();
              var v2 = Control_Monad_Rec_Class.tailRecM2(Control_Monad_Rec_Class.monadRecEff)(function (ter) {
                  return function (v2) {
                      if (v2 === 0) {
                          return Control_Applicative.pure(Control_Monad_Eff.applicativeEff)(new Control_Monad_Rec_Class.Done(ter));
                      };
                      return function __do() {
                          var v3 = Game_Cubbit_Collesion.buildCollesionTerrain(ter)(v.world)(Game_Cubbit_ChunkIndex.chunkIndex(0)(0)(0))();
                          return new Control_Monad_Rec_Class.Loop({
                              a: v3, 
                              b: v2 - 1
                          });
              ...
              return Control_Monad_Eff_Ref.modifyRef(ref)(function (v3) {
                  var $68 = {};
                  for (var $69 in v3) {
                      if (v3.hasOwnProperty($69)) {
                          $68[$69] = v3[$69];
                      };
                  };
                  $68.terrain = v2;
          ...
          throw new Error("Failed pattern match at Game.Cubbit.Hud.Eval line 442, column 5 - line 470, column 71: " + [ v.res.constructor.name ]);
      };
  };
              ...
              if (v.res instanceof Game_Cubbit_Types.Complete) {
                  return Data_Functor.voidRight(Halogen_Query_HalogenM.functorHalogenM)(query.value1)((function () {
                      ...
                      if (query.value0 instanceof Game_Cubbit_Hud_Type.SetLanguage) {
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(Graphics_Babylon_Sound.play(v.res.value0.sounds.switchSound)))(function () {
                              return Game_Cubbit_Hud_Start.modifyAppState(ref)(function (v1) {
                                  var $89 = {};
                                  for (var $90 in v1) {
                                      if (v1.hasOwnProperty($90)) {
                                          $89[$90] = v1[$90];
                                      };
                                  };
                                  $89.config = (function () {
                                      var $86 = {};
                                      for (var $87 in v1.config) {
                                          if (v1.config.hasOwnProperty($87)) {
                                              $86[$87] = v1.config[$87];
                                          };
                                      };
                                      $86.language = query.value0.value0;
                                      return $86;
                                  })();
                                  return $89;
                              });
                      ...
                      if (query.value0 instanceof Game_Cubbit_Hud_Type.ShowConfig) {
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Game_Cubbit_Hud_Start.modifyAppState(ref)(function (v1) {
                              var $98 = {};
                              for (var $99 in v1) {
                                  if (v1.hasOwnProperty($99)) {
                                      $98[$99] = v1[$99];
                                  };
                              };
                              $98.configVisible = true;
                              return $98;
                          }))(function () {
                      ...
                      if (query.value0 instanceof Game_Cubbit_Hud_Type.CloseConfig) {
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Game_Cubbit_Hud_Start.modifyAppState(ref)(function (v1) {
                              var $102 = {};
                              for (var $103 in v1) {
                                  if (v1.hasOwnProperty($103)) {
                                      $102[$103] = v1[$103];
                                  };
                              };
                              $102.configVisible = false;
                              return $102;
                          }))(function () {
                              return Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(Graphics_Babylon_Sound.play(v.res.value0.sounds.switchSound));
                          });
                      ...
                      if (query.value0 instanceof Game_Cubbit_Hud_Type.SetBGMVolume) {
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Game_Cubbit_Hud_Start.modifyAppState(ref)(function (v1) {
                              var $109 = {};
                              for (var $110 in v1) {
                                  if (v1.hasOwnProperty($110)) {
                                      $109[$110] = v1[$110];
                                  };
                              };
                              $109.config = (function () {
                                  var $106 = {};
                                  for (var $107 in v1.config) {
                                      if (v1.config.hasOwnProperty($107)) {
                                          $106[$107] = v1.config[$107];
                                      };
                                  };
                                  $106.bgmVolume = query.value0.value0;
                                  return $106;
                              })();
                              return $109;
                          }))(function () {
                              return Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(function __do() {
                                  ...
                                  var v1 = Control_Monad_Eff_Ref.readRef(ref)();
                                  return Game_Cubbit_Config.writeConfig(v1.config)();
                              });
                          });
                      };
                      if (query.value0 instanceof Game_Cubbit_Hud_Type.SetSEVolume) {
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Game_Cubbit_Hud_Start.modifyAppState(ref)(function (v1) {
                              var $120 = {};
                              for (var $121 in v1) {
                                  if (v1.hasOwnProperty($121)) {
                                      $120[$121] = v1[$121];
                                  };
                              };
                              $120.config = (function () {
                                  var $117 = {};
                                  for (var $118 in v1.config) {
                                      if (v1.config.hasOwnProperty($118)) {
                                          $117[$118] = v1.config[$118];
                                      };
                                  };
                                  $117.seVolume = query.value0.value0;
                                  return $117;
                              })();
                              return $120;
                          }))(function () {
                      ...
                      if (query.value0 instanceof Game_Cubbit_Hud_Type.ToggleShadow) {
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Game_Cubbit_Hud_Start.modifyAppState(ref)(function (v1) {
                              ...
                              $131.config = (function () {
                                  var $128 = {};
                                  for (var $129 in v1.config) {
                                      if (v1.config.hasOwnProperty($129)) {
                                          $128[$129] = v1.config[$129];
                                      };
                                  };
                                  $128.shadow = !v1.config.shadow;
                                  return $128;
                              })();
                              return $131;
                          }))(function () {
                              return Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(function __do() {
                                  ...
                                  var v2 = Graphics_Babylon_Scene.getMeshes(v.res.value0.scene)();
                                  return Data_Foldable.for_(Control_Monad_Eff.applicativeEff)(Data_Foldable.foldableArray)(v2)(Graphics_Babylon_AbstractMesh.setReceiveShadows(v1.config.shadow))();
                              });
                          });
                      };
                      if (query.value0 instanceof Game_Cubbit_Hud_Type.ToggleVertexColor) {
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Game_Cubbit_Hud_Start.modifyAppState(ref)(function (v1) {
                              ...
                              $142.config = (function () {
                                  var $139 = {};
                                  for (var $140 in v1.config) {
                                      if (v1.config.hasOwnProperty($140)) {
                                          $139[$140] = v1.config[$140];
                                      };
                                  };
                                  $139.vertexColor = !v1.config.vertexColor;
                                  return $139;
                              })();
                              return $142;
                          }))(function () {
                              return Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(function __do() {
                                  ...
                                  var v3 = Graphics_Babylon_Scene.getMeshes(v.res.value0.scene)();
                                  return Data_Foldable.for_(Control_Monad_Eff.applicativeEff)(Data_Foldable.foldableArray)(v3)(Graphics_Babylon_AbstractMesh.setUseVertexColors(v2.config.vertexColor))();
                              });
                          });
                      };
                      if (query.value0 instanceof Game_Cubbit_Hud_Type.ToggleWaterMaterial) {
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Game_Cubbit_Hud_Start.modifyAppState(ref)(function (v1) {
                              var $154 = {};
                              for (var $155 in v1) {
                                  if (v1.hasOwnProperty($155)) {
                                      $154[$155] = v1[$155];
                                  };
                              };
                              $154.config = (function () {
                                  var $151 = {};
                                  for (var $152 in v1.config) {
                                      if (v1.config.hasOwnProperty($152)) {
                                          $151[$152] = v1.config[$152];
                                      };
                                  };
                                  $151.waterMaterial = !v1.config.waterMaterial;
                                  return $151;
                              })();
                              return $154;
                          }))(function () {
                      ...
                      if (query.value0 instanceof Game_Cubbit_Hud_Type.SetShadowArea) {
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Game_Cubbit_Hud_Start.modifyAppState(ref)(function (v1) {
                              var $163 = {};
                              for (var $164 in v1) {
                                  if (v1.hasOwnProperty($164)) {
                                      $163[$164] = v1[$164];
                                  };
                              };
                              $163.config = (function () {
                                  var $160 = {};
                                  for (var $161 in v1.config) {
                                      if (v1.config.hasOwnProperty($161)) {
                                          $160[$161] = v1.config[$161];
                                      };
                                  };
                                  $160.shadowArea = query.value0.value0;
                                  return $160;
                              })();
                              return $163;
                          }))(function () {
                      ...
                      if (query.value0 instanceof Game_Cubbit_Hud_Type.SetChunkArea) {
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Game_Cubbit_Hud_Start.modifyAppState(ref)(function (v1) {
                              var $173 = {};
                              for (var $174 in v1) {
                                  if (v1.hasOwnProperty($174)) {
                                      $173[$174] = v1[$174];
                                  };
                              };
                              $173.config = (function () {
                                  var $170 = {};
                                  for (var $171 in v1.config) {
                                      if (v1.config.hasOwnProperty($171)) {
                                          $170[$171] = v1.config[$171];
                                      };
                                  };
                                  $170.chunkArea = query.value0.value0;
                                  return $170;
                              })();
                              return $173;
                          }))(function () {
                                  ...
                                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Game_Cubbit_Aff.wait(Halogen_Query_HalogenM.monadAffHalogenM(Control_Monad_Aff_Class.monadAffAff))(1000))(function () {
                                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(Graphics_Babylon_Sound.stop(v.res.value0.sounds.forestSound)))(function () {
                                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Game_Cubbit_Hud_Start.modifyAppState(ref)(function (v1) {
                                              var $184 = {};
                                              for (var $185 in v1) {
                                                  if (v1.hasOwnProperty($185)) {
                                                      $184[$185] = v1[$185];
                                                  };
                                              };
                                              $184.sceneState = nextScene;
                                              $184.nextBGM = new Data_Maybe.Just(v.res.value0.sounds.cleaning);
                                              return $184;
                                          }))(function () {
                                              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Game_Cubbit_Aff.wait(Halogen_Query_HalogenM.monadAffHalogenM(Control_Monad_Aff_Class.monadAffAff))(1000))(function () {
                                                  return Game_Cubbit_Hud_Start.modifyAppState(ref)(function (v1) {
                              ...
                              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Game_Cubbit_Hud_Start.modifyAppState(ref)(function (v1) {
                                  ...
                                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Game_Cubbit_Aff.wait(Halogen_Query_HalogenM.monadAffHalogenM(Control_Monad_Aff_Class.monadAffAff))(1000))(function () {
                                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Game_Cubbit_Hud_Start.modifyAppState(ref)(function (v1) {
                                          var $196 = {};
                                          for (var $197 in v1) {
                                              if (v1.hasOwnProperty($197)) {
                                                  $196[$197] = v1[$197];
                                              };
                                          };
                                          $196.sceneState = nextScene;
                                          $196.nextBGM = new Data_Maybe.Just(v.res.value0.sounds.ichigo);
                                          return $196;
                                      }))(function () {
                                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Game_Cubbit_Aff.wait(Halogen_Query_HalogenM.monadAffHalogenM(Control_Monad_Aff_Class.monadAffAff))(1000))(function () {
                                              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Game_Cubbit_Hud_Start.modifyAppState(ref)(function (v1) {
                      ...
                      if (query.value0 instanceof Game_Cubbit_Hud_Type.Start) {
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(Control_Monad_Eff_Ref.readRef(ref)))(function (v1) {
                              return Game_Cubbit_Hud_Start.start(ref)(v1)(v.res.value0)(query.value0.value0);
                          });
                      };
                      if (query.value0 instanceof Game_Cubbit_Hud_Type.ToggleMute) {
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Game_Cubbit_Hud_Start.modifyAppState(ref)(function (v1) {
                              var $209 = {};
                              for (var $210 in v1) {
                                  if (v1.hasOwnProperty($210)) {
                                      $209[$210] = v1[$210];
                                  };
                              };
                              $209.config = (function () {
                                  var $206 = {};
                                  for (var $207 in v1.config) {
                                      if (v1.config.hasOwnProperty($207)) {
                                          $206[$207] = v1.config[$207];
                                      };
                                  };
                                  $206.mute = !v1.config.mute;
                                  return $206;
                              })();
                              return $209;
                          }))(function () {
                      ...
                      if (query.value0 instanceof Game_Cubbit_Hud_Type.PlayingSceneQuery) {
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(Control_Monad_Eff_Ref.readRef(ref)))(function (v1) {
                              ...
                              if (v1.sceneState instanceof Game_Cubbit_Types.ModeSelectionSceneState) {
                                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit);
                              };
                              if (v1.sceneState instanceof Game_Cubbit_Types.PlayingSceneState) {
                                  if (query.value0.value0 instanceof Game_Cubbit_Hud_Type.SetCursorPosition) {
                                      return Control_Applicative.when(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Eq.notEq(Game_Cubbit_BlockIndex.eq_BlockIndex)(query.value0.value0.value0)(v1.sceneState.value0.cursorPosition))(Game_Cubbit_Hud_Start.modifyAppState(ref)(function (v2) {
                                          var $224 = {};
                                          for (var $225 in v2) {
                                              if (v2.hasOwnProperty($225)) {
                                                  $224[$225] = v2[$225];
                                              };
                                          };
                                          $224.sceneState = new Game_Cubbit_Types.PlayingSceneState((function () {
                                              var $221 = {};
                                              for (var $222 in v1.sceneState.value0) {
                                                  if (v1.sceneState.value0.hasOwnProperty($222)) {
                                                      $221[$222] = v1.sceneState.value0[$222];
                                                  };
                                              };
                                              $221.cursorPosition = query.value0.value0.value0;
                                              return $221;
                                          })());
                                          return $224;
                                      }));
                                  ...
                                  if (query.value0.value0 instanceof Game_Cubbit_Hud_Type.SetMode) {
                                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(Control_Applicative.when(Control_Monad_Eff.applicativeEff)(Data_Eq.notEq(Game_Cubbit_Types.eqMode)(v1.sceneState.value0.mode)(query.value0.value0.value0))(Graphics_Babylon_Sound.play(v.res.value0.sounds.switchSound))))(function () {
                                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Game_Cubbit_Hud_Start.modifyAppState(ref)(function (v2) {
                                              var $232 = {};
                                              for (var $233 in v2) {
                                                  if (v2.hasOwnProperty($233)) {
                                                      $232[$233] = v2[$233];
                                                  };
                                              };
                                              $232.sceneState = new Game_Cubbit_Types.PlayingSceneState((function () {
                                                  var $229 = {};
                                                  for (var $230 in v1.sceneState.value0) {
                                                      if (v1.sceneState.value0.hasOwnProperty($230)) {
                                                          $229[$230] = v1.sceneState.value0[$230];
                                                      };
                                                  };
                                                  $229.mode = query.value0.value0.value0;
                                                  return $229;
                                              })());
                                              return $232;
                                          }))(function () {
                                  ...
                                  if (query.value0.value0 instanceof Game_Cubbit_Hud_Type.SetPosition) {
                                      return Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(Control_Monad_Eff_Ref.modifyRef(ref)(function (v2) {
                                          var $240 = {};
                                          for (var $241 in v2) {
                                              if (v2.hasOwnProperty($241)) {
                                                  $240[$241] = v2[$241];
                                              };
                                          };
                                          $240.sceneState = new Game_Cubbit_Types.PlayingSceneState((function () {
                                              var $237 = {};
                                              for (var $238 in v1.sceneState.value0) {
                                                  if (v1.sceneState.value0.hasOwnProperty($238)) {
                                                      $237[$238] = v1.sceneState.value0[$238];
                                                  };
                                              };
                                              $237.position = query.value0.value0.value0;
                                              return $237;
                                          })());
                                          return $240;
                                      }));
                                  ...
                                  if (query.value0.value0 instanceof Game_Cubbit_Hud_Type.TogglePointerLock) {
                                      return Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))((function () {
                                          var firstPersonView = !v1.sceneState.value0.firstPersonView;
                                          return function __do() {
                                              Control_Monad_Eff_Ref.modifyRef(ref)(function (v2) {
                                                  var $248 = {};
                                                  for (var $249 in v2) {
                                                      if (v2.hasOwnProperty($249)) {
                                                          $248[$249] = v2[$249];
                                                      };
                                                  };
                                                  $248.sceneState = new Game_Cubbit_Types.PlayingSceneState((function () {
                                                      var $245 = {};
                                                      for (var $246 in v1.sceneState.value0) {
                                                          if (v1.sceneState.value0.hasOwnProperty($246)) {
                                                              $245[$246] = v1.sceneState.value0[$246];
                                                          };
                                                      };
                                                      $245.firstPersonView = firstPersonView;
                                                      return $245;
                                                  })());
                                                  return $248;
                                              })();
                                                  ...
                                                  return Game_Cubbit_PointerLock.requestPointerLock(function (e) {
                                                      return function __do() {
                                                          Control_Monad_Eff_Ref.modifyRef(ref)(function (v2) {
                                                              var $260 = {};
                                                              for (var $261 in v2) {
                                                                  if (v2.hasOwnProperty($261)) {
                                                                      $260[$261] = v2[$261];
                                                                  };
                                                              };
                                                              $260.sceneState = (function () {
                                                                  if (v2.sceneState instanceof Game_Cubbit_Types.TitleSceneState) {
                                                                      return new Game_Cubbit_Types.TitleSceneState(v2.sceneState.value0);
                                                                  };
                                                                  if (v2.sceneState instanceof Game_Cubbit_Types.ModeSelectionSceneState) {
                                                                      return new Game_Cubbit_Types.ModeSelectionSceneState(v2.sceneState.value0);
                                                                  };
                                                                  if (v2.sceneState instanceof Game_Cubbit_Types.PlayingSceneState) {
                                                                      return new Game_Cubbit_Types.PlayingSceneState((function () {
                                                                          var $256 = {};
                                                                          for (var $257 in v2.sceneState.value0) {
                                                                              if (v2.sceneState.value0.hasOwnProperty($257)) {
                                                                                  $256[$257] = v2.sceneState.value0[$257];
                                                                              };
                                                                          };
                                                                          $256.playerRotation = v2.sceneState.value0.playerRotation + e.movementX * v.res.value0.options.pointerHorizontalSensitivity;
                                                                          $256.playerPitch = Data_Ord.max(Data_Ord.ordNumber)(-$$Math.pi * 0.45)(Data_Ord.min(Data_Ord.ordNumber)($$Math.pi * 0.45)(v2.sceneState.value0.playerPitch) - e.movementY * v.res.value0.options.pointerVerticalSensitivity);
                                                                          return $256;
                                                                      })());
                                                                  };
                                                                  throw new Error("Failed pattern match at Game.Cubbit.Hud.Eval line 307, column 66 - line 313, column 58: " + [ v2.sceneState.constructor.name ]);
                                                              })();
                                                              return $260;
                                                          })();
                                                          return Data_Unit.unit;
                                                      ...
                                                      var $271 = {};
                                                      for (var $272 in v2) {
                                                          if (v2.hasOwnProperty($272)) {
                                                              $271[$272] = v2[$272];
                                                          };
                                                      };
                                                      $271.sceneState = (function () {
                                                          if (v2.sceneState instanceof Game_Cubbit_Types.TitleSceneState) {
                                                              return new Game_Cubbit_Types.TitleSceneState(v2.sceneState.value0);
                                                          };
                                                          if (v2.sceneState instanceof Game_Cubbit_Types.ModeSelectionSceneState) {
                                                          ...
                                                          if (v2.sceneState instanceof Game_Cubbit_Types.PlayingSceneState) {
                                                              return new Game_Cubbit_Types.PlayingSceneState((function () {
                                                                  var $267 = {};
                                                                  for (var $268 in v2.sceneState.value0) {
                                                                      if (v2.sceneState.value0.hasOwnProperty($268)) {
                                                                          $267[$268] = v2.sceneState.value0[$268];
                                                                      };
                                                                  };
                                                                  $267.firstPersonView = false;
                                                                  return $267;
                                                              })());
                                                          };
                                                          throw new Error("Failed pattern match at Game.Cubbit.Hud.Eval line 317, column 62 - line 322, column 54: " + [ v2.sceneState.constructor.name ]);
                                                      })();
                                                      return $271;
                                                  }))();
                                              };
                                              ...
                                              throw new Error("Failed pattern match at Game.Cubbit.Hud.Eval line 304, column 41 - line 324, column 65: " + [ firstPersonView.constructor.name ]);
                                          };
                                      })());
                                  };
                                  if (query.value0.value0 instanceof Game_Cubbit_Hud_Type.SetMousePosition) {
                                      return Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(Control_Monad_Eff_Ref.modifyRef(ref)(function (v2) {
                                          ...
                                          var dy = offsetY(query.value0.value0.value0) - v2.mousePosition.y;
                                          var dx = offsetX(query.value0.value0.value0) - v2.mousePosition.x;
                                          var $280 = {};
                                          for (var $281 in v2) {
                                              if (v2.hasOwnProperty($281)) {
                                                  $280[$281] = v2[$281];
                                              };
                                          };
                                          $280.mousePosition = {
                                          ...
                                          $280.sceneState = new Game_Cubbit_Types.PlayingSceneState((function () {
                                              var $277 = {};
                                              for (var $278 in v1.sceneState.value0) {
                                                  if (v1.sceneState.value0.hasOwnProperty($278)) {
                                                      $277[$278] = v1.sceneState.value0[$278];
                                                  };
                                              };
                                              $277.cameraYaw = (function () {
                                                  if (isRightButton) {
                                                      return v1.sceneState.value0.cameraYaw + Data_Int.toNumber(dx) * v.res.value0.options.cameraHorizontalSensitivity;
                                                  };
                                                  if (!isRightButton) {
                                                      return v1.sceneState.value0.cameraYaw;
                                                  };
                                                  throw new Error("Failed pattern match at Game.Cubbit.Hud.Eval line 337, column 73 - line 337, column 207: " + [ isRightButton.constructor.name ]);
                                              })();
                                              $277.cameraPitch = (function () {
                                                  if (isRightButton) {
                                                      return Data_Ord.max(Data_Ord.ordNumber)(-$$Math.pi * 0.45)(Data_Ord.min(Data_Ord.ordNumber)($$Math.pi * 0.45)(v1.sceneState.value0.cameraPitch + Data_Int.toNumber(dy) * v.res.value0.options.cameraVertialSensitivity));
                                                  };
                                                  if (!isRightButton) {
                                                      return v1.sceneState.value0.cameraPitch;
                                                  };
                                                  throw new Error("Failed pattern match at Game.Cubbit.Hud.Eval line 338, column 75 - line 338, column 247: " + [ isRightButton.constructor.name ]);
                                              })();
                                              return $277;
                                          })());
                                          return $280;
                                      ...
                                      return Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(function __do() {
                                          ...
                                          return Control_Applicative.when(Control_Monad_Eff.applicativeEff)(DOM_Event_MouseEvent.buttons(query.value0.value0.value0) === 1)((function () {
                                              var put = function (block) {
                                                  return function __do() {
                                                      var v3 = Game_Cubbit_Control.pickBlock(v.res.value0.scene)(v.res.value0.cursor)(v1.sceneState.value0.mode)(v2.terrain)(v2.mousePosition.x)(v2.mousePosition.y)();
                                                      if (v3 instanceof Data_Maybe.Nothing) {
                                                          return Data_Unit.unit;
                                                      };
                                                      if (v3 instanceof Data_Maybe.Just) {
                                                          Game_Cubbit_MeshBuilder.editBlock(ref)(v3.value0)(block)();
                                                          var v4 = Game_Cubbit_Collesion.updateChunkCollesion(v2.terrain)(v2.world)(Game_Cubbit_Terrain.globalIndexToChunkIndex(v3.value0))();
                                                          return Control_Monad_Eff_Ref.modifyRef(ref)(function (v5) {
                                                              var $293 = {};
                                                              for (var $294 in v5) {
                                                                  if (v5.hasOwnProperty($294)) {
                                                                      $293[$294] = v5[$294];
                                                                  };
                                                              };
                                                              $293.terrain = v4;
                                                      ...
                                                      throw new Error("Failed pattern match at Game.Cubbit.Hud.Eval line 358, column 49 - line 365, column 58: " + [ v3.constructor.name ]);
                                                  };
                                              };
                                              if (v1.sceneState.value0.mode instanceof Game_Cubbit_Types.Put) {
                                                  return function __do() {
                                                      put(v1.sceneState.value0.mode.value0)();
                                                      return Graphics_Babylon_Sound.play(v.res.value0.sounds.putSound)();
                                                  };
                                              };
                                              if (v1.sceneState.value0.mode instanceof Game_Cubbit_Types.Remove) {
                                                  return function __do() {
                                                      put(Game_Cubbit_BlockType.airBlock)();
                                                      return Graphics_Babylon_Sound.play(v.res.value0.sounds.pickSound)();
                                                  };
                                              };
                                              if (v1.sceneState.value0.mode instanceof Game_Cubbit_Types.Move) {
                                                  return Control_Applicative.pure(Control_Monad_Eff.applicativeEff)(Data_Unit.unit);
                                              };
                                              throw new Error("Failed pattern match at Game.Cubbit.Hud.Eval line 367, column 41 - line 374, column 62: " + [ v1.sceneState.value0.mode.constructor.name ]);
                                          })())();
                                      });
                                  };
                                  if (query.value0.value0 instanceof Game_Cubbit_Hud_Type.Zoom) {
                                      return Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(function __do() {
                                          Control_Monad_Eff_Ref.modifyRef(ref)(function (v2) {
                                              var $304 = {};
                                              for (var $305 in v2) {
                                                  if (v2.hasOwnProperty($305)) {
                                                      $304[$305] = v2[$305];
                                                  };
                                              };
                                              $304.sceneState = new Game_Cubbit_Types.PlayingSceneState((function () {
                                                  var $301 = {};
                                                  for (var $302 in v1.sceneState.value0) {
                                                      if (v1.sceneState.value0.hasOwnProperty($302)) {
                                                          $301[$302] = v1.sceneState.value0[$302];
                                                      };
                                                  };
                                                  $301.cameraRange = Data_Ord.max(Data_Ord.ordNumber)(v.res.value0.options.cameraMinimumRange)(Data_Ord.min(Data_Ord.ordNumber)(v.res.value0.options.cameraMaximumRange)(v1.sceneState.value0.cameraRange + Data_Int.toNumber(deltaY(query.value0.value0.value0)) * v.res.value0.options.cameraZoomSpeed));
                                                  return $301;
                                              })());
                                              return $304;
                                          })();
                                  ...
                                  if (query.value0.value0 instanceof Game_Cubbit_Hud_Type.OnKeyDown) {
                                      return Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(function __do() {
                                          Control_Monad_Eff_Ref.modifyRef(ref)(function (v2) {
                                              var $309 = {};
                                              for (var $310 in v2) {
                                                  if (v2.hasOwnProperty($310)) {
                                                      $309[$310] = v2[$310];
                                                  };
                                              };
                                              $309.keys = Data_Set.insert(Data_Ord.ordString)(DOM_Event_KeyboardEvent.key(query.value0.value0.value0))(v2.keys);
                                              return $309;
                                          })();
                                          (function () {
                                              var $312 = DOM_Event_KeyboardEvent.key(query.value0.value0.value0);
                                              if ($312 === "1") {
                                                  return function __do() {
                                                      Control_Monad_Eff_Ref.modifyRef(ref)(function (v2) {
                                                          var $314 = {};
                                                          for (var $315 in v2) {
                                                              if (v2.hasOwnProperty($315)) {
                                                                  $314[$315] = v2[$315];
                                                              };
                                                          };
                                                          $314.debugLayer = !v2.debugLayer;
                                                          return $314;
                                                      })();
                                                      var v2 = Control_Monad_Eff_Ref.readRef(ref)();
                                                      if (v2.debugLayer) {
                                                      ...
                                                      throw new Error("Failed pattern match at Game.Cubbit.Hud.Eval line 393, column 45 - line 395, column 97: " + [ v2.debugLayer.constructor.name ]);
                                                  };
                                              };
                                              if ($312 === "2") {
                                  ...
                                  if (query.value0.value0 instanceof Game_Cubbit_Hud_Type.OnKeyUp) {
                                      return Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(function __do() {
                                          Control_Monad_Eff_Ref.modifyRef(ref)(function (v2) {
                                              var $321 = {};
                                              for (var $322 in v2) {
                                                  if (v2.hasOwnProperty($322)) {
                                                      $321[$322] = v2[$322];
                                                  };
                                              };
                                              $321.keys = Data_Set["delete"](Data_Ord.ordString)(DOM_Event_KeyboardEvent.key(query.value0.value0.value0))(v2.keys);
                                              return $321;
                                          })();
                                          DOM_Event_Event.preventDefault(DOM_Event_Types.keyboardEventToEvent(query.value0.value0.value0))();
                                          return DOM_Event_Event.stopPropagation(DOM_Event_Types.keyboardEventToEvent(query.value0.value0.value0))();
                                  ...
                                  if (query.value0.value0 instanceof Game_Cubbit_Hud_Type.SetCenterPanelVisible) {
                                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Game_Cubbit_Hud_Start.modifyAppState(ref)(function (v2) {
                                          var $329 = {};
                                          for (var $330 in v2) {
                                              if (v2.hasOwnProperty($330)) {
                                                  $329[$330] = v2[$330];
                                              };
                                          };
                                          $329.sceneState = new Game_Cubbit_Types.PlayingSceneState((function () {
                                              var $326 = {};
                                              for (var $327 in v1.sceneState.value0) {
                                                  if (v1.sceneState.value0.hasOwnProperty($327)) {
                                                      $326[$327] = v1.sceneState.value0[$327];
                                                  };
                                              };
                                              $326.centerPanelVisible = query.value0.value0.value0;
                                              return $326;
                                          })());
                                          return $329;
                                      }))(function () {
                                  ...
                                  throw new Error("Failed pattern match at Game.Cubbit.Hud.Eval line 263, column 29 - line 411, column 46: " + [ query.value0.value0.constructor.name ]);
                              };
                              throw new Error("Failed pattern match at Game.Cubbit.Hud.Eval line 255, column 21 - line 411, column 46: " + [ v1.sceneState.constructor.name ]);
                          });
                      };
                      throw new Error("Failed pattern match at Game.Cubbit.Hud.Eval line 64, column 37 - line 411, column 46: " + [ query.value0.constructor.name ]);
                  })());
              };
              throw new Error("Failed pattern match at Game.Cubbit.Hud.Eval line 50, column 5 - line 411, column 46: " + [ v.res.constructor.name ]);
          });
      };
  };
  exports["eval"] = $$eval;
...
(function(exports) {
  ...
  var onWheel = function ($27) {
      return Halogen_HTML_Events.handler("wheel")(Unsafe_Coerce.unsafeCoerce($27));
  };                                            
  ...
  var render = function (v) {
          ...
          return function (action) {
              return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("config-slider") ])(Data_Functor.mapFlipped(Data_Functor.functorArray)(Data_Array.range(0)(Game_Cubbit_Constants.sliderMaxValue))(function (i) {
                  return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("config-slider-box " + (function () {
                      ...
                      throw new Error("Failed pattern match at Game.Cubbit.Hud.Render line 212, column 64 - line 212, column 102: " + [ $6.constructor.name ]);
      ...
      var toggle = function (value) {
          return function (act) {
              return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("config-toggle " + (function () {
                  ...
                  throw new Error("Failed pattern match at Game.Cubbit.Hud.Render line 218, column 56 - line 218, column 85: " + [ value.constructor.name ]);
              })()), Halogen_HTML_Events.onClick(function (e) {
                  ...
                  throw new Error("Failed pattern match at Game.Cubbit.Hud.Render line 220, column 22 - line 220, column 47: " + [ value.constructor.name ]);
              })()) ]);
          };
      };
      var languageButton = function (lang) {
          return function (caption) {
              return Halogen_HTML_Elements.button([ Halogen_HTML_Properties.class_(Halogen_HTML_Core.ClassName("config-language" + (function () {
                  ...
                  throw new Error("Failed pattern match at Game.Cubbit.Hud.Render line 194, column 59 - line 194, column 108: " + [ $9.constructor.name ]);
              })())), Halogen_HTML_Events.onClick(function (v1) {
                  return send$prime(new Game_Cubbit_Hud_Type.SetLanguage(lang));
      ...
      var hotbuttons = function (playingSceneState) {
          var tool = function (v1) {
              ...
              throw new Error("Failed pattern match at Game.Cubbit.Hud.Render line 244, column 17 - line 247, column 42: " + [ v1.constructor.name ]);
          };
          var slot = function (v1) {
              ...
              throw new Error("Failed pattern match at Game.Cubbit.Hud.Render line 41, column 1 - line 248, column 56: " + [ v1.constructor.name ]);
          };
      ...
      if (v.res instanceof Game_Cubbit_Types.Loading) {
          return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.id_("content"), Halogen_HTML_Properties.key("root-content"), Halogen_HTML_Properties.class_("content-layer") ])([ Halogen_HTML_Elements.img([ Halogen_HTML_Properties.class_("content-layer"), Halogen_HTML_Properties.src("image/loading.png") ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("progress") ])(Data_Functor.mapFlipped(Data_Functor.functorArray)(Data_Array.range(0)(Game_Cubbit_Resources.resourceCount))(function (i) {
              return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("cell" + (function () {
                  ...
                  throw new Error("Failed pattern match at Game.Cubbit.Hud.Render line 49, column 51 - line 49, column 88: " + [ $16.constructor.name ]);
              })()) ])([  ]);
          })) ]);
      };
      if (v.res instanceof Game_Cubbit_Types.Complete) {
          return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.id_("content"), Halogen_HTML_Properties.key("root-content"), Halogen_HTML_Properties.class_("content-layer"), Halogen_HTML_Events.onContextMenu(function (e) {
              ...
              if (v.sceneState instanceof Game_Cubbit_Types.TitleSceneState) {
                  return [ Halogen_HTML_Elements.img([ Halogen_HTML_Properties.class_("content-layer"), Halogen_HTML_Properties.src("image/title.png"), Halogen_HTML_Properties.key("image/title.png"), Halogen_HTML_Events.onClick(function (e) {
                      return send$prime(Game_Cubbit_Hud_Type.ModeSelect.value);
              ...
              if (v.sceneState instanceof Game_Cubbit_Types.ModeSelectionSceneState) {
                  return [ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("content-layer mode-root") ])([ Halogen_HTML_Elements.h1([  ])([ icon("tree"), mtext(Game_Cubbit_Captions.modeSelection) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("home button"), Halogen_HTML_Events.onClick(function (e) {
                      return send$prime(Game_Cubbit_Hud_Type.Home.value);
                      ...
                      return send$prime(new Game_Cubbit_Hud_Type.Start(Game_Cubbit_Types.SinglePlayerMode.value));
                      ...
                      return send$prime(new Game_Cubbit_Hud_Type.Start(Game_Cubbit_Types.MultiplayerMode.value));
              ...
              if (v.sceneState instanceof Game_Cubbit_Types.PlayingSceneState) {
                  ...
                  return [ Halogen_HTML_Elements.img([ Halogen_HTML_Properties.key("image/screenshade.png"), Halogen_HTML_Properties.id_("screen-shade"), Halogen_HTML_Properties.class_("content-layer"), Halogen_HTML_Properties.src("image/screenshade.png") ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.id_("cursor-position") ])([ Halogen_HTML.text("cursor: (" + (Data_Show.show(Data_Show.showInt)(index.x) + (", " + (Data_Show.show(Data_Show.showInt)(index.y) + (", " + (Data_Show.show(Data_Show.showInt)(index.z) + ")")))))) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.id_("life") ])(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Array.replicate(v.sceneState.value0.life)(Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("active") ])([ icon("heart") ])))(Data_Array.replicate(v.sceneState.value0.maxLife - v.sceneState.value0.life)(icon("heart")))), Halogen_HTML_Elements.p([ Halogen_HTML_Properties.id_("message-box-top") ])([  ]), Halogen_HTML_Elements.p([ Halogen_HTML_Properties.id_("message-box") ])([ Halogen_HTML.text("Cubbit\xd7Cubbit Playable Demo") ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.id_("right-panel"), suppressMouseMove, suppressMouseDown ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("button"), Halogen_HTML_Events.onClick(function (e) {
                      ...
                      throw new Error("Failed pattern match at Game.Cubbit.Hud.Render line 120, column 21 - line 127, column 37: " + [ v.sceneState.value0.centerPanelVisible.constructor.name ]);
              ...
              throw new Error("Failed pattern match at Game.Cubbit.Hud.Render line 65, column 50 - line 140, column 18: " + [ v.sceneState.constructor.name ]);
          })()), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.key("config-root"), Halogen_HTML_Properties.class_("content-layer config-root" + (function () {
              if (v.configVisible) {
                  return " visible";
              };
              if (!v.configVisible) {
              ...
              return send$prime(new Game_Cubbit_Hud_Type.Nop(DOM_Event_Types.mouseEventToEvent(e)));
          }) ])([ Halogen_HTML_Elements.h2([ Halogen_HTML_Properties.class_("config-heading") ])([ icon("language"), mtext(Game_Cubbit_Captions.language) ]), languageButton(Game_Cubbit_Captions.En.value)("English"), languageButton(Game_Cubbit_Captions.Ja.value)("\u65e5\u672c\u8a9e"), Halogen_HTML_Elements.h2([ Halogen_HTML_Properties.class_("config-heading") ])([ icon("volume-up"), mtext(Game_Cubbit_Captions.sounds) ]), option(Game_Cubbit_Captions.mute)(toggle(v.config.mute)(Game_Cubbit_Hud_Type.ToggleMute.value)), option(Game_Cubbit_Captions.bgmVolume)(slider(v.config.bgmVolume)(Game_Cubbit_Hud_Type.SetBGMVolume.create)), option(Game_Cubbit_Captions.seVolume)(slider(v.config.seVolume)(Game_Cubbit_Hud_Type.SetSEVolume.create)), Halogen_HTML_Elements.h2([ Halogen_HTML_Properties.class_("config-heading") ])([ icon("photo"), mtext(Game_Cubbit_Captions.graphics) ]), option(Game_Cubbit_Captions.shadow)(toggle(v.config.shadow)(Game_Cubbit_Hud_Type.ToggleShadow.value)), option(Game_Cubbit_Captions.shadowArea)(slider(v.config.shadowArea)(Game_Cubbit_Hud_Type.SetShadowArea.create)), option(Game_Cubbit_Captions.vertexColor)(toggle(v.config.vertexColor)(Game_Cubbit_Hud_Type.ToggleVertexColor.value)), option(Game_Cubbit_Captions.waterMaterial)(toggle(v.config.waterMaterial)(Game_Cubbit_Hud_Type.ToggleWaterMaterial.value)), Halogen_HTML_Elements.h2([ Halogen_HTML_Properties.class_("config-heading") ])([ icon("cubes"), mtext(Game_Cubbit_Captions.terrain) ]), option(Game_Cubbit_Captions.chunkArea)(slider(v.config.chunkArea)(Game_Cubbit_Hud_Type.SetChunkArea.create)), Halogen_HTML_Elements.p_([ Halogen_HTML_Elements.a([ Halogen_HTML_Properties.target("_blank"), Halogen_HTML_Properties.href("LICENSE.txt"), Halogen_HTML_Events.onClick(function (e) {
      ...
      throw new Error("Failed pattern match at Game.Cubbit.Hud.Render line 41, column 50 - line 184, column 10: " + [ v.res.constructor.name ]);
  };
  ...
  var updateSound = function (sounds) {
      return function (v) {
          var sliderValueToNumber = function (n) {
              ...
              throw new Error("Failed pattern match at Game.Cubbit.Update line 457, column 33 - line 457, column 106: " + [ v.config.mute.constructor.name ]);
          };
          return function __do() {
              ...
              return function __do() {
                  ...
                  var v6 = (function () {
                      if (v5 instanceof Data_Maybe.Just && Game_Cubbit_Terrain.isSolidBlock(v5.value0)) {
                          return function __do() {
                              ...
                              var $68 = Graphics_Babylon_PickingInfo.getPickedPoint(v9);
                              ...
                              throw new Error("Failed pattern match at Game.Cubbit.Update line 357, column 22 - line 359, column 44: " + [ $68.constructor.name ]);
                          };
                      };
                  ...
                  var v8 = (function () {
                      ...
                      var loadAndGenerateChunk = function (index) {
                          return Game_Cubbit_MeshBuilder.generateChunk(v1)(v.materials)(v.scene)(index)(v.options)(v1.config);
                      };
                      ...
                      return function __do() {
                              ...
                              return function (y) {
                                  return function (z) {
                                      ...
                                      return function __do() {
                                          ...
                                          throw new Error("Failed pattern match at Game.Cubbit.Update line 382, column 17 - line 396, column 13: " + [ v8.constructor.name ]);
                                      };
                                  };
                              };
                          })();
                          var $78 = {};
                          for (var $79 in v1) {
                              if (v1.hasOwnProperty($79)) {
                                  $78[$79] = v1[$79];
                              };
                          };
                          $78.updateIndex = Data_Nullable.toNullable(new Data_Maybe.Just(v8));
                          return $78;
                      };
                  })()();
                  (function () {
                  ...
                  var v9 = (function () {
                      var $84 = v1.config.shadow || v1.config.waterMaterial;
                      if ($84) {
                      ...
                      throw new Error("Failed pattern match at Game.Cubbit.Update line 419, column 26 - line 429, column 29: " + [ $84.constructor.name ]);
                  })()();
                  Graphics_Babylon_ShadowGenerator.setRenderList((function () {
                      ...
                      throw new Error("Failed pattern match at Game.Cubbit.Update line 431, column 24 - line 431, column 87: " + [ v1.config.shadow.constructor.name ]);
                  })())(v.shadowMap)();
                  (function () {
                      ...
                      throw new Error("Failed pattern match at Game.Cubbit.Update line 433, column 9 - line 445, column 26: " + [ v1.config.waterMaterial.constructor.name ]);
                  })()();
                  return v8;
              };
          };
              ...
              return function (playingSceneState) {
                  return Control_Monad_Eff.runPure((function () {
                      var rot = -(function () {
                          ...
                          throw new Error("Failed pattern match at Game.Cubbit.Update line 70, column 23 - line 70, column 138: " + [ playingSceneState.firstPersonView.constructor.name ]);
                      })();
                      var keyStep = function (key) {
                          var $98 = Data_Set.member(Data_Ord.ordString)(key)(v1.keys);
                          if ($98) {
                              return 1.0;
                          };
                          if (!$98) {
                          ...
                          throw new Error("Failed pattern match at Game.Cubbit.Update line 72, column 23 - line 74, column 5: " + [ $98.constructor.name ]);
                      };
                      var keyVector = {
                      ...
                      return function __do() {
                          ...
                          var isStartingJump = playingSceneState.jumpable && (isLanding && (Data_Set.member(Data_Ord.ordString)(" ")(v1.keys) && playingSceneState.landing === 0));
                          var jumpVelocity = (function () {
                              ...
                              throw new Error("Failed pattern match at Game.Cubbit.Update line 94, column 24 - line 96, column 5: " + [ isStartingJump.constructor.name ]);
                          })();
                          var moveFactor = (function () {
                              ...
                              throw new Error("Failed pattern match at Game.Cubbit.Update line 98, column 22 - line 101, column 5: " + [ isLanding.constructor.name ]);
                          })();
                          var gravityAccelerator = (function () {
                              ...
                              throw new Error("Failed pattern match at Game.Cubbit.Update line 101, column 30 - line 101, column 84: " + [ isLanding.constructor.name ]);
                          })();
                          var moveVectorLength = $$Math.sqrt(rotatedKeyVector.x * rotatedKeyVector.x + rotatedKeyVector.z * rotatedKeyVector.z);
                          var velocity = (function () {
                              var $105 = 0.0 < moveVectorLength && playingSceneState.landing === 0;
                              if ($105) {
                                  return {
                              ...
                              throw new Error("Failed pattern match at Game.Cubbit.Update line 105, column 20 - line 115, column 14: " + [ $105.constructor.name ]);
                          })();
                          var playerRotation$prime = (function () {
                              if (isLanding) {
                                  var $107 = 0 < playingSceneState.landing;
                                  if ($107) {
                                      return playingSceneState.playerRotation;
                                  };
                                  if (!$107) {
                                      var $108 = stopped || playingSceneState.firstPersonView;
                                      if ($108) {
                                          return playingSceneState.playerRotation;
                                      };
                                      if (!$108) {
                                      ...
                                      throw new Error("Failed pattern match at Game.Cubbit.Update line 121, column 22 - line 123, column 60: " + [ $108.constructor.name ]);
                                  };
                                  throw new Error("Failed pattern match at Game.Cubbit.Update line 119, column 19 - line 123, column 60: " + [ $107.constructor.name ]);
                              };
                              if (!isLanding) {
                                  return playingSceneState.playerRotation;
                              };
                              throw new Error("Failed pattern match at Game.Cubbit.Update line 118, column 27 - line 124, column 52: " + [ isLanding.constructor.name ]);
                          })();
                          var playerPosition = {
                          ...
                          var animation$prime = (function () {
                              var $109 = 0 < playingSceneState.landing;
                              if ($109) {
                                  return "land";
                              };
                              if (!$109) {
                                  if (isLanding) {
                                      var $111 = Data_Foldable.any(Data_Foldable.foldableArray)(Data_HeytingAlgebra.heytingAlgebraBoolean)(function (k) {
                                      ...
                                      throw new Error("Failed pattern match at Game.Cubbit.Update line 137, column 23 - line 137, column 101: " + [ $111.constructor.name ]);
                                  };
                                  if (!isLanding) {
                                      return "jump";
                                  };
                                  throw new Error("Failed pattern match at Game.Cubbit.Update line 136, column 18 - line 140, column 5: " + [ isLanding.constructor.name ]);
                              };
                              throw new Error("Failed pattern match at Game.Cubbit.Update line 134, column 22 - line 140, column 5: " + [ $109.constructor.name ]);
                          })();
                          ...
                          var landingCount = (function () {
                              var $116 = isLanding$prime && playingSceneState.velocity.y < v.landingVelocityLimit;
                              if ($116) {
                              ...
                              throw new Error("Failed pattern match at Game.Cubbit.Update line 154, column 24 - line 156, column 43: " + [ $116.constructor.name ]);
                          })();
                          var cameraSpeed = (function () {
                              ...
                              throw new Error("Failed pattern match at Game.Cubbit.Update line 159, column 23 - line 159, column 99: " + [ playingSceneState.firstPersonView.constructor.name ]);
                          })();
                          ...
                          var cameraTargetX$prime = (function () {
                              ...
                              throw new Error("Failed pattern match at Game.Cubbit.Update line 174, column 26 - line 174, column 122: " + [ playingSceneState.firstPersonView.constructor.name ]);
                          })();
                          var cameraTargetY$prime = (function () {
                              ...
                              throw new Error("Failed pattern match at Game.Cubbit.Update line 175, column 26 - line 175, column 122: " + [ playingSceneState.firstPersonView.constructor.name ]);
                          })();
                          var cameraTargetZ$prime = (function () {
                              ...
                              throw new Error("Failed pattern match at Game.Cubbit.Update line 176, column 26 - line 176, column 122: " + [ playingSceneState.firstPersonView.constructor.name ]);
                          })();
                          ...
                          var cameraPositionX = (function () {
                              ...
                              throw new Error("Failed pattern match at Game.Cubbit.Update line 198, column 27 - line 198, column 127: " + [ playingSceneState.firstPersonView.constructor.name ]);
                          })();
                          var cameraPositionY = (function () {
                              ...
                              throw new Error("Failed pattern match at Game.Cubbit.Update line 199, column 27 - line 199, column 127: " + [ playingSceneState.firstPersonView.constructor.name ]);
                          })();
                          var cameraPositionZ = (function () {
                              ...
                              throw new Error("Failed pattern match at Game.Cubbit.Update line 200, column 27 - line 200, column 127: " + [ playingSceneState.firstPersonView.constructor.name ]);
                          })();
                          ...
                          var sceneState = (function () {
                              var $132 = {};
                              for (var $133 in playingSceneState) {
                                  if (playingSceneState.hasOwnProperty($133)) {
                                      $132[$133] = playingSceneState[$133];
                                  };
                              };
                              $132.cameraYaw = playingSceneState.cameraYaw + ((function () {
                                  var $124 = Data_Set.member(Data_Ord.ordString)("q")(v1.keys);
                                  if ($124) {
                                      return 1.0;
                                  };
                                  if (!$124) {
                                  ...
                                  throw new Error("Failed pattern match at Game.Cubbit.Update line 210, column 61 - line 210, column 103: " + [ $124.constructor.name ]);
                              })() - (function () {
                                  var $125 = Data_Set.member(Data_Ord.ordString)("e")(v1.keys);
                                  if ($125) {
                                      return 1.0;
                                  };
                                  if (!$125) {
                                  ...
                                  throw new Error("Failed pattern match at Game.Cubbit.Update line 210, column 108 - line 210, column 150: " + [ $125.constructor.name ]);
                              })()) * v.cameraRotationSpeed;
                              $132.cameraPitch = Data_Ord.max(Data_Ord.ordNumber)(0.1)(Data_Ord.min(Data_Ord.ordNumber)($$Math.pi * 0.48)(playingSceneState.cameraPitch + ((function () {
                                  var $126 = Data_Set.member(Data_Ord.ordString)("r")(v1.keys);
                                  if ($126) {
                                      return 1.0;
                                  };
                                  if (!$126) {
                                  ...
                                  throw new Error("Failed pattern match at Game.Cubbit.Update line 211, column 91 - line 211, column 133: " + [ $126.constructor.name ]);
                              })() - (function () {
                                  var $127 = Data_Set.member(Data_Ord.ordString)("f")(v1.keys);
                                  if ($127) {
                                      return 1.0;
                                  };
                                  if (!$127) {
                                  ...
                                  throw new Error("Failed pattern match at Game.Cubbit.Update line 211, column 138 - line 211, column 180: " + [ $127.constructor.name ]);
                              })()) * v.cameraRotationSpeed));
                              $132.cameraRange = Data_Ord.max(Data_Ord.ordNumber)(v.cameraMinimumRange)(Data_Ord.min(Data_Ord.ordNumber)(v.cameraMaximumRange)(playingSceneState.cameraRange + ((function () {
                                  var $128 = Data_Set.member(Data_Ord.ordString)("g")(v1.keys);
                                  if ($128) {
                                      return 1.0;
                                  };
                                  if (!$128) {
                                  ...
                                  throw new Error("Failed pattern match at Game.Cubbit.Update line 212, column 129 - line 212, column 171: " + [ $128.constructor.name ]);
                              })() - (function () {
                                  var $129 = Data_Set.member(Data_Ord.ordString)("t")(v1.keys);
                                  if ($129) {
                                      return 1.0;
                                  };
                                  if (!$129) {
                                  ...
                                  throw new Error("Failed pattern match at Game.Cubbit.Update line 212, column 176 - line 212, column 218: " + [ $129.constructor.name ]);
                              })()) * v.cameraZoomSpeed));
                              $132.velocity = velocity;
                              $132.playerRotation = playerRotation$prime;
                              $132.animation = animation$prime;
                              $132.landing = Data_Ord.max(Data_Ord.ordInt)(0)(landingCount - 1);
                              $132.jumpable = (function () {
                                  var $130 = isLanding && !Data_Set.member(Data_Ord.ordString)(" ")(v1.keys);
                                  if ($130) {
                                      return true;
                                  };
                                  if (!$130) {
                                      var $131 = Data_Set.member(Data_Ord.ordString)(" ")(v1.keys);
                                      if ($131) {
                                          return false;
                                      };
                                      if (!$131) {
                                      ...
                                      throw new Error("Failed pattern match at Game.Cubbit.Update line 217, column 87 - line 217, column 154: " + [ $131.constructor.name ]);
                                  };
                                  throw new Error("Failed pattern match at Game.Cubbit.Update line 217, column 28 - line 217, column 154: " + [ $130.constructor.name ]);
                              })();
                              return $132;
                          })();
                          var state$prime = (function () {
                              var $135 = {};
                              for (var $136 in v1) {
                                  if (v1.hasOwnProperty($136)) {
                                      $135[$136] = v1[$136];
                                  };
                              };
                              $135.sceneState = new Game_Cubbit_Types.PlayingSceneState(sceneState);
                              ...
                              $135.totalFrames = v1.totalFrames + 1 | 0;
                              $135.skyboxRotation = v1.skyboxRotation + v.skyboxRotationSpeed * deltaTime;
                              return $135;
                          })();
              ...
              return function (v1) {
                  if (v1.sceneState instanceof Game_Cubbit_Types.TitleSceneState) {
                      var state$prime = (function () {
                          ...
                          $147.sceneState = new Game_Cubbit_Types.TitleSceneState((function () {
                              var $144 = {};
                              for (var $145 in v1.sceneState.value0) {
                                  if (v1.sceneState.value0.hasOwnProperty($145)) {
                                      $144[$145] = v1.sceneState.value0[$145];
                                  };
                              };
                              $144.position = v1.sceneState.value0.position + deltaTime * 8.0e-4;
                              return $144;
                          })());
                          return $147;
                      })();
                  ...
                  if (v1.sceneState instanceof Game_Cubbit_Types.PlayingSceneState) {
                      return function __do() {
                          var v2 = calcurateNextState(v.options)(deltaTime)(v1)(v1.sceneState.value0);
                          Control_Applicative.when(Control_Monad_Eff.applicativeEff)(v2.value1.animation !== v1.sceneState.value0.animation)(Game_Cubbit_Control.playAnimation(v2.value1.animation)(v.playerMeshes))();
                          var v3 = Graphics_Babylon_Vector3.createVector3(0.0)(v2.value1.playerRotation)(0.0)();
                          var v4 = Graphics_Babylon_Vector3.createVector3(v2.value1.position.x)(v2.value1.position.y)(v2.value1.position.z)();
                          Data_Foldable.for_(Control_Monad_Eff.applicativeEff)(Data_Foldable.foldableArray)(v.playerMeshes)(function (mesh) {
                              return Data_Functor["void"](Control_Monad_Eff.functorEff)(function __do() {
                                  Graphics_Babylon_AbstractMesh.setPosition(v4)(mesh)();
                                  Graphics_Babylon_AbstractMesh.setRotation(v3)(mesh)();
                                  return Graphics_Babylon_AbstractMesh.setVisibility((function () {
                                      ...
                                      throw new Error("Failed pattern match at Game.Cubbit.Update line 269, column 36 - line 269, column 90: " + [ v1.sceneState.value0.firstPersonView.constructor.name ]);
                                  })())(mesh)();
                              });
                          })();
                          (function () {
                              if (v2.value1.mode instanceof Game_Cubbit_Types.Move) {
                                  return Control_Applicative.pure(Control_Monad_Eff.applicativeEff)(Data_Unit.unit);
                              };
                              return function __do() {
                                  var v5 = Data_Functor.map(Control_Monad_Eff.functorEff)(Data_Nullable.toMaybe)(Control_Bind.bind(Control_Monad_Eff.bindEff)(Data_Functor.map(Control_Monad_Eff.functorEff)(DOM_HTML_Types.htmlDocumentToNonElementParentNode)(Control_Bind.bind(Control_Monad_Eff.bindEff)(DOM_HTML.window)(DOM_HTML_Window.document)))(DOM_Node_NonElementParentNode.getElementById("renderCanvas")))();
                                  var v6 = (function () {
                                      if (v5 instanceof Data_Maybe.Nothing) {
                                          return function __do() {
                                      ...
                                      if (v5 instanceof Data_Maybe.Just) {
                                          return function __do() {
                                              var v6 = DOM_HTML_HTMLElement.getBoundingClientRect(Unsafe_Coerce.unsafeCoerce(v5.value0))();
                                              return {
                                                  x: Data_Int.floor(v6.width * 0.5), 
                                                  y: Data_Int.floor(v6.height * 0.5)
                                              };
                                          };
                                      };
                                      throw new Error("Failed pattern match at Game.Cubbit.Update line 279, column 45 - line 288, column 38: " + [ v5.constructor.name ]);
                                  })()();
                                  var playerPositionIndex = Game_Cubbit_Terrain.globalPositionToGlobalIndex(v2.value1.position.x)(v2.value1.position.y)(v2.value1.position.z);
                                  var v7 = (function () {
                                      if (v2.value1.firstPersonView) {
                                          return Game_Cubbit_Control.pickBlock(v.scene)(v.cursor)(v2.value1.mode)(v1.terrain)(v6.x)(v6.y);
                                      };
                                      if (!v2.value1.firstPersonView) {
                                          return Game_Cubbit_Control.pickBlock(v.scene)(v.cursor)(v2.value1.mode)(v1.terrain)(v1.mousePosition.x)(v1.mousePosition.y);
                                      };
                                      throw new Error("Failed pattern match at Game.Cubbit.Update line 292, column 44 - line 294, column 150: " + [ v2.value1.firstPersonView.constructor.name ]);
                                  })()();
                                  if (v7 instanceof Data_Maybe.Nothing) {
                                      return Data_Unit.unit;
                                  };
                                  if (v7 instanceof Data_Maybe.Just) {
                                      return Data_Functor["void"](Control_Monad_Eff.functorEff)(Control_Applicative.when(Control_Monad_Eff.applicativeEff)(Game_Cubbit_BlockIndex.blockIndexDistance(playerPositionIndex)(v7.value0) < v.options.blockPickingMaxDistance)((function () {
                                          var rbi = Game_Cubbit_BlockIndex.runBlockIndex(v7.value0);
                                          return function __do() {
                                              var v8 = Graphics_Babylon_Vector3.createVector3(Data_Int.toNumber(rbi.x) + 0.5)(Data_Int.toNumber(rbi.y) + 0.5)(Data_Int.toNumber(rbi.z) + 0.5)();
                                              Graphics_Babylon_Mesh.setPosition(v8)(v.cursor)();
                                              return Game_Cubbit_Hud_Driver.queryToHud(driver)(Game_Cubbit_Hud_Type.Query.create(new Game_Cubbit_Hud_Type.PlayingSceneQuery(new Game_Cubbit_Hud_Type.SetCursorPosition(v7.value0))))();
                                          };
                                      })()))();
                                  };
                                  throw new Error("Failed pattern match at Game.Cubbit.Update line 295, column 29 - line 305, column 109: " + [ v7.constructor.name ]);
                              };
                          })()();
                          Graphics_Babylon_AbstractMesh.setIsVisible((function () {
                              if (v2.value1.mode instanceof Game_Cubbit_Types.Put) {
                                  return true;
                              };
                              if (v2.value1.mode instanceof Game_Cubbit_Types.Remove) {
                                  return true;
                              };
                              if (v2.value1.mode instanceof Game_Cubbit_Types.Move) {
                                  return false;
                              };
                              throw new Error("Failed pattern match at Game.Cubbit.Update line 309, column 35 - line 312, column 38: " + [ v2.value1.mode.constructor.name ]);
                          })())(Graphics_Babylon_Mesh.meshToAbstractMesh(v.cursor))();
                          (function () {
                              var $169 = v1.sceneState.value0.animation !== "run" && v2.value1.animation === "run";
                              if ($169) {
                                  return Graphics_Babylon_Sound.play(v.sounds.stepSound);
                              };
                              if (!$169) {
                                  var $170 = v1.sceneState.value0.animation === "run" && v2.value1.animation !== "run";
                                  if ($170) {
                                  ...
                                  throw new Error("Failed pattern match at Game.Cubbit.Update line 318, column 30 - line 320, column 43: " + [ $170.constructor.name ]);
                              };
                              throw new Error("Failed pattern match at Game.Cubbit.Update line 316, column 21 - line 320, column 43: " + [ $169.constructor.name ]);
                          })()();
                          return v2.value0;
                      };
                  };
                  throw new Error("Failed pattern match at Game.Cubbit.Update line 243, column 9 - line 322, column 36: " + [ v1.sceneState.constructor.name ]);
              };
          };
      };
  };
...
(function(exports) {
  ...
  var main = function __do() {
          ...
          return Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Control_Monad_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(function (v1) {
              return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Game_Cubbit_Config.readConfig))(function (v2) {
                  return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Graphics_Cannon_World.createWorld))(function (v3) {
                      return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Control_Bind.bind(Control_Monad_Eff.bindEff)(Control_Bind.bind(Control_Monad_Eff.bindEff)(DOM_HTML.window)(DOM_HTML_Window.location))(DOM_HTML_Location.hostname)))(function (v4) {
                          var niconico = v4 === "html5.nicogame.jp";
                          return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Applicative.when(Control_Monad_Aff.applicativeAff)(niconico)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(function __do() {
                              var v5 = Control_Bind.bind(Control_Monad_Eff.bindEff)(Control_Bind.bind(Control_Monad_Eff.bindEff)(DOM_HTML.window)(DOM_HTML_Window.document))(DOM_HTML_Document.body)();
                              return Data_Foldable.for_(Control_Monad_Eff.applicativeEff)(Data_Foldable.foldableMaybe)(Data_Nullable.toMaybe(v5))(function ($52) {
                                  return DOM_Node_Element.setClassName("niconico")(DOM_HTML_Types.htmlElementToElement($52));
                              })();
                          })))(function () {
                              return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Game_Cubbit_Terrain.createTerrain(0)))(function (v5) {
                                  var initialState = {
                                      canvas: v.value0, 
                                      config: v2, 
                                  ...
                                  return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Control_Monad_Eff_Ref.newRef(initialState)))(function (v6) {
                                      return Control_Bind.bind(Control_Monad_Aff.bindAff)(Game_Cubbit_Hud_Driver.initializeHud(initialState)(v6)(v1))(function (v7) {
                                          return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Control_Monad_Eff_Ref.newRef(0)))(function (v8) {
                                                  ...
                                                  return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Control_Monad_Eff_Ref.readRef(v8)))(function (v9) {
                                                      return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Control_Monad_Eff_Console.log(Data_Show.show(Data_Show.showInt)(v9) + (" / " + Data_Show.show(Data_Show.showInt)(Game_Cubbit_Resources.resourceCount)))))(function () {
                                                          return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Control_Monad_Eff_Ref.readRef(v6)))(function (v10) {
                                                              return Game_Cubbit_Hud_Eval.repaint(v7)((function () {
                                                                  var $32 = {};
                                                                  for (var $33 in v10) {
                                                                      if (v10.hasOwnProperty($33)) {
                                                                          $32[$33] = v10[$33];
                                                                      };
                                                                  };
                                                                  $32.res = new Game_Cubbit_Types.Loading(v9);
                                                                  return $32;
                                                              })());
                                                          });
                                                      });
                                              ...
                                              return Control_Bind.bind(Control_Monad_Aff.bindAff)(Game_Cubbit_Resources.loadResources(v.value0)(inc))(function (v9) {
                                                  return Control_Bind.bind(Control_Monad_Aff.bindAff)(Game_Cubbit_Hud_Eval.repaint(v7)((function () {
                                                      var $36 = {};
                                                      for (var $37 in initialState) {
                                                          if (initialState.hasOwnProperty($37)) {
                                                              $36[$37] = initialState[$37];
                                                          };
                                                      };
                                                      $36.res = new Game_Cubbit_Types.Complete(v9);
                                                      return $36;
                                                  })()))(function () {
                                                      return Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(function __do() {
                                                          Control_Monad_Eff_Ref.modifyRef(v6)(function (v10) {
                                                              var $40 = {};
                                                              for (var $41 in v10) {
                                                                  if (v10.hasOwnProperty($41)) {
                                                                      $40[$41] = v10[$41];
                                                                  };
                                                              };
                                                              $40.nextBGM = new Data_Maybe.Just(v9.sounds.cleaning);
                                                              return $40;
                                                          })();
                                                          ...
                                                          Game_Cubbit_Hud_Eval.initializeTerrain(v6)();
                                                          Control_Bind.bind(Control_Monad_Eff.bindEff)(Data_Functor.mapFlipped(Control_Monad_Eff.functorEff)(Control_Bind.bind(Control_Monad_Eff.bindEff)(Data_Functor.mapFlipped(Control_Monad_Eff.functorEff)(Control_Bind.bind(Control_Monad_Eff.bindEff)(DOM_HTML.window)(DOM_HTML_Window.document))(DOM_HTML_Types.htmlDocumentToNonElementParentNode))(DOM_Node_NonElementParentNode.getElementById("content")))(Data_Nullable.toMaybe))(Data_Foldable.traverse_(Control_Monad_Eff.applicativeEff)(Data_Foldable.foldableMaybe)(function ($53) {
                                                              return DOM_HTML_HTMLElement.focus(Unsafe_Coerce.unsafeCoerce($53));
                                                          }))();
                                                          ...
                                                          return Graphics_Babylon_Engine.runRenderLoop(function __do() {
                                                              var v12 = Control_Monad_Eff_Ref.readRef(v6)();
                                                              if (v12.sceneState instanceof Game_Cubbit_Types.ModeSelectionSceneState) {
                                                                  return Control_Bind.bind(Control_Monad_Eff.bindEff)(Control_Bind.bind(Control_Monad_Eff.bindEff)(Control_Monad_Eff_Ref.readRef(v6))(Game_Cubbit_Update.updateSound(v9.sounds)))(Control_Monad_Eff_Ref.writeRef(v6))();
                                                              };
                                                              var v13 = Graphics_Babylon_Engine.getDeltaTime(v9.engine)();
                                                              Control_Bind.bind(Control_Monad_Eff.bindEff)(Control_Bind.bind(Control_Monad_Eff.bindEff)(Control_Bind.bind(Control_Monad_Eff.bindEff)(Control_Bind.bind(Control_Monad_Eff.bindEff)(Control_Bind.bind(Control_Monad_Eff.bindEff)(Control_Monad_Eff_Ref.readRef(v6))(Game_Cubbit_Update.update(v13)(v9)(v7)))(Game_Cubbit_Update.updateBabylon(v13)(v9)))(Game_Cubbit_Update.updateSound(v9.sounds)))(Game_Cubbit_Collesion.updatePhysics(v13)(v11)(v3)))(Control_Monad_Eff_Ref.writeRef(v6))();
      ...
      throw new Error("Failed pattern match at Game.Cubbit.Main line 49, column 62 - line 152, column 36: " + [ v.constructor.name ]);
  };
  exports["main"] = main;
