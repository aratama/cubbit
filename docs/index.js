                          ...
                          return function __do() {
                              ...
                              (function () {
                                  ...
                                  return function __do() {
                                      ...
                                      return Graphics_Babylon_ShadowGenerator.setRenderList(Data_Array.catMaybes(Data_Functor.map(Data_Functor.functorArray)(function (chunk) {
                              ...
                              var st$prime = (function () {
                                  ...
                                  if (v4 instanceof Data_Maybe.Just) {
                                      ...
                                      $121.position = {
                                          x: v3.position.x, 
                                          y: Data_Int.toNumber(globalIndex.y), 
                                          z: v3.position.z
                                      };
                                      $121.velocity = {
                                          x: 0.0, 
                              ...
                              return Data_Foldable.for_(Control_Monad_Eff.applicativeEff)(Data_Foldable.foldableArray)(v3.playerMeshes)(function (mesh) {
                                  return Data_Functor["void"](Control_Monad_Eff.functorEff)(function __do() {
                                      var v5 = Graphics_Babylon_Vector3.createVector3(st$prime.position.x)(st$prime.position.y + 1.001)(st$prime.position.z)();
      ...
      return function (canvas2d) {
          return function __do() {
              ...
              var v5 = (function __do() {
                  ...
                  Graphics_Babylon_AbstractMesh.setMaterial(Graphics_Babylon_StandardMaterial.standardMaterialToMaterial(v6))(Graphics_Babylon_Mesh.meshToAbstractMesh(v5))();
                  return v5;
              })();
              var v6 = (function __do() {
                  ...
                  Graphics_Babylon_AbstractMesh.setRenderingGroupId(Game_Cubbit_Constants.skyBoxRenderingGruop)(Graphics_Babylon_Mesh.meshToAbstractMesh(v10))();
                  Graphics_Babylon_AbstractMesh.setMaterial(Graphics_Babylon_StandardMaterial.standardMaterialToMaterial(v7))(Graphics_Babylon_Mesh.meshToAbstractMesh(v10))();
              ...
              var v7 = (function __do() {
                  ...
                  var v8 = Graphics_Babylon_Texture.createTexture("./alpha.png")(v1)();
                  Graphics_Babylon_BaseTexture.setHasAlpha(true)(Graphics_Babylon_Texture.textureToBaseTexture(v8))();
                  var v9 = (function __do() {
                      var v9 = Graphics_Babylon_ShaderMaterial.createShaderMaterial("cellShading")(v1)("./alice/cellShading")({
                      ...
                      var v10 = Graphics_Babylon_Vector3.createVector3(0.0)(20.0)(-10.0)();
                      var v11 = Graphics_Babylon_Color3.createColor3(1.0)(1.0)(1.0)();
                      var v12 = Graphics_Babylon_Texture.createTexture("./alice/texture.png")(v1)();
                      Graphics_Babylon_ShaderMaterial.setTexture("textureSampler")(v12)(v9)();
                      Graphics_Babylon_ShaderMaterial.setVector3("vLightPosition")(v10)(v9)();
                      Graphics_Babylon_ShaderMaterial.setFloats("ToonThresholds")([ 0.2, -0.45, -5.0, -5.0 ])(v9)();
                      Graphics_Babylon_ShaderMaterial.setFloats("ToonBrightnessLevels")([ 1.0, 0.9, 0.75, 0.75, 0.75 ])(v9)();
                      Graphics_Babylon_ShaderMaterial.setColor3("vLightColor")(v11)(v9)();
                      return v9;
                  })();
                  var v10 = (function __do() {
                      var v10 = Graphics_Babylon_StandardMaterial.createStandardMaterial("grass-block")(v1)();
                      var v11 = Graphics_Babylon_Color3.createColor3(0.0)(0.0)(0.0)();
                      Graphics_Babylon_StandardMaterial.setSpecularColor(v11)(v10)();
                  ...
                  var v11 = (function () {
                      if (enableWaterMaterial) {
                          return function __do() {
                              var v11 = Graphics_Babylon_WaterMaterial.createWaterMaterial("water-block")(v1)();
                              var v12 = Graphics_Babylon_Texture.createTexture("waterbump.png")(v1)();
                              Graphics_Babylon_WaterMaterial.setBumpTexture(v12)(v11)();
                              Graphics_Babylon_WaterMaterial.addToRenderList(Graphics_Babylon_Mesh.meshToAbstractMesh(v6))(v11)();
                              Graphics_Babylon_WaterMaterial.setWaveHeight(0.0)(v11)();
                              Graphics_Babylon_WaterMaterial.setWindForce(1.0)(v11)();
                              return Graphics_Babylon_WaterMaterial.waterMaterialToMaterial(v11);
                          };
                      };
                      if (!enableWaterMaterial) {
                          return function __do() {
                              var v11 = Graphics_Babylon_StandardMaterial.createStandardMaterial("water-block")(v1)();
                              var v12 = Graphics_Babylon_Color3.createColor3(50.0 / 255.0)(50.0 / 255.0)(60.0 / 255.0)();
                              Graphics_Babylon_StandardMaterial.setDiffuseColor(v12)(v11)();
                              Graphics_Babylon_Material.setAlpha(0.7)(Graphics_Babylon_StandardMaterial.standardMaterialToMaterial(v11))();
                              return Graphics_Babylon_StandardMaterial.standardMaterialToMaterial(v11);
                          };
                      };
                      throw new Error("Failed pattern match at Game.Cubbit.Main line 195, column 26 - line 210, column 54: " + [ enableWaterMaterial.constructor.name ]);
                  })()();
                  var v12 = (function __do() {
                      var v12 = Graphics_Babylon_StandardMaterial.createStandardMaterial("bush-material")(v1)();
                      Graphics_Babylon_StandardMaterial.setDiffuseTexture(v8)(v12)();
                      Graphics_Babylon_Material.setAlpha(0.8)(Graphics_Babylon_StandardMaterial.standardMaterialToMaterial(v12))();
                      var v13 = Graphics_Babylon_Color3.createColor3(0.35)(0.5)(0.3)();
                      Graphics_Babylon_StandardMaterial.setDiffuseColor(v13)(v12)();
                      Graphics_Babylon_StandardMaterial.setUseAlphaFromDiffuseTexture(true)(v12)();
                      return v12;
                  })();
                  return {
                      blockMaterial: Graphics_Babylon_StandardMaterial.standardMaterialToMaterial(v10), 
                      waterMaterial: v11, 
                      cellShadingMaterial: Graphics_Babylon_ShaderMaterial.shaderMaterialToMaterial(v9), 
                      bushMaterial: Graphics_Babylon_StandardMaterial.standardMaterialToMaterial(v12)
                  };
              })();
              var v8 = Game_Cubbit_Terrain.emptyTerrain(0)();
              var v9 = Control_Monad_Eff_Ref.newRef({
              ...
              Game_Cubbit_UI.initializeUI(canvasGL)(canvas2d)(v9)(v5)(v3)(v2)(v1)(v7)();
              var onSucc = function (result) {
                  return function __do() {
                      Data_Foldable.for_(Control_Monad_Eff.applicativeEff)(Data_Foldable.foldableArray)(result)(function (mesh) {
                          return Data_Functor["void"](Control_Monad_Eff.functorEff)(function __do() {
                              var v10 = Graphics_Babylon_Vector3.createVector3(0.5)(13.0)(0.5)();
                              Graphics_Babylon_AbstractMesh.setPosition(v10)(mesh)();
                              Graphics_Babylon_AbstractMesh.setRenderingGroupId(1)(mesh)();
                              Graphics_Babylon_AbstractMesh.setReceiveShadows(true)(mesh)();
                              var v11 = Graphics_Babylon_AbstractMesh.getSkeleton(mesh)();
                              Graphics_Babylon_Scene.beginAnimation(v11)(0)(30)(true)(1.0)(Data_Nullable.toNullable(Data_Maybe.Nothing.value))(Data_Nullable.toNullable(Data_Maybe.Nothing.value))(v1)();
                              return Graphics_Babylon_AbstractMesh.setMaterial(v7.cellShadingMaterial)(mesh)();
                          });
                      })();
                      Control_Monad_Eff_Ref.modifyRef(v9)(function (v10) {
                          var $112 = {};
                          for (var $113 in v10) {
                              if (v10.hasOwnProperty($113)) {
                                  $112[$113] = v10[$113];
                              };
                          };
                          $112.playerMeshes = result;
                          return $112;
                      })();
                      return Data_Unit.unit;
                  };
              ...
              Game_Cubbit_Event.onKeyDown(function (e) {
                  return Control_Applicative.when(Control_Monad_Eff.applicativeEff)(e.keyCode === 32)(Control_Monad_Eff_Ref.modifyRef(v9)(function (v10) {
                      var $116 = {};
                      for (var $117 in v10) {
                          if (v10.hasOwnProperty($117)) {
                              $116[$117] = v10[$117];
                          };
                      };
                      $116.velocity = {
                          x: v10.velocity.x, 
                          y: v10.velocity.y + 0.15, 
                          z: v10.velocity.z
                      };
                      return $116;
                  }));
              ...
              Control_Monad_Eff.forE(-5)(5)(function (x) {
                  return Control_Monad_Eff.forE(-5)(5)(function (z) {
                      return Data_Functor["void"](Control_Monad_Eff.functorEff)((function () {
                          ...
                          return Game_Cubbit_MeshBuilder.createChunkMesh(v9)(v7)(v1)(index);
                      })());
                  });
              })();
              return Graphics_Babylon_Engine.runRenderLoop(function __do() {
                  Game_Cubbit_Update.update(v9)(v1)(v7)(v4)(v5)(v3)();
