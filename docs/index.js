      ...
      return function (canvas2d) {
          return Data_Functor["void"](Control_Monad_Eff.functorEff)(Control_Monad_Aff.runAff(Control_Monad_Eff_Console.errorShow(Control_Monad_Eff_Exception.showError))(Control_Applicative.pure(Control_Monad_Eff.applicativeEff))(Control_Bind.bind(Control_Monad_Aff.bindAff)(Network_HTTP_Affjax.get(Network_HTTP_Affjax_Response.responsableForeign)("options.json"))(function (v) {
              return Control_Bind.bind(Control_Monad_Aff.bindAff)((function () {
                  var $90 = Control_Monad_Except.runExcept(readOptions(v.response));
                  if ($90 instanceof Data_Either.Left) {
                      return Control_Monad_Error_Class.throwError(Control_Monad_Aff.monadErrorAff)(Control_Monad_Eff_Exception.error(Data_Show.show(Data_List_Types.showNonEmptyList(Data_Foreign.showForeignError))($90.value0)));
                  };
                  if ($90 instanceof Data_Either.Right) {
                      return Control_Applicative.pure(Control_Monad_Aff.applicativeAff)($90.value0);
                  };
                  throw new Error("Failed pattern match at Game.Cubbit.Main line 98, column 16 - line 100, column 30: " + [ $90.constructor.name ]);
              })())(function (v1) {
                                      ...
                                      return Control_Bind.bind(Control_Monad_Aff.bindAff)(Graphics_Babylon_SceneLoader_Aff.loadMesh("")("./alice/")("alice.babylon")(v3)(Control_Applicative.pure(Control_Monad_Eff.applicativeEff)))(function (v6) {
                                          return Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(function __do() {
                                              ...
                                              var v8 = (function __do() {
                                                  ...
                                                  var v9 = Graphics_Babylon_TargetCamera.createTargetCamera("target-camera")(v8)(v3)();
                                                  var v10 = Graphics_Babylon_Vector3.createVector3(0.0)(8.0)(0.0)();
                                                  Graphics_Babylon_TargetCamera.setTarget(v10)(v9)();
                                                  return v9;
                                              })();
                                              Graphics_Babylon_Scene.setActiveCameras([ Graphics_Babylon_TargetCamera.targetCameraToCamera(v8) ])(v3)();
                                              Graphics_Babylon_Scene.setActiveCamera(Graphics_Babylon_TargetCamera.targetCameraToCamera(v8))(v3)();
                                              (function __do() {
                                              ...
                                              Game_Cubbit_Event.onKeyDown(function (e) {
                                                  return function __do() {
                                                      Control_Applicative.when(Control_Monad_Eff.applicativeEff)(e.keyCode === 32)(Control_Monad_Eff_Ref.modifyRef(v14)(function (v15) {
                                                          var $136 = {};
                                                          for (var $137 in v15) {
                                                              if (v15.hasOwnProperty($137)) {
                                                                  $136[$137] = v15[$137];
                                                              };
                                                          };
                                                          $136.velocity = (function () {
                                                              var $133 = {};
                                                              for (var $134 in v15.velocity) {
                                                                  if (v15.velocity.hasOwnProperty($134)) {
                                                                      $133[$134] = v15.velocity[$134];
                                                                  };
                                                              };
                                                              $133.y = v15.velocity.y + v1.jumpVelocity;
                                                              return $133;
                                                          })();
                                                          return $136;
                                                      }))();
                                                      Control_Applicative.when(Control_Monad_Eff.applicativeEff)(e.keyCode === 87)(Control_Monad_Eff_Ref.modifyRef(v14)(function (v15) {
                                                          var $140 = {};
                                                          for (var $141 in v15) {
                                                              if (v15.hasOwnProperty($141)) {
                                                                  $140[$141] = v15[$141];
                                                              };
                                                          };
                                                          $140.wKey = true;
                                                      ...
                                                      Control_Applicative.when(Control_Monad_Eff.applicativeEff)(e.keyCode === 83)(Control_Monad_Eff_Ref.modifyRef(v14)(function (v15) {
                                                          var $144 = {};
                                                          for (var $145 in v15) {
                                                              if (v15.hasOwnProperty($145)) {
                                                                  $144[$145] = v15[$145];
                                                              };
                                                          };
                                                          $144.sKey = true;
                                                      ...
                                                      Control_Applicative.when(Control_Monad_Eff.applicativeEff)(e.keyCode === 65)(Control_Monad_Eff_Ref.modifyRef(v14)(function (v15) {
                                                          var $148 = {};
                                                          for (var $149 in v15) {
                                                              if (v15.hasOwnProperty($149)) {
                                                                  $148[$149] = v15[$149];
                                                              };
                                                          };
                                                          $148.aKey = true;
                                                      ...
                                                      Control_Applicative.when(Control_Monad_Eff.applicativeEff)(e.keyCode === 68)(Control_Monad_Eff_Ref.modifyRef(v14)(function (v15) {
                                                          var $152 = {};
                                                          for (var $153 in v15) {
                                                              if (v15.hasOwnProperty($153)) {
                                                                  $152[$153] = v15[$153];
                                                              };
                                                          };
                                                          $152.dKey = true;
                                                      ...
                                                      Control_Applicative.when(Control_Monad_Eff.applicativeEff)(e.keyCode === 82)(Control_Monad_Eff_Ref.modifyRef(v14)(function (v15) {
                                                          var $156 = {};
                                                          for (var $157 in v15) {
                                                              if (v15.hasOwnProperty($157)) {
                                                                  $156[$157] = v15[$157];
                                                              };
                                                          };
                                                          $156.rKey = true;
                                                      ...
                                                      Control_Applicative.when(Control_Monad_Eff.applicativeEff)(e.keyCode === 70)(Control_Monad_Eff_Ref.modifyRef(v14)(function (v15) {
                                                          var $160 = {};
                                                          for (var $161 in v15) {
                                                              if (v15.hasOwnProperty($161)) {
                                                                  $160[$161] = v15[$161];
                                                              };
                                                          };
                                                          $160.fKey = true;
                                                      ...
                                                      Control_Applicative.when(Control_Monad_Eff.applicativeEff)(e.keyCode === 81)(Control_Monad_Eff_Ref.modifyRef(v14)(function (v15) {
                                                          var $164 = {};
                                                          for (var $165 in v15) {
                                                              if (v15.hasOwnProperty($165)) {
                                                                  $164[$165] = v15[$165];
                                                              };
                                                          };
                                                          $164.qKey = true;
                                                      ...
                                                      Control_Applicative.when(Control_Monad_Eff.applicativeEff)(e.keyCode === 69)(Control_Monad_Eff_Ref.modifyRef(v14)(function (v15) {
                                                          var $168 = {};
                                                          for (var $169 in v15) {
                                                              if (v15.hasOwnProperty($169)) {
                                                                  $168[$169] = v15[$169];
                                                              };
                                                          };
                                                          $168.eKey = true;
                                                      ...
                                                      Control_Applicative.when(Control_Monad_Eff.applicativeEff)(e.keyCode === 84)(Control_Monad_Eff_Ref.modifyRef(v14)(function (v15) {
                                                          var $172 = {};
                                                          for (var $173 in v15) {
                                                              if (v15.hasOwnProperty($173)) {
                                                                  $172[$173] = v15[$173];
                                                              };
                                                          };
                                                          $172.tKey = true;
                                                      ...
                                                      return Control_Applicative.when(Control_Monad_Eff.applicativeEff)(e.keyCode === 71)(Control_Monad_Eff_Ref.modifyRef(v14)(function (v15) {
                                                          var $176 = {};
                                                          for (var $177 in v15) {
                                                              if (v15.hasOwnProperty($177)) {
                                                                  $176[$177] = v15[$177];
                                                              };
                                                          };
                                                          $176.gKey = true;
