...
(function(exports) {
  ...
  var Data_Ring = PS["Data.Ring"];
  var show_Show = new Data_Show.Show(function (v) {
      return Data_Show.show(Game_Cubbit_BlockIndex.show_Show)(v);
  });
...
(function(exports) {
  ...
  var createBlockMap = function (index) {
      return function (seed) {
          return $foreign.createBlockMapJS(PerlinNoise.createNoise(seed))(PerlinNoise.simplex2)(index)(terrainScale)(waterBlockHeight)(maxHeight)(Game_Cubbit_BlockType.blockTypes);
      };
  };
...
(function(exports) {
  ...
  var lookupChunk = function (index) {
      return function (v) {
          return Data_ShowMap.lookup(Game_Cubbit_ChunkIndex.show_Show)(index)(v.map);
      };
  };
  var insertChunk = function (v) {
      return function (v1) {
          ...
          $12.map = Data_ShowMap.insert(Game_Cubbit_ChunkIndex.show_Show)(v.blocks.index)(v)(v1.map);
          return $12;
      };
  };
  ...
  var lookupBlock = function (p) {
      return function (v) {
          ...
          return Control_Bind.bind(Data_Maybe.bindMaybe)(Data_ShowMap.lookup(Game_Cubbit_ChunkIndex.show_Show)(chunkIndex)(v.map))(function (v1) {
              return Control_Bind.bind(Data_Maybe.bindMaybe)(Game_Cubbit_BoxelMap.lookup(localIndex)(v1.blocks.blocks))(function (v2) {
                  var $21 = Data_Eq.eq(Game_Cubbit_BlockType.eq_BlockType)(v2)(Game_Cubbit_BlockType.airBlock);
                  if ($21) {
                      return Data_Maybe.Nothing.value;
                  };
                  if (!$21) {
                  ...
                  throw new Error("Failed pattern match at Game.Cubbit.Terrain line 79, column 9 - line 79, column 66: " + [ $21.constructor.name ]);
              });
          });
      };
  };
...
(function(exports) {
  ...
  var Game_Cubbit_ChunkIndex = PS["Game.Cubbit.ChunkIndex"];
  var Game_Cubbit_Constants = PS["Game.Cubbit.Constants"];
  var Game_Cubbit_VertexDataPropsData = PS["Game.Cubbit.VertexDataPropsData"];
  var Control_Alternative = PS["Control.Alternative"];
  var Control_Bind = PS["Control.Bind"];
  var Control_Monad = PS["Control.Monad"];
  var Control_Monad_Eff = PS["Control.Monad.Eff"];
  ...
  var createTerrainGeometry = $foreign.createTerrainGeometryJS(Game_Cubbit_Constants.chunkSize)(Game_Cubbit_BlockType.blockTypes)(Game_Cubbit_ChunkIndex.runChunkIndex);
          ...
          return function (scene) {
              return function (chunkWithMesh) {
                  return Data_Functor["void"](Control_Monad_Eff.functorEff)(function __do() {
                      ...
                      (function () {
                          var $11 = Game_Cubbit_Terrain.lookupChunk(v.terrain.index)(v1.terrain);
                          if ($11 instanceof Data_Maybe.Nothing) {
                              return Control_Applicative.pure(Control_Monad_Eff.applicativeEff)(Data_Unit.unit);
                          };
                          if ($11 instanceof Data_Maybe.Just) {
                              return Game_Cubbit_Terrain.disposeChunk($11.value0);
                          };
                          throw new Error("Failed pattern match at Game.Cubbit.MeshBuilder line 77, column 5 - line 79, column 49: " + [ $11.constructor.name ]);
                      })()();
                      ...
                      return Control_Monad_Eff_Class.liftEff(Control_Monad_Eff_Class.monadEffEff)(Control_Monad_Eff_Ref.writeRef(ref)((function () {
                          ...
                          $15.terrain = Game_Cubbit_Terrain.insertChunk(v3)(v1.terrain);
                          return $15;
                      })()))();
                  });
              };
          ...
          return function (scene) {
              return function (index) {
                  return function __do() {
                      ...
                      var boxMap = Game_Cubbit_Generation.createBlockMap(index)(0);
                      var $20 = createTerrainGeometry(boxMap);
                      return Data_Functor["void"](Control_Monad_Eff.functorEff)(function __do() {
                          (function () {
                              var $21 = Game_Cubbit_Terrain.lookupChunk(index)(v.terrain);
                              if ($21 instanceof Data_Maybe.Nothing) {
                                  return Control_Applicative.pure(Control_Monad_Eff.applicativeEff)(Data_Unit.unit);
                              };
                              if ($21 instanceof Data_Maybe.Just) {
                                  return Game_Cubbit_Terrain.disposeChunk($21.value0);
                              };
                              throw new Error("Failed pattern match at Game.Cubbit.MeshBuilder line 45, column 13 - line 47, column 57: " + [ $21.constructor.name ]);
                          })()();
                          ...
                          return Control_Monad_Eff_Ref.modifyRef(ref)(function (v2) {
                              ...
                              $25.terrain = Game_Cubbit_Terrain.insertChunk(result)(v2.terrain);
                              return $25;
                          })();
                      })();
                  };
              ...
              return function (screenX) {
                  return function (screenY) {
                      ...
                      return function __do() {
                          ...
                          var pickup = (function () {
                              ...
                              return function __do() {
                                  ...
                                  var lookupBlock$prime = function (x) {
                                      return function (y) {
                                          return function (z) {
                                              return Game_Cubbit_Terrain.lookupBlock({
                                                  x: x, 
                                                  y: y, 
                                                  z: z
                                              })(v.terrain);
                                  ...
                                  if (v.mode instanceof Game_Cubbit_Types.Put) {
                                      ...
                                      if (!$29) {
                                          ...
                                          throw new Error("Failed pattern match at Game.Cubbit.Update line 90, column 30 - line 99, column 57: " + [ $34.constructor.name ]);
                                      };
                                      throw new Error("Failed pattern match at Game.Cubbit.Update line 85, column 24 - line 99, column 57: " + [ $29.constructor.name ]);
                                  };
                                  if (v.mode instanceof Game_Cubbit_Types.Remove) {
                                      ...
                                      if (!$43) {
                                          ...
                                          throw new Error("Failed pattern match at Game.Cubbit.Update line 106, column 30 - line 115, column 57: " + [ $48.constructor.name ]);
                                      };
                                      throw new Error("Failed pattern match at Game.Cubbit.Update line 101, column 27 - line 115, column 57: " + [ $43.constructor.name ]);
                                  };
                                  if (v.mode instanceof Game_Cubbit_Types.Move) {
                                      return Data_Maybe.Nothing.value;
                                  };
                                  throw new Error("Failed pattern match at Game.Cubbit.Update line 84, column 13 - line 117, column 37: " + [ v.mode.constructor.name ]);
                              };
                          })();
                          ...
                          throw new Error("Failed pattern match at Game.Cubbit.Update line 119, column 5 - line 119, column 56: " + [ $57.constructor.name ]);
                      };
                  };
              };
          };
                  ...
                  return function (cursor) {
                      return function (camera) {
                          return function __do() {
                              ...
                              var cameraPositionChunkIndex = Game_Cubbit_Terrain.globalPositionToChunkIndex(v1.x)(v1.y)(v1.z);
                              (function () {
                                  if (v.mode instanceof Game_Cubbit_Types.Move) {
                                      return Control_Applicative.pure(Control_Monad_Eff.applicativeEff)(Data_Unit.unit);
                                  };
                                  return function __do() {
                                      ...
                                      throw new Error("Failed pattern match at Game.Cubbit.Update line 138, column 21 - line 143, column 49: " + [ v2.constructor.name ]);
                                  };
                              })()();
                                          ...
                                          Control_Monad_Eff.forE(ci.x - 0)(ci.x + 0 | 0)(function (dx) {
                                              return Control_Monad_Eff.forE(ci.y - 0)(ci.y + 0 | 0)(function (dy) {
                                                  return Control_Monad_Eff.forE(ci.z - 0)(ci.z + 0 | 0)(function (dz) {
                                                      var $70 = Game_Cubbit_Terrain.lookupChunk(Game_Cubbit_ChunkIndex.chunkIndex(dx)(dy)(dz))(v.terrain);
                                                      ...
                                                      throw new Error("Failed pattern match at Game.Cubbit.Update line 157, column 29 - line 160, column 105: " + [ $70.constructor.name ]);
                                                  });
                                              });
                                          })();
                                          return v2;
                              ...
                              (function () {
                                      ...
                                      return Control_Bind.bind(Control_Bind.bindArray)(Data_Array.range(ci.x - loadDistance)(ci.x + loadDistance | 0))(function (v2) {
                                          return Control_Bind.bind(Control_Bind.bindArray)(Data_Array.range(ci.y - 1)(ci.y + 1 | 0))(function (v3) {
                                              return Control_Bind.bind(Control_Bind.bindArray)(Data_Array.range(ci.z - loadDistance)(ci.z + loadDistance | 0))(function (v4) {
                                                  return Control_Bind.bind(Control_Bind.bindArray)(Control_MonadZero.guard(Control_MonadZero.monadZeroArray)(Data_Maybe.isNothing(Game_Cubbit_Terrain.lookupChunk(Game_Cubbit_ChunkIndex.chunkIndex(v2)(v3)(v4))(v.terrain))))(function () {
                                                      return Control_Applicative.pure(Control_Applicative.applicativeArray)(Game_Cubbit_ChunkIndex.chunkIndex(v2)(v3)(v4));
                                                  });
                                              });
                                          });
                                      });
                                  ...
                                  if ($77 instanceof Data_Maybe.Just) {
                                      return function __do() {
                                          Game_Cubbit_MeshBuilder.createChunkMesh(ref)(materials)(scene)($77.value0)();
                                          Control_Monad_Eff_Console.log("load chunk: " + Data_Show.show(Game_Cubbit_ChunkIndex.show_Show)($77.value0))();
                                          return Control_Monad_Eff_Console.log("total chunks:" + Data_Show.show(Data_Show.showInt)(Game_Cubbit_Terrain.chunkCount(v.terrain) + 1 | 0))();
                                      };
                                  };
                                  throw new Error("Failed pattern match at Game.Cubbit.Update line 177, column 13 - line 182, column 81: " + [ $77.constructor.name ]);
                              })()();
                              (function __do() {
                                  var v2 = Control_Monad_Eff_Ref.readRef(ref)();
                                  return Data_Foldable.for_(Control_Monad_Eff.applicativeEff)(Data_ShowMap.foldable_ShowMap)(Game_Cubbit_Terrain.getChunkMap(v2.terrain))(function (v3) {
                                      var r = Game_Cubbit_ChunkIndex.chunkIndexDistance(v3.blocks.index)(cameraPositionChunkIndex);
                              ...
                              (function __do() {
                                  ...
                                  var st$prime = (function () {
                                      var $83 = Game_Cubbit_Terrain.lookupBlock(next)(v2.terrain);
                                      ...
                                      throw new Error("Failed pattern match at Game.Cubbit.Update line 205, column 23 - line 217, column 30: " + [ $83.constructor.name ]);
                                  })();
                              ...
                              return function (materials) {
                                  return function __do() {
                                          ...
                                          return function (value) {
                                              return Game_Cubbit_Event.onButtonClick(id)(function __do() {
                                                  ...
                                                  return Graphics_Babylon_AbstractMesh.setIsVisible((function () {
                                                      ...
                                                      throw new Error("Failed pattern match at Game.Cubbit.UI line 66, column 40 - line 69, column 30: " + [ value.constructor.name ]);
                                      ...
                                      Game_Cubbit_Event.onButtonClick("minimap")(function __do() {
                                          ...
                                          throw new Error("Failed pattern match at Game.Cubbit.UI line 84, column 9 - line 86, column 68: " + [ v.minimap.constructor.name ]);
                                      })();
                                      Game_Cubbit_Event.onButtonClick("debuglayer")(function __do() {
                                          ...
                                          throw new Error("Failed pattern match at Game.Cubbit.UI line 91, column 9 - line 93, column 57: " + [ v.debugLayer.constructor.name ]);
                                      })();
                                      return Game_Cubbit_Event.onMouseClick(function (e) {
                                          return function __do() {
                                              ...
                                              if (v1 instanceof Data_Maybe.Just) {
                                                  var chunkIndex = Game_Cubbit_Terrain.globalIndexToChunkIndex(v1.value0);
                                                  var $37 = Game_Cubbit_Terrain.lookupChunk(chunkIndex)(v.terrain);
                                                  ...
                                                  if ($37 instanceof Data_Maybe.Just) {
                                                      return Data_Functor["void"](Control_Monad_Eff.functorEff)((function () {
                                                          var localIndex = Game_Cubbit_Terrain.globalIndexToLocalIndex(v1.value0);
                                                          return Game_Cubbit_MeshBuilder.updateChunkMesh(ref)(materials)(scene)((function () {
                                                              var $42 = {};
                                                              ...
                                                              $42.blocks = (function () {
                                                                  ...
                                                                  $39.blocks = (function () {
                                                                      if (v.mode instanceof Game_Cubbit_Types.Put) {
                                                                          return Game_Cubbit_BoxelMap.insert(localIndex)(Game_Cubbit_BlockType.grassBlock)($37.value0.blocks.blocks);
                                                                      };
                                                                      if (v.mode instanceof Game_Cubbit_Types.Remove) {
                                                                          return Game_Cubbit_BoxelMap["delete"](localIndex)($37.value0.blocks.blocks);
                                                                      };
                                                                      if (v.mode instanceof Game_Cubbit_Types.Move) {
                                                                          return $37.value0.blocks.blocks;
                                                                      };
                                                                      throw new Error("Failed pattern match at Game.Cubbit.UI line 109, column 42 - line 112, column 57: " + [ v.mode.constructor.name ]);
                                                                  })();
                                                                  return $39;
                                                              })();
                                                              return $42;
                                                  ...
                                                  throw new Error("Failed pattern match at Game.Cubbit.UI line 103, column 17 - line 114, column 25: " + [ $37.constructor.name ]);
                                              };
                                              throw new Error("Failed pattern match at Game.Cubbit.UI line 99, column 9 - line 114, column 25: " + [ v1.constructor.name ]);
                                          };
                                      })();
                                  };
                              };
          ...
          return function __do() {
              ...
              var v7 = (function __do() {
                  ...
                  var v10 = (function () {
                      ...
                      throw new Error("Failed pattern match at Game.Cubbit.Main line 179, column 26 - line 191, column 54: " + [ enableWaterMaterial.constructor.name ]);
                  })()();
                  return {
              ...
              var v8 = Control_Monad_Eff_Ref.newRef({
                  ...
                  terrain: Game_Cubbit_Terrain.emptyTerrain, 
                  mousePosition: {
                      x: 0, 
                      y: 0
                  }, 
              ...
              Game_Cubbit_UI.initializeUI(canvasGL)(canvas2d)(v8)(v5)(v3)(v2)(v1)(v7)();
              ...
              return Graphics_Babylon_Engine.runRenderLoop(function __do() {
                  Game_Cubbit_Update.update(v8)(v1)(v7)(v4)(v5)(v3)();
